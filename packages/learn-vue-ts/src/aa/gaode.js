(function (config) {
    ...
    var Ta = Ra ? "android" : Ma ? "ios" : wa ? "windows" : Ea ? "mac" : "other", Ua = ra && !ca.XMLHttpRequest,
        Va = ra && !fa.querySelector, Wa = ra && !fa.addEventListener, Xa = ra && ia("msie 9"),
        Ya = ra && ia("msie 10"), Za = ra && ia("rv:11"), $a = Wa || Xa, ab = ia("edge"), bb = ia("qtweb"),
        ...
        }(), xb = va && (!qb || !!wb && 1 <= wb), yb = ra && "transition" in ga.style,
        ...
        Db = !ra && !ab && !(cb && Ra) && window.Worker && Cb && Cb.createObjectURL && window.Blob, Eb = "", pa = "",
        Fb = 0,
        Ib = window.forceWebGL ? {alpha: !0, antialias: !0, depth: !0} : {
            alpha: !0,
            antialias: !0,
            depth: !0,
    ...
    window.AMap ? (window.AMap.version = "1559206836107", window.AMap.yK = {
        uL: function (a) {
            a(dc)
        }
    }) : window.AMap = {
        version: "1559206836107", yK: {
            uL: function (a) {
                a(dc)
            }
        }
    ...
    var g = g || {Ea: {we: 0, yq: [], qj: {}}}, A = {o: {}, control: {}, w: {}};
    g.HBa = function (a) {
        var b = Function;
        return function () {
    ...
    g.c.add = g.BuryPoint.add = function (a, b, c) {
        a.a4 || a.C || !(a = a.CLASS_NAME) || (a = a.replace("AMap.", ""), g.Qz.Io(a, b, c))
    };
    var lc = {lang: 1, baseRender: 1, overlayRender: 1, viewMode: 1};
    g.c.ya = g.BuryPoint.addOptions = function (a, b) {
        if (!a.Zsa) if (b && (b.innerLayer || b.innerOverlay)) a.a4 = !0; else {
            a.Zsa = !0;
            var c = a.CLASS_NAME;
            if (c) {
                c = c.replace("AMap.", "");
                g.Qz.Io(c);
                b = b || {};
                for (var d in b) b.hasOwnProperty(d) && ("Map" === c && d in lc ? g.Qz.Io(c, d, b[d]) : g.Qz.Io(c, d))
            }
        }
    };
    g.aa = function () {
    ...
    g.aa.extend = g.aa.extend = function (a) {
        ...
        function c() {
            ...
            if (!d && this.vi) {
                ...
                this.vi = this.vi.replace(/url\((['"]?)(?:\.\.\/)*/g, "url($1" + g.A.yb + "/");
                a.styleSheet ? a.styleSheet.cssText = this.vi : a.innerHTML = this.vi;
    ...
    g.Qz = {
        qj: {}, getKey: function (a, b) {
            ...
            a.length && (a = ["type=nfl", "k=" + g.A.key, "m=" + (g.l.Z ? 1 : 0), "pf=" + g.l.Ry, "v=" + g.A.er, "branch=JSAPI", "log=" + a.join("!")], a = g.A.Bc + "://webapi.amap.com/count?" +
    ...
    g.sa = {
        g: function (a, b, c, d, e) {
            ...
            f[a] = f[a] || [];
            e ? f[a].unshift({tb: b, Se: c || this, nj: d}) : f[a].push({tb: b, Se: c || this, nj: d});
            return this
        }, fe: function (a, b, c) {
            var d = this.af;
            if (b && c) {
                if (d && a in d && d[a]) for (var e = 0; e < d[a].length; e += 1) if (d[a][e].tb === b && d[a][e].Se === c) return !0;
                return !1
            }
            ...
            var d = this.af;
            if (d && d[a]) for (var e = 0; e < d[a].length; e += 1) if (!(d[a][e].tb !== b && "mv" !==
                b || c && d[a][e].Se !== c)) {
                d[a].splice(e, 1);
                d[a].length || (d[a] = null);
                break
            ...
            if (!this.fe(a)) return this;
            var c = this.af;
            if (c && c[a]) for (var d = 0; d < c[a].length; d += 1) if (!b || c[a][d].Se === b) {
                c[a].splice(d, 1);
                c[a].length || (c[a] = null);
                break
            }
            ...
            if (!this.fe(a)) return this;
            var c = {type: a};
            void 0 !== b && (b instanceof Array ? (c = b.slice(0), c.type = a) : "string" === typeof b || "number" === typeof b || "boolean" === typeof b ? c.value = b : g.a.II(b) ? c.value = b : c = g.extend(c, b));
            for (var d =
                [].concat(this.af[a]), e = 0; e < d.length; e += 1) d[e].tb && (d[e].tb.call(d[e].Se || this, c), d[e] && d[e].nj && this.af[a] && this.af[a].splice(e, 1));
            return this
        }, gi: function (a) {
            a ? this.af && this.af[a] && (this.af[a] = null) : this.af = null;
            return this
        }
    };
    ...
    g.Qe = {
        set: function (a, b, c) {
            ...
            } else (this.He = this.He || {})[a] = b, c || this.FJ(a, b)
        }, k3: function () {
            var a = {};
            return function (b) {
            ...
            this.ll || (this.ll = {});
            this.ll[a] !== b && (b.g(a, function (b) {
                this.FJ(a, b)
            }, this), this.ll[a] = b, c || this.FJ(a))
        }, Re: function (a, b, c) {
            for (var d = 0; d < a.length; d += 1) this.W(a[d], b, !c)
        }, dl: function (a) {
            this.ll && this.ll[a] && (this.ll[a].G(a, "mv", this), this.ll[a] = void 0)
        }, el: function () {
            if (this.ll) for (var a in this.ll) this.ll.hasOwnProperty(a) && this.dl(a)
        }, FJ: function (a, b) {
            var c = a + "Changed";
            if (this[c]) this[c](b);
            this.q(a, b)
        }, lDa: function (a, b, c) {
            var d = new (g.aa.extend({ja: [g.sa, g.Qe]}));
            d.YO = function () {
    ...
    g.A = {
        ...
        TDa: "dark light blue darkblue fresh grey midblue".split(" "),
        key: "391e9af14a808e5b064732b402559efe",
        Bc: "http",
        ...
        uJ: "http://gaode.com",
        Xu: "http://m.amap.com",
        XC: "http://webrd0{1,2,3,4}.is.autonavi.com/appmaptile?lang=[lang]&size=1&scale=1&style=8&x=[x]&y=[y]&z=[z]",
        VI: "http://wprd0{1,2,3,4}.is.autonavi.com/appmaptile?lang=zh_cn&size=1&style=7&x=[x]&y=[y]&z=[z]&scl=1&ltype=3",
        mT: "http://webst0{1,2,3,4}.is.autonavi.com/appmaptile?style=6&x=[x]&y=[y]&z=[z]",
        SJ: "http://webst0{1,2,3,4}.is.autonavi.com/appmaptile?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scale=1&style=8",
        TJ: "http://wprd0{1,2,3,4}.is.autonavi.com/appmaptile?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scl=1&style=8&ltype=11",
        ZD: "http://wprd0{1,2,3,4}.is.autonavi.com/appmaptile?lang=[lang]&size=1&style=7&x=[x]&y=[y]&z=[z]",
        CK: "http://vector.amap.com",
        AK: "vdata.amap.com",
        fya: "ws"
    };
    ...
    function mc(a) {
        ...
        "https" === b && (g.A.fya = "wss", g.A.Rd = g.A.Rd.replace("http", "https"), g.A.XC = g.A.XC.replace("http", "https"), g.A.VI = g.A.VI.replace("http", "https"), g.A.mT = g.A.mT.replace("http", "https"), g.A.SJ = g.A.SJ.replace("http", "https"), g.A.TJ = g.A.TJ.replace("http", "https"), g.A.ZD = g.A.ZD.replace("http", "https"), g.A.CK = g.A.CK.replace("http", "https"));
        var c = window.location.href;
        0 !== c.indexOf("http") && window.parent && window.parent !== window && (c = window.parent.location.href);
        g.A.MBa = c;
        c = encodeURIComponent(c);
        g.A.Pt = c;
        g.A.qi = g.A.yb + "/theme/v1.3/markers/" + (g.l.Nc ? "b" : "n");
        var d = document.createElement("style");
        d.type = "text/css";
        g.A.Oma = "url(" + b + "://webapi.amap.com/theme/v1.3/openhand.cur),default";
        var e = ".amap-container{cursor:" + g.A.Oma + ";}.amap-drag{cursor:url(" + b + "://webapi.amap.com/theme/v1.3/closedhand.cur),default;}";
    ...
    window.AMap && window.AMap.yK && window.AMap.yK.uL && window.AMap.yK.uL(mc);
    g.mm = {eu: Math.PI / 180, fua: 180 / Math.PI, MP: 6378137};
    (function () {
        function a(a) {
        ...
        g.Qh = {
            lpa: function (b) {
                ...
                if (g.l.Z) {
                    var d = [g.A.Xu + "/callAPP?", "src=jsapi_q"];
                    ...
                    d.push("&wp=" + encodeURIComponent("viewMap?sourceApplication=jsapi_q&dev=0&poiname=" + b.name + "&lat=" +
                        b.y + "&lon=" + b.x));
                    d.push("&mo=" + encodeURIComponent(g.A.Xu + "?q=" + c.join(",") + "&callapp=0&sourceApplication=jsapi_q"));
                    return d.join("")
                }
                return g.A.uJ + "?q=" + c.join(",") + "&src=jsapi_q"
            }, X2: function (b) {
                b.name = a(b.name);
                ...
                if (g.l.Z) {
                    var d = [g.A.Xu + "/callAPP?", "src=jsapi_p"];
                ...
                return g.A.uJ + "?p=" + c.join(",") + "&src=jsapi_p"
            }, V2: function (b) {
                if (g.l.Z) {
                    var c = [g.A.Xu + "/callAPP?", "src=jsapi_detail"];
                    ...
                    c.push("&mo=" + encodeURIComponent(g.A.Xu + "/detail/index/poiid=" + b.id + "&sourceApplication=jsapi_detail"));
                    return c.join("")
                }
                return g.A.uJ + "/detail/" + b.id + "?src=jsapi_detail"
            }, HQ: function (b) {
                b.sname = a(b.sname);
                "" === b.sname &&
                (b.sname = "\u8d77\u70b9");
                ...
                if (g.l.Z) {
                    var d = [g.A.Xu + "/callAPP?", "src=jsapi_r_" + b.t];
                    ...
                    d.push("&mo=" + encodeURIComponent(g.A.Xu +
                        "/?r=" + c.join(",") + "&callapp=0&sourceApplication=jsapi_r_" + b.t));
                    return d.join("")
                }
                return g.A.uJ + "?r=" + c.join(",") + "src=jsapi_r_" + b.t
            }, Ds: function (a) {
    ...
    g.a = {
        CLASS_NAME: "AMap.Util", iK: [], Da: 268435456, Ao: [215440491, 106744817], S8: function () {
            ...
            start: function (a) {
                ...
                a.vma = new Date - a.startTime;
                this.cancel(a);
                a.vC = Math.round(1E3 / (a.vma / (a.Bs.length + 1)))
            }
        }, g3: function (a, b, c) {
            ...
            var b =
                {};
            if (g.a.Tj(a, "object")) for (var c in a) a.hasOwnProperty(c) && (b[a[c]] = c);
            return b
        }, Uf: function (a, b) {
            ...
            if ("object" === typeof a && null !== a) {
                if (a.x5 || this.Tj(a, "Float32Array") || this.Tj(a, "Uint16Array")) return a;
                var b = this.isArray(a) ? [] : {}, c;
                for (c in a) a.hasOwnProperty(c) && (b[c] = g.a.mb(a[c]));
                return b
            }
            return a
        }, m4: function (a) {
            return (a | 0) === a
        }, Gva: "function" === typeof Object.setPrototypeOf ? Object.setPrototypeOf : function (a, b) {
            ...
            return this.hT(this.sp(a))
        }, sp: function (a) {
            if (a instanceof Array) return 3 == a.length && a.push(1), a;
            a = this.rH(a);
            if (0 == a.indexOf("#")) {
                if (7 == a.length) return this.mv(a.substr(1));
                if (9 == a.length) return a = a.substr(1), this.Dk(a.substr(6) + a.substr(0, 6))
            } else {
                if (0 == a.indexOf("rgb(")) return a = this.bva(a), a.push(1), a;
                if (0 == a.indexOf("rgba(")) return this.nv(a)
            }
        }, W6: function (a) {
            return g.a.hr("ff" + a)
        }, hr: function (a) {
            ...
            return "function" == typeof b ? this.EO(a, !0, this.Vka(b, c, 1)) : this.EO(a, !0)
        }, EO: function (a, b, c, d, e, f, h) {
            var k;
            c && (k = e ? c(a, d, e) : c(a));
            if (void 0 !== k) return k;
            if (!this.r4(a)) return a;
            if (d = this.isArray(a)) {
                if (k =
                    this.qqa(a), !b) return this.Cka(a, k)
            } else {
                var l = Object.prototype.toString.call(a), m = "[object Function]" == l;
                if ("[object Object]" == l || "[object Arguments]" == l || m && !e) {
                    if (k = this.rqa(m ? {} : a), !b) return this.Lka(k, a)
                } else return e ? a : {}
            }
            f || (f = []);
            h || (h = []);
            ...
            f.push(a);
            h.push(k);
            (d ? this.Dka : this.Qka)(a, function (d, e) {
                k[e] = g.a.EO(d, b, c, e, a, f, h)
            });
            return k
        }, Lka: function (a, b) {
            return null == b ? a : this.Oka(b, Object.keys(b), a)
        }, r4: function (a) {
            var b = typeof a;
            return !!a && ("object" ==
                b || "function" == b)
            ...
            return new a
                          ...
                          b, c) {
            if ("function" != typeof a) return this.Gu;
            ...
            return g.a.wma()(a, b, Object.keys)
        }, Ewa: function (a) {
            return g.a.r4(a) ? a : Object(a)
        }, Oka: function (a, b, c) {
            c || (c = {});
        ...
        }(), Gna: "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=", uf: Date.now ? function () {
            return Date.now()
        } : function () {
            ...
            if (d) {
                ...
                e = function () {
                    l ? m = arguments : (l = !0, a.apply(c, arguments), setTimeout(n,
                        b))
                }
            }
            return e
            ...
            for (var c, d = 0, e = a.length; d < e; d += 1) c = a.charCodeAt(d), b = (b << 5) - b + c,
                b &= b;
            return b
        }, oBa: function (a, b) {
            ...
            JSON.stringify ? g.a.Q7(JSON.stringify(a)) : null
        }, vFa: function (a, b) {
            ...
            this.j6 || (this.j6 = [], this.xR = !1);
            var c = this.j6, d = this;
            if ("img" === a.tagName.toLowerCase()) c.push(a); else {
                a = a.getElementsByTagName("*");
                for (var e = 0; e < a.length; e += 1) c.push(a[e])
            }
            window.DD_belatedPNG && this.xR ? setTimeout(function () {
                    b()
                }, 100) :
                this.xR || g.pb.load("AMap.FixPng", b)
        }, Ia: function (a) {
            if (g.a.isArray(a)) if (g.a.isArray(a[0])) for (var b = 0; b < a.length; b += 1) a[b] = g.a.Ia(a[b]); else if (b = typeof a[0], "string" === b || "number" === b) return new g.T(a[0], a[1]);
            return a
        }, hya: function (a) {
            for (var b = [], c = 0, d = a.length; c < d; c += 1) b[c] = [a[c].x, a[c].y];
            return b
        }, Zp: function (a) {
            return g.a.isArray(a) ? new g.vd(a[0], a[1]) : a
        }, xO: function (a) {
            var b = a.type, c = a.IT, d = a.error;
            a = new g.fb.XMLHttpRequest(a.url, {Sc: void 0 === b ? "GET" : b, z1: a.data, eT: "text/plain"});
            a.g("complete",
                function (a) {
                    a = JSON.parse(a.data);
                    c && c(a)
    ...
    (function () {
        ...
        function c(a) {
            var b = +new Date, c = Math.max(0, (g.l.Al ? 50 : 20) - (b - d));
            d = b + c;
    ...
    g.a.fT = window.requestIdleCallback ? function (a, b) {
        return window.requestIdleCallback(a, b)
    } : function (a) {
        var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, c = g.a.uf();
        return setTimeout(function () {
            a({
                didTimeout: !1, timeRemaining: function () {
                    return Math.max(0, 70 - (g.a.uf() - c))
                }
            })
        }, b.timeout || 0)
    };
    g.a.WO = window.cancelIdleCallback ? function (a) {
    ...
    (function (a) {
        var b = 1, c = {};
        a.a.Eva = function (a, b) {
            if (c[a]) {
                var f = c[a];
                f.OD = 1;
                f.result = b;
                if (f.Mm) {
                    for (var h = f.Mm, k = 0, l = h.length; k < l; k++) h[k].call(null, b);
                    f.Mm = null
                }
            }
        };
        ...
        a.a.Rxa = function (a, b) {
            if (c[a]) {
                var f = c[a];
                0 < f.OD ? b(null, f.result) : (f.Mm || (f.Mm = []), f.Mm.push(b))
            } else b(null, a)
        };
        a.a.AQ = function (d, e) {
            var f = navigator.geolocation;
            if (!a.l.NC || "https:" === document.location.protocol) return d(null, f);
            var h;
            e && e.Sxa && (h = "f" + b++, c[h] = {OD: 0});
            var k = null, l = !1;
    ...
    (function (a) {
        var b = a.aa.extend({
            ja: [a.sa], r: function () {
                ...
                a.vj && a.vj.g("vecTileParsed.buildings", this.iea, this)
            }, k4: function (a) {
                return a.map.mY
            }, Xoa: function (a) {
                return this.k4(a) ? a.map.MM : null
            }, Bva: function (a, b) {
                if (b) {
                    var e = b.map;
                    e && (e.MM ? e.MM.toString() : "") !== (a ? a.toString() : "") && (e.MM = a || [], e.set("display", 0))
                }
            }, p7: function (a, b) {
                if (b) {
                    var e = b.map;
                    e && e.mY !== a && (e.mY = a, e.set("display", 0))
                }
            }, Nza: function () {
            }, hY: function (a, b) {
                ...
                if (!b) return null;
                b = b.map.ra;
                for (var d = 0, e = b.length; d < e; d++) if (a.o.Uh && b[d] instanceof a.o.Uh && b[d].ga && b[d].ga.length && (-1 !== b[d].ga.indexOf("building") || -1 !== b[d].ga.indexOf("poilabel")) && b[d].La) {
                    var f = b[d].V.get("tiles", null, !0);
                    if (f && f.length) return b[d]
                }
                return null
            }, uoa: function (a) {
                if (a = this.l2(a)) {
                    if (a = a.V.get("tiles", null, !0)) a = a[0]; else return null;
                    if (!a || !a.length) return null;
                    for (var b = [], e = 0, f = a.length; e < f; e++) {
                        var h = a[e];
                        h.be && h.be.ff && this.hY(h.be.ff, b)
                    }
                    return b
                }
            },
            iea: function (a) {
                if (a.Mo && a.Mo.be) {
                    ...
                    if (b) {
                        var e = [];
                        this.hY(b, e);
                        this.q("vecTileParsed.builds.found", {X0: e, Mo: a.Mo})
                    }
                }
            }
        });
    ...
    (function (a) {
        ...
        function d(a) {
            function b(c, d) {
                function e(a, b, c) {
                    a = {oz: Date.now(), az: h, error: a, result: b, Wp: !1, Ik: !1};
                    if (c) for (var f in c) c.hasOwnProperty(f) && (a[f] = c[f]);
                    d(a)
                }

                var f = c.$Q, h = c.az, l = c.hP, m = c.RB, n = c.Bka || [], p = a._wkHandlers[f];
                p ? p[l] ? m ?
                    p[l].apply(p, n.concat(e)) : e(null, p[l].apply(p, n)) : e("Unknown cmd: " + l) : e("Can not find handler for: " + f)
            }

            var c = [], d = null, e = null;
            for (d in this._wkHandlers) -1 !== d.indexOf("_def_") && (e = this._wkHandlers.ODa = d);
            ...
            a.addEventListener("message", function (d) {
                ...
                var f = d.data;
                d = f.Tua || [f];
                for (var h = d.length, n = 0, p = Date.now() - f.oz, t = [], f = 0; f < h; f++) b(d[f], e)
            }, !1)
        }
        ...
        function e(d, h) {
            ...
            this.kp = [];
            this.mA = this.B.clientId || "w" + f++;
            this.B.onReady && this.cS(this.B.onReady);
            this.yF = this.jda();
            ...
            this.fB(null);
            this.B.lazy || this.yx();
            a.Jpa || !1 === this.B.hostWorker || (a.Jpa = this);
            this.Gn && this.Gn.r && this.Gn.r.call(this.Gn)
        }

        var f = 1, h = 1;
        a.extend(e, {
            NQ: "_g_", Qva: function (a) {
                if (!a.vaa) {
                    var b = [];
                    a.addEventListener("message", function (a) {
                        ...
                        for (var c = 0, d = a.length; c < d; c++) {
                            ...
                            a:{
                                f = e.az;
                                for (var k = !e.Ik, h = 0, v = b.length; h < v; h++) {
                                    var x = b[h];
                                    if (f === x.az) {
                                        k || b.splice(h, 1);
                                        f = x;
        ...
        a.extend(e.prototype,
            {
                jda: function () {
                    return "_def_" + this.mA
                }, rX: function () {
                    return "_cln_" + this.mA
                }, Eia: function () {
                    var a = Array.prototype.slice.call(arguments, 0);
                    this.e_ = a;
                    if (this.cx) {
                        for (var b = 0, c = this.cx.length; b < c; b++) this.cx[b].apply(null, a);
                        this.cx.length = 0
                    }
                }, Nt: function (a) {
                    this.via && this.kp.push.apply(this.kp, a)
                }, cS: function (a) {
                    this.e_ ? a.apply(null, this.e_) : (this.cx || (this.cx = []), this.cx.push(a))
                }, yx: function (b) {
                    var c = this;
                    if (!c.pW) {
                        c.pW = !0;
                        var d = function (d, e) {
                            d && a.l.zR && console.warn(d);
                            c.Eia.call(c, d, e);
                            b && b(d, e)
                        };
                        a.l.zR ? this.ria(function (a, b) {
                            b ? this.Kea(b, function (a, c) {
                                a ? d(a) : (this.fB(c), this.uO = c, this.kp.length = 0, this.Gn = null, d(null, {
                                    Ska: b,
                                    cya: c
                                }))
                    ...
                    var d = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : a.a.is, f = this;
                    b = b || f.yF;
                    var h = {};
                    if (a.a.Tj(c, "object")) {
                        var q = "return {", r;
                    ...
                    f.fB(null, h);
                    f.cS(function (a) {
                        a ? d(a) : f.uO ? (a = f.wX(c, f.yM(f.mA, b), !0), f.uO.sendMessage(e.NQ + ":injectCode", a, function (a, b) {
                            a || f.fB(f.uO, h);
                            d(a, b)
                    ...
                    if (!c) return function () {
                        var a = b.apply(e.Gn, arguments);
                        e.pW || "untilCall" === e.B.lazy && e.yx();
                        return a
                    };
                    d._proxy2Worker = !0;
                    return d
                    ...
                    var b = {}, c;
                    for (c in a) a.hasOwnProperty(c) && this.VV(c, a[c], b);
                    return b
                }, VV: function (a, b, c) {
                    b = b.call(null, !1);
                    for (var d in b) b.hasOwnProperty(d) && (c[a + ":" + d] = b[d], a === this.yF && (c[d] = b[d]))
                }, fB: function (a, b) {
                    if (!b) this.Gn || (this.Gn = this.kba(this.NF)), b = this.Gn; else if (this.Gn) for (var c in b) b.hasOwnProperty(c) && (this.Gn[c] = b[c]);
                    for (c in b) if (b.hasOwnProperty(c)) {
                        var d = b[c];
                        "function" === typeof d && (this[c] = this.Gda(c,
                            d, a))
                    }
                    this.via = !!a
                }, wX: function (a, b) {
                    ...
                    var b = this.mA, c = [], d;
                    for (d in this.NF) if (this.NF.hasOwnProperty(d)) {
                        var f = this.wX(this.NF[d], this.yM(b, d));
                        f && c.push(f)
                    }
                    ...
                    c && c !== r ? c.cS(function (b, c) {
                        b ? a.call(r, b) : c.cya.sendMessage(e.NQ + ":injectCode", h, function (b) {
                            b ? a.call(r, b) : a.call(r, null, c.Ska)
                        })
                    }) : a.call(r, null, r.Ija(h))
                }, Ija: function (b) {
                    ...
                    var c = 1, d = b.jaa, e = this, f = !!e.B.batchSend;
                    return function (h) {
                        var r = Array.prototype.slice.call(arguments, 1),
                            s = "function" === typeof r[r.length - 1] ? r.pop() : null, u = e.mA, v = h.split(":"),
                            x = e.yF;
                        1 < v.length && (h = v[1], x = v[0]);
                        r = {oz: a.a.uf(), $Q: e.yM(u, x), RB: !!s, az: u + "_" + c++, hP: h, Bka: r};
                        s && d.push({hP: r.hP, $Q: r.$Q, oz: r.oz, az: r.az, RB: s});
                        f ? e.Oaa(b, r) : e.ax(b, r)
                    }
                }, ax: function (a, b) {
                    if (this.kp.length) {
                        try {
                    ...
                    if (!b.XZ) {
                        var d = this;
                        b.XZ = setTimeout(function () {
                            b.XZ = null;
                            var c = b.rN;
                            c.length && (d.ax(b, 1 === c.length ? c[0] : {oz: a.a.uf(), Tua: c}), c.length = 0)
                        }, 0)
                    }
                }, Aja: function (a) {
                    var b = this;
                    ...
                    c.Aja(a);
                    var d = this.cca(a);
                    if (e.Iba) b.call(c, null, {sendMessage: d}); else {
                        e.Iba = !0;
                        var f = [c.rX() + ":checkup", Math.random().toFixed(5) + "", Math.round(1E3 * Math.random()), !1, function (a, e) {
                            var h = !0;
    ...
    (function () {
        if (!g.ne) {
            g.ne = {$e: {}, ny: {}};
            var a = g.ne, b = g.ne.$e, c = g.a, d = g.A;
            b.start = function (b) {
                a.ny[b.id] = {
                    J: b.J, time: {Y3: c.uf()}, pla: function () {
                        return c.uf() - this.time.Y3
                    }
                }
            };
            b.end = function (b) {
                var d = a.ny[b.id], e = d.time, d = c.bind(d.pla, d), l = b.index, m = b.key;
                "function" !== typeof b.Gc && (b.Gc = function () {
                });
                if (void 0 === e[m]) void 0 === l ? e[m] = d() : (e[m] = [], e[m][l] = d()); else if (void 0 !== l && void 0 === e[m][l]) e[m][l] = d(); else return b.Gc(Error("Duplicate Invoke"));
                b.Gc(null)
            };
            b.push = function (b) {
                ...
                if (void 0 === c[d]) c[d] = e; else return b.Gc(Error("Duplicate Invoke"));
                b.Gc(null)
            };
            b.send = function (b) {
                var c = d.Bc + "://webapi.amap.com/count?", k = g.extend(e({J: a.ny[b.id].J}), b.params || {}), l = g.a;
                b.params && b.params.rs && !b.params.type && (b = a.ny[b.id].time, delete b.Y3, k = g.extend(k, b));
                b = [];
                for (var m in k) l.isArray(k[m]) ? b.push([m, k[m].join("-")].join("=")) : b.push([m, k[m]].join("="));
                b.push("jl=" + (d.WC ? 1 : 0));
                if (l.Tj(window.performance, "performance") &&
                    l.Tj(window.performance.getEntriesByType, "function")) {
    ...
    (function () {
        if (!g.KK) {
            var a = g.a.zC({A: "Conf", extend: "extend", l: "Browser", Lv: "uncodeCoords"});
            g.KK = function () {
                var b = new g.$z(function () {
                    return {
                        r: function () {
                            this.Fw = {Uj: 0, gv: 0};
                            this.xk = {};
                            ...
                            var e = a.Ed, f = a.ve, h = "building" === a.ga[0];
                            (f && e !== this.Fw.gv && this.Fw.gv || !f && !h && e !== this.Fw.Uj && this.Fw.Uj) && this.eka(!!f);
                            f ? this.Fw.gv = e : h || (this.Fw.Uj = e);
                            this.qra(a, b)
                        }, eka: function (a) {
                            if (a) this.QV(); else if (!a && Object.keys(this.xk).length) for (var b in this.xk) this.xk.hasOwnProperty(b) &&
                            (a = this.xk[b], a.at || a.abort())
                        }, Nwa: function () {
                            this.gt > this.LY && this.SS(Object.keys(this.Ej).slice(0, Math.floor(this.LY / 2)))
                        }, SS: function (a) {
                            for (var b = 0, e = a.length; b < e; b++) delete this.Ej[a[b]];
                            this.gt -= a.length
                        }, rP: function (a) {
                            var b = a.ga;
                            a = a.ve;
                            ...
                            e.aq = "";
                            e.GD = [(new Date).getTime(), a ? 1 : 0, b.join("|")].join("-");
                            return e
                        }, B3: function (a, b, e) {
                            var f = this, h = a.Eb, k = a.ve, l = [], m = h.filter(function (a) {
                                var b = f.Ej[a.key];
                                if (b) {
                                    if (b.DY) return !0;
                                    l.push(a.key)
                            ...
                            if (m.length && ((n =
                                ...
                                m.forEach(function (a) {
                                    a = a.key;
                                    p.push.apply(p, f.Ej[a]);
                                    delete f.Ej[a]
                                });
                                this.gt -= m.length;
                                this.ks(this.extend({}, a, {lE: p, Ed: a.Ed, Pk: n}), e)
                            }
                            !k && l.length && this.SS(l);
                            this.Nwa();
                            return n
                        }, qra: function (a, b) {
                            function e(e, f) {
                                var m = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : !1;
                                if (p.xk[q.GD] || p.zea(q)) {
                                    var n = e.split("|");
                                    f && (n[0] = f + n[0]);
                                    var t = n, w = "";
                                    ...
                                    y; n++) {
                                        if (t[n]) {
                                            ...
                                            if (D.length) {
                                                ...
                                                p.Ej[C] ? p.Ej[C].push(D) : (p.Ej[C] = [D], p.gt++);
                                                m && (p.Ej[C].DY = !0)
                                            }
                                        }
                                    } else p.ks(p.extend({}, a, {lE: t, Ed: h, Pk: m, qR: !0}), b);
                                    return w
                                }
                                r || (p.pl(l, b), r = !0)
                            }

                            var f = this, h = a.Ed, k = a.ve, l = a.Eb, m = a.url;
                            if (!this.B3(a, function (a, b) {
                                ...
                                var n = 0, p = this, q = this.rP(a);
                                k ? this.Mn.push(q) : (this.xk[q.GD] = q, q.Eb = l, q.Gc = b);
                                var r = !1;
                                q.onreadystatechange = function () {
                                    if (4 === q.readyState && 0 === q.status) q.at || (q.at = !0, f.pl(l, b), q.onreadystatechange = null, k ? f.j_(q) : delete f.xk[q.GD]), q = null; else if (!q.at) if (3 === q.readyState) {
                                        var h = q.responseText.substring(n);
                                        q.aq = e(h, q.aq);
                                        n = q.responseText.length
                                    } else 4 === q.readyState && (h = q.responseText.substring(n), a.Ig && (h += "|"), e(h, q.aq, !0), q.aq = "", k ? f.j_(q) : delete f.xk[q.GD],
                                        q = null)
                                };
                                q.onerror = function () {
                                };
                            ...
                            function b(d, p, r) {
                                ...
                                18 < k && !n && (s += "/" + k);
                                if (d && "loaded" !== d.status && -1 !== m.indexOf(t)) if ("limg" === t) p = h[1], d.sd = p, "string" === typeof p.b && (p.b = x.rA(p.b)), r = "", (r = "object" === typeof p.u ? p.u.url : p.u) && (p.u = {
                                    url: r,
                                    hk: "limg-" + d.key + "-" + f
                                }); else {
                                    p = {
                            ...
                            var e = a.Eb, f = a.ER, h = a.cC, k = a.Ed, l = a.Ic, m = a.ga, n = a.vf, p = a.QQ,
                                q = a.le, r = h[0].split("-"), s = parseInt(r[1]), u = parseInt(r[2]),
                                v = parseInt(r[0]), x = this, t = r[3], r = Math.pow(2, v);
                            10 > v && (s <= p && b(s + r, u, v), s >= r - p && b(s - r, u, v));
                            b(s, u, v)
                        }, j_: function (a) {
                            for (var b = this.Mn.length - 1; 0 <= b; b--) this.Mn[b] === a && this.Mn.splice(b, 1)
                        }, zea: function (a) {
                            for (var b = 0, e = this.Mn.length; b < e; b++) if (this.Mn[b] === a) return !0;
                            return !1
                        }, sB: function () {
                            return Object.keys(this.xk).length ? !0 : !1
                        }, QV: function () {
                            if (this.Mn.length) {
                                for (var a = this.Mn.length - 1; 0 <= a; a--) {
                                    var b = this.Mn[a];
                                    b.at || b.abort();
                                    b.p8 && this.SS(b.p8)
                                }
                            ...
                            b(null, {Eb: a, s4: !0, disabled: this.disabled}, {Ik: !0})
                        }
                    }
                }, {batchSend: !1});
    ...
    g.h = {
        CLASS_NAME: "DomUtil", get: function (a) {
            ...
            return a.parentNode == b ? !0 : a.parentNode && a.parentNode !== document.body && !g.h.Ym(a.parentNode, c) ? g.h.QC(a.parentNode, b) : !1
        }, ao: function (a) {
            if (!a) return [0, 0];
            ...
            if (a) return new g.vd(a.clientWidth || document.body.clientWidth, a.clientHeight || (g.l.Rr ? "CSS1Compat" === document.compatMode ? document.documentElement.clientHeight : document.body.clientHeight : document.body.clientHeight), !0)
        }, A2: function (a) {
            return new g.vd(a.clientWidth, a.clientHeight)
        }, MQ: function (a) {
            ...
            do {
                ...
                b -= d.scrollTop || 0;
                c -= d.scrollLeft || 0;
                g.h.ina() || !g.l.Y8 && !k || (c += d.scrollWidth - d.clientWidth, k && "hidden" !== g.h.Dd(d, "overflow-y") && "hidden" !== g.h.Dd(d, "overflow") &&
                (c += 17));
                d = d.parentNode
            } while (d);
            return new g.H(c, b)
        }, ina: function () {
            g.h.wca || (g.h.wca = !0, g.h.vca = "ltr" === g.h.Dd(document.body, "direction"));
            return g.h.vca
            ...
            this.yha || (this.yha = document.onselectstart, document.onselectstart = g.a.h2)
        }, a2: function () {
        }, Hwa: function (a,
                          b, c) {
            ...
            a && b && (a.classList && a.classList.add ? a.classList.add(b) : g.h.Ym(a, b) || (a.className += (a.className ? " " : "") + b))
        }, uva: function (a, b) {
            a && (a.className = b || "")
        }, ab: function (a, b) {
            function c(a, c) {
            ...
            return g.h.i3(b.add(b.Fd(-1 * a))) + (" scale(" + a + ") ")
        }, t7: function (a, b, c) {
            a.Mi = b;
            !c && g.l.ZG ? (b = g.h.i3(b), c = a.style[g.h.dg].split("rotate"), 1 < c.length ? (c[0] = b, a.style[g.h.dg] = c.join("rotate")) : a.style[g.h.dg] = b, g.l.k5 && (a.style.WebkitBackfaceVisibility = "hidden")) : (a.style.left = b.x + "px", a.style.top = b.y + "px")
        }, re: function (a) {
            a.Mi || (a.Mi = a.style.left ?
        ...
        remove: function (a) {
            ...
            d ? (a.style[d] = "" + (" rotate(" + b + "deg)"), a.style[g.h.Es[d] + "-origin"] = c.x + "px " + c.y + "px") : (d = Math.cos(b * Math.PI / 180), b = Math.sin(b * Math.PI / 180), a.style.filter = "progid:DXImageTransform.Microsoft.Matrix()", 0 < a.filters.length && (a = a.filters.item(0), a.Dx = -c.x * d + c.y * b + c.x, a.Dy = -c.x * b - c.y * d + c.y, a.M11 = a.M22 = d, a.M12 = -(a.M21 = b)))
        }, d3: function (a, b, c) {
            var d = g.h.dg;
            c = c ||
                {x: a.clientWidth / 2, y: a.clientHeight / 2};
            return d ? g.h.Es[d] + ":" + ("" + (" rotate(" + b + "deg)")) + ";" + (g.h.Es[d] + "-origin:" + c.x + "px " + c.y + "px") : ""
        }, $l: function (a, b, c) {
            a.width = b;
            a.height = c
    ...
    (function () {
        var a = g.h.MT(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]), b;
        g.extend(g.h, {
            N1: function () {
    ...
    g.h.dg = g.h.MT(["WebkitTransform", "OTransform", "MozTransform", "msTransform", "transform"]);
    g.h.Es = {
        transform: "transform",
    ...
    g.h.UE = g.h.MT(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]);
    g.h.aza = "webkitTransition" === g.h.UE || "OTransition" === g.h.UE ? g.h.UE + "End" : "transitionend";
    g.F = {
        g: function (a, b, c, d) {
            function e(b) {
                b = b || window.event;
            ...
            if (a[h]) return this;
            var k = b;
            g.l.ZP && "mousewheel" === b && (b = "DOMMouseScroll");
            if (g.l.Rr && ("mouseover" === b || "mouseout" === b)) {
                var l = e;
            ...
            if (g.l.l6 && 0 === b.indexOf("touch")) return a[h] = e, this.mka(a, b, e, f);
            g.l.Af && "dblclick" === b && this.kka && this.kka(a, e, f);
            ...
            var e = a[d];
            g.l.ZP && "mousewheel" === b && (b = "DOMMouseScroll");
            !g.l.Rr || "mouseover" !== b && "mouseout" !== b || (b = "mouseover" === b ? "mouseenter" : "mouseleave");
            g.l.l6 && -1 < b.indexOf("touch") ? this.wua(a, b, c) : g.l.Af && "dblclick" === b && this.sua ? this.sua(a, c) :
        ...
        dwa: function (a) {
            var b = g.F.rka;
            g.l.Af && (g.F.g(a, "touchstart", b, this), g.F.g(a, "touchmove", b, this), g.F.g(a, "touchend", b, this));
            g.l.Z || (g.F.g(a, "mousedown", b, this), g.F.g(a, "mouseup", b, this), g.F.g(a, "mousemove", b, this), g.F.g(a, "mousewheel", b, this));
            g.l.vS && (g.F.g(a, "pointerdown", b, this), g.F.g(a, "pointerup", b, this), g.F.g(a, "pointermove", b, this));
            g.l.m5 && (g.F.g(a, "MSPointerDown", b, this), g.F.g(a, "MSPointerUp", b, this), g.F.g(a, "MSPointerMove", b, this))
            ...
            return a && a.getBoundingClientRect ? (a.qL = a.getBoundingClientRect(), a.DV = [a.clientLeft, a.clientTop], !0) : !1
        }, uxa: function (a) {
            a.qL && (a.qL = null, a.DV = null)
        }, Wna: function (a, b) {
            var c = b.qL || b.getBoundingClientRect(), d = b.DV || [b.clientLeft, b.clientTop];
            return new g.H(a.clientX - c.left - d[0], a.clientY - c.top - d[1])
        }, Pl: function (a, b) {
            if (b && b.getBoundingClientRect) return this.Wna(a, b);
            var c = document.body,
                d = document.documentElement,
                c = new g.H(g.l.Af ? a.pageX : a.clientX + (c.scrollLeft || d.scrollLeft), g.l.Af ? a.pageY : a.clientY + (c.scrollTop || d.scrollTop));
            return b ? c.$a(g.h.MQ(b)) : c
        }, p4: function (a) {
            return 1 === a.which || 0 === a.button || 1 === a.button
        }
    };
    g.extend(g.F, {
        qN: [], PY: !1, mka: function (a, b, c, d) {
            switch (b) {
                case "touchstart":
                    return this.pka(a, b, c, d);
                case "touchend":
                    return this.nka(a, b, c, d);
                case "touchmove":
                    return this.oka(a, b, c, d)
            }
        }, fo: function (a) {
            if (g.l.vS) return a;
            switch (a) {
            ...
            a.addEventListener(this.fo("pointerdown"), e, !1);
            this.PY || (a = function (a) {
                for (var b = 0; b < f.length; b += 1) if (f[b].pointerId === a.pointerId) {
                    f.splice(b, 1);
                    break
                }
            }, document.documentElement.addEventListener(this.fo("pointerup"), a, !1), document.documentElement.addEventListener(this.fo("pointercancel"), a, !1), this.PY = !0);
            return this
            ...
            a.addEventListener(this.fo("pointermove"), e, !1);
            return this
            ...
            a.addEventListener(this.fo("pointerup"), e, !1);
            a.addEventListener(this.fo("pointercancel"),
                e, !1);
            return this
        }, wua: function (a, b, c) {
            c = a["_amap_" + b + c];
            switch (b) {
                case "touchstart":
                    a.removeEventListener(this.fo("pointerdown"), c, !1);
                    break;
                case "touchmove":
                    a.removeEventListener(this.fo("pointermove"), c, !1);
                    break;
                case "touchend":
                    a.removeEventListener(this.fo("pointerup"), c, !1), a.removeEventListener(this.fo("pointercancel"), c, !1)
            }
            return this
        }
    });
    (function () {
        ...
        var c = document.attachEvent, d = navigator.userAgent.match(/(Trident|Edge)/), e = g.a.Qc, f = g.a.fi;
        g.extend(g.F, {
            qka: function (e, f) {
    ...
    g.pb = {
        fsa: g.A.yb + "/maps", gu: g.aa.gu, OR: 0, Qy: [], bu: {}, Kg: function (a, b) {
            function c() {
                d += 1;
                d === e.length && b && b()
            }
            ...
            for (f = 0; f < e.length; f += 1) this.VP(e[f], c)
        }, RC: function (a) {
            for (var b = 0; b < a.length; b += 1) if (1 !== this.dC(a[b]).status) return !1;
            return !0
        }, VP: function (a, b) {
            var c = this.dC(a);
            if (1 === c.status) b && b(); else {
                b && c.zx.push(b);
                try {
                    if (g.l.$r && window.localStorage) {
                        var d = window.localStorage["_AMap_" +
                        a];
                        d && (d = JSON.parse(d), d.version === g.A.tj ? (window._jsload_(a, d.script, !0), d.css && window._cssload_(a, d.css, !0)) : window.localStorage.removeItem("_AMap_" + a))
                    }
                } catch (e) {
                }
                if (0 === c.status) {
                    this.aua(a);
                    var f = this;
                    f.OR || (f.OR = 1, window.setTimeout(function () {
                        f.OR = 0;
                        var a = f.fsa + "/modules?v=" + g.A.er + "&key=" + g.A.key + "&m=" + f.Qy.join(",") + "&vrs=" + g.A.tj;
                        g.pb.et(f.Qy.join(","));
                        f.Qy = [];
                        c.YJ = f.Bra(a)
                    }, 1));
            ...
            if (c) {
                ...
                for (var f = 0, c = function () {
                    f += 1;
                    f === d.length && b && b()
                }, e = 0; e < d.length; e += 1) this.VP(d[e], c)
            } else this.VP(a, b)
        }, aua: function (a) {
            for (var b = 0; b < this.Qy.length; b += 1) if (this.Qy[b] === a) return;
            this.Qy.push(a)
        }, ln: function (a, b) {
            var c = this.dC(a);
            try {
            ...
            c.status = 1;
            for (var e = 0, f = c.zx.length; e < f; e += 1) c.zx[e]();
            c.zx = []
        }, od: function (a, b) {
            var c = this;
            c.timeout = setTimeout(function () {
                1 !==
                c.bu[a].status ? (c.remove(a), c.load(a, b)) : clearTimeout(c.timeout)
            }, 5E3)
        }, dC: function (a) {
            this.bu[a] || (this.bu[a] = {}, this.bu[a].status = 0, this.bu[a].zx = []);
            return this.bu[a]
        }, remove: function (a) {
            this.bu[a] = null
        }, Bra: function (a) {
    ...
    window._jsload_ = function (a, b, c) {
        var d = g.pb.dC(a);
        d.YJ && 0 <= g.a.indexOf(document.body.childNodes, d.YJ) && document.body.removeChild(d.YJ);
        d.YJ = null;
        try {
            if (!c && window.localStorage && b && "" !== b && g.l.$r) {
                var e = window.localStorage["_AMap_" + a], e = e || "{}", e = JSON.parse(e);
                e.version !== g.A.tj || e.script ? window.localStorage.setItem("_AMap_" + a, JSON.stringify({
                    version: g.A.tj,
                    script: b
    ...
    window._cssload_ = function (a, b, c) {
        try {
            !c && window.localStorage && b && "" !== b && g.l.$r && window.localStorage.setItem("_AMap_" + a, JSON.stringify({
                css: b,
                version: g.A.tj
            }))
        } catch (d) {
    ...
    (function (a) {
        ...
        if (!g.indexedDB && b.xi) {
            var c = a.indexedDB || a.webkitIndexedDB || a.msIndexedDB || a.mozIndexedDB,
                d = a.IDBKeyRange || a.dGa || a.MDa || a.LDa;
            if (c) {
                var e = g.a, f = null;
                a = "amap-jsapi" + (a.Cya ? "-debug" : "");
                ...
                g.indexedDB = {
                    CB: function (a, b) {
                        ...
                        e.isArray(a) || (a = [a]);
                        var d = a.length, f =
                            d, k = 0, h = Math.ceil(d / 5), l = setInterval(function () {
                            if (k++ < h) {
                                var e = 5 * k;
                                e > d && (e = d);
                        ...
                        c.openCursor(d.bound(a[0], a[a.length - 1])).onsuccess = function (c) {
                            if (c = c.target.result) {
                                ...
                                for (var d = -1,
                                         f = 0, k = a.length; f < k; f++) if (a[f] > c.value.tileKey) {
                                    d = f;
                                    break
                                }
                                c["continue"](a[d])
    ...
    (function () {
        ...
        function b(a) {
            var b = g.A.tj + "|" + a.yi.replace(/\//g, ",") + "|" + (a.vf ? "w" : "v") + "|", c;
            c = a.ia;
            var d = a.le;
        ...
        function h() {
            ...
            a && (a.BK === u.data.BK && a.z0 === u.data.z0 ? u.data = a : e())
        }

        function k() {
            u.data = {BK: q.Bf, z0: g.A.tj, keys: [], sf: {}, Vm: {}};
            u.Fs = {}
        }

        function l(a) {
            a && (u.data.BK = a, q.Bf = a)
        }
        ...
        function n(a) {
            if ("object" === typeof a && null !== a) {
                ...
                } else if (r.Tj(a, "Float32Array")) b.push("__Float32Array"), b.push(Array.prototype.slice.call(a)); else if (r.Tj(a, "Uint16Array")) b.push("__Uint16Array"), b.push(Array.prototype.slice.call(a)); else for (d in b = {}, a) a.hasOwnProperty(d) && (b[d] = n(a[d]));
                return b
            }
            return a
        }
        ...
        var q = g.l, r = g.a;
        if (!g.zj && q.xi) {
            var s = g.indexedDB, u = {VK: 1E3, key: "_AMap_data.tileKeys"}, v = [], x = {
                getItem: function (a,
                                   b) {
                    ...
                    var d = b;
                    c && (d = JSON.stringify(b), 1.5 < d.length / 1024 / 1024 && Object.keys(b.Vm).length && (b.Vm = {}, d = JSON.stringify(b)));
                    try {
            ...
            g.zj = {
                clear: e, get: function (c, d) {
                    function f(a) {
                        var b = {bR: l, j5: H, HDa: x, sf: u.data.sf};
                        a && z.length && (/\|limg/.test(z[0]) ? b.O4 = a.map(function (a) {
                    ...
                    var h = "FS" === c.type;
                    if (!q.$r || !(h || q.xi && 0 !== u.data.keys.length)) return d({code: 1});
                    var l = [], x = [], z = [], H = [], G = [];
                    c.ywa.forEach(function (a) {
                        var d = !1, e = b({yi: a.key, url: c.url, vf: c.vf, ia: c.o.ia, le: c.le});
                        h && (v.push(e), u.data.Vm[e] && (l.push(a), z.push(e), G.push({
                            data: p(u.data.Vm[e]),
                            tileKey: e
                        }),
                            d = !0));
                        d || (q.xi && r.ja(u.data.keys, e) ? (z.push(e), x.push(a)) : H.push(a))
                    });
                    ...
                    s.get(z, {timeout: c.timeout || 1E3}, function (b, c) {
                        if (b || c.length !== z.length) b && 3 === b.code ? q.xi = !1 : e(), H = x, x = [], f(null); else {
                            if (h) for (var d = c.length - 1; 0 <= d; d--) {
                                var k = c[d];
                                k && k.data ? u.data.Vm[k.tileKey] = n(k.data) : H.push(x.splice(d, 1)[0])
                            }
                            l = x;
                            x = [];
                            f(c);
                    ...
                    a.Eb.forEach(function (c) {
                        c =
                            b({yi: c.key, url: a.url, vf: a.vf, ia: a.o.ia, le: a.le});
                        u.Fs[c] && delete u.Fs[c]
                    })
                }, set: function (a, c) {
                    a.Bf && a.Bf !== u.data.BK && (l(a.Bf), e(), c && c({code: 2}));
                    !a.sd && a.Ic ? a.Ic.forEach(function (c) {
                        var d = b({yi: c.yi, url: a.url, vf: a.vf, ia: a.o.ia, le: a.le});
                        if (q.xi || r.ja(v, d)) {
                            var e = u.Fs[d] || {};
                            e[c.Sc] = c.Aa;
                            u.Fs[d] = e
                        ...
                        var d = b({yi: c.key, url: a.url, vf: a.vf, ia: a.o.ia, le: a.le});
                        if (q.xi || r.ja(v, d)) u.Fs[d] = c.data
                    });
                    u.data.sf = {"x-vd-v": a["x-vd-v"], tv: a.tv, bgc: a.bgc}
                }, flush: function () {
                    var a =
                        !0;
                    return function () {
                        var b = this;
                        if (a) {
                            if (Object.keys(u.data.Vm).length) for (var c in u.data.Vm) u.data.Vm.hasOwnProperty(c) && !r.ja(v, c) && delete u.data.Vm[c];
                            q.xi ? s.count(function (a, c) {
                    ...
                    var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : !1, b = {}, d = [],
                        f = Object.keys(u.Fs), k = [];
                    f.length ? (f.forEach(function (a) {
                        var c = u.Fs[a];
                        a.split("|").pop().split(",").every(function (a) {
                            return "limg" ===
                            a ? !0 : c && void 0 !== c[a]
                        }) ? (r.ja(u.data.keys, a) || (k.push(a), d.push({
                            tileKey: a,
                            data: c
                        })), r.ja(v, a) && void 0 === u.data.Vm[a] && (u.data.Vm[a] = c)) : b[a] = c
                    }), d.length && (q.xi ? s.add(d, function (a) {
                        a ? 3 !== a.code ? e() : q.xi = !1 : (u.data.keys = u.data.keys.concat(k), x.setItem(u.key, u.data, !0), c())
                    }) : x.setItem(u.key, u.data, !0)), u.Fs = b) : (a && x.setItem(u.key, u.data, !0), c())
                }
            };
            h()
        }
    ...
    g.T = g.aa.extend({
        r: function (a, b, c) {
            ...
            return g.a.lc(this.Q, 6)
        }, sQ: function () {
            return g.a.lc(this.P, 6)
        }, add: function (a, b) {
            ...
            return g.a.lc(this.Q, 6) + "," + g.a.lc(this.P, 6)
        }, cl: function () {
            return [this.Q,
                this.P]
        }, mb: function () {
            var a = this.controlPoints, b = new g.T(this.Q, this.P);
            a && (b.controlPoints = [].concat(a));
            return b
        }
    });
    g.T.Toa = function (a, b, c) {
        c = c + 1 || Math.round(Math.abs(a.Q - b.Q));
        if (!c || 0.001 > Math.abs(a.Q - b.Q)) return [];
        var d = [], e = Math.PI, f = g.mm.eu, h = g.mm.fua, k = Math.asin, l = Math.sqrt, m = Math.sin, n = Math.pow,
    ...
    g.Ee = g.aa.extend({
        r: function () {
            ...
            return new g.T(this.xc.Q, this.nc.P, !0)
        }, io: function () {
            return new g.T(this.nc.Q, this.xc.P, !0)
        }, contains: function (a) {
            var b = this.xc, c = this.nc, d;
            if (a instanceof g.No) return this.RT().contains(a);
            a instanceof g.Ee ? (d = a.xc, a = a.nc) : d = a = g.a.Ia(a);
            var e = d.Q, f = b.Q, h = a.Q, k = c.Q;
            f > k && (k += 360, 0 > e && (e += 360), 0 > h && (h += 360));
            return d.P >= b.P && a.P <= c.P && e >= f && h <= k
        }, Gg: function (a) {
            var b = this.xc, c = this.nc,
                d = a.xc;
            a = a.nc;
            var e = a.Q >= b.Q && d.Q <= c.Q;
            return a.P >= b.P && d.P <= c.P && e
        }, ji: function () {
            return new g.T(this.xc.Q > this.nc.Q ? (this.xc.Q + this.nc.Q + 360) / 2 % 360 : (this.xc.Q + this.nc.Q) / 2, (this.xc.P + this.nc.P) / 2)
        }, extend: function (a) {
            ...
            return this.extend(a.xc).extend(a.nc)
        }, toString: function () {
            return this.xc.toString() + ";" + this.nc.toString()
        }, mb: function () {
            return new g.Ee(this.xc.mb(),
                this.nc.mb())
        }, cb: function (a) {
            return a instanceof g.Ee ? this.xc.cb(a.xc) && this.nc.cb(a.nc) : !1
        }, gj: function () {
            return Math.abs(this.nc.Q - this.xc.Q)
        }, ej: function () {
            return Math.abs(this.xc.P - this.nc.P)
        }, RT: function (a) {
            var b = [this.zu(), this.io(), this.cy(), this.Nj()];
            a && b.push(this.zu());
            return new g.No(b)
        }, Cwa: function (a) {
            return new g.Ef(a.ec(this.Nj(), 20), a.ec(this.io(), 20))
        }, oQ: function (a, b) {
            return this.RT(b).oQ(a)
        }, lQ: function (a) {
            return this.Cwa(a).ji()
        }
    });
    g.Ee.Mb({
        zu: "getSouthWest",
    ...
    g.vd = g.aa.extend({
        r: function (a, b, c) {
            ...
            return new g.vd(this.width, this.height)
        }, gj: function () {
            return this.width
        }, ej: function () {
            return this.height
        }, WD: function () {
            return new g.H(this.gj(), this.ej())
        }, contains: function (a) {
            return Math.abs(a.x) <= Math.abs(this.width) && Math.abs(a.y) <= Math.abs(this.height)
        }, cb: function (a) {
            return a instanceof g.vd && this.width ===
                a.width && this.height === a.height
        }, toString: function () {
            return this.gj() + "," + this.ej()
        }
    });
    g.vd.Mb({gj: "getWidth", ej: "getHeight", toString: "toString"});
    g.No = g.aa.extend({
        r: function (a) {
            ...
            return g.zd.Md(a, this.path, b)
        }, toBounds: function () {
            for (var a = new g.Ee(180, 90, -180, -90), b = this.Ud.length - 1; 0 <= b; b -= 1) a.extend(this.Ud[b]);
            return a
        }, oQ: function (a) {
            for (var b = [], c = 0; c <
            ...
            return this.toBounds().lQ(a)
        }, ji: function () {
            return this.toBounds().ji()
        }
    });
    g.No.Mb({contains: "contains", ji: "getCenter"});
    g.C9 = g.No.extend({
        r: function (a) {
    ...
    g.Ef = g.aa.extend({
        r: function () {
            if (2 === arguments.length) this.Xb = arguments[0], this.Pd = arguments[1]; else if (1 === arguments.length && arguments[0] instanceof Array || 4 === arguments.length) {
                var a = arguments[0] instanceof Array ? arguments[0] : arguments;
                this.Xb = new g.H(a[0], a[1]);
                this.Pd = new g.H(a[2], a[3])
            } else throw"Invalid Object: PixelBounds(" + arguments.join(",") + ")";
        }, ji: function (a) {
            return new g.H((this.Xb.x + this.Pd.x) / 2, (this.Xb.y + this.Pd.y) / 2, a)
        }, contains: function (a) {
            var b;
            a instanceof g.Ef ? (b = a.Xb, a = a.Pd) :
                b = a;
            return b.x > this.Xb.x && a.x < this.Pd.x && b.y > this.Xb.y && a.y < this.Pd.y
        }, gj: function () {
            return this.Pd.x - this.Xb.x
        }, ej: function () {
            return this.Pd.y - this.Xb.y
        }, Gg: function (a, b) {
            b || 0 === b || (b = 20);
            var c = this.Xb, d = this.Pd, e = a.Xb, f = a.Pd, h = f.y >= c.y - b && e.y <= d.y + b;
            return f.x >= c.x - b && e.x <= d.x + b && h
        }, toString: function () {
            return this.Xb + ";" + this.Pd
        }, mb: function () {
            return new g.Ef(this.Xb.mb(), this.Pd.mb())
        }
    });
    g.I = {};
    g.I.KO = function (a) {
        for (var b = [Infinity, Infinity, -Infinity, -Infinity], c = 0, d = a.length; c < d; c += 1) g.I.NH(b, a[c]);
        return b
    };
    g.I.L0 = function (a, b, c) {
        var d = Math.min.apply(null, a);
        a = Math.max.apply(null, a);
        var e = Math.min.apply(null, b);
        b = Math.max.apply(null, b);
        return g.I.Dma(d, a, e, b, c)
    };
    ...
    g.I.touches = function (a, b) {
        return g.I.Gg(a, b) && (a[0] === b[2] || a[2] === b[0] || a[1] === b[3] || a[3] === b[1])
    };
    g.I.transform = function (a, b, c) {
        a = [a[0], a[1], a[0], a[3], a[2], a[1], a[2], a[3]];
        b(a, a, 2);
        return g.I.L0([a[0], a[2], a[4], a[6]], [a[1], a[3], a[5], a[7]], c)
    };
    g.Ee.zb({
        r: function () {
            var a = g.Ee.prototype.r;
            return function () {
    ...
    g.VE = g.aa.extend({
        r: function (a, b, c, d) {
            ...
            return this.X_(a.mb(), b)
        }, X_: function (a, b) {
            b = b || 1;
            a.x = b * (this.OV * a.x + this.dW);
            a.y = b * (this.rW * a.y + this.OW);
            return a
        }, vxa: function (a, b) {
            b = b || 1;
            return new g.H((a.x / b - this.dW) / this.OV, (a.y / b - this.OW) / this.rW)
        }
    });
    g.To = g.aa.extend({
        r: function (a) {
    ...
    g.To.J$ = new g.To({
        MAX_LATITUDE: 85.0511287798, project: function (a) {
            var b = Math.PI / 180, c = this.UK, c = Math.max(Math.min(c, a.P), -c);
            a = a.Q * b;
    ...
    g.To.iV = {
        UK: 85.0840591556, fL: 6356752.3142, eL: 6378137, ec: function (a) {
            var b = Math.PI / 180, c = this.UK, d = Math.max(Math.min(c, a.P), -c), e = this.eL, c = this.fL;
            a = a.Q * b * e;
            b *= d;
            e = c / e;
            e = Math.sqrt(1 - e * e);
    ...
    g.Ph.wE = {
        VC: function (a, b) {
            var c = this.wf.ec(a), d = this.scale(b);
            return this.$D.X_(c, d)
        }, sD: function (a, b, c) {
            b = this.scale(b);
            a = this.$D.vxa(a, b);
            return this.wf.Mh(a, c)
        }, ec: function (a) {
            return this.wf.ec(a)
        }, scale: function (a) {
            return 256 << a
    ...
    g.Ph.LK = g.extend({}, g.Ph.wE, {
        code: "EPSG:3857",
        wf: g.To.J$,
        $D: new g.VE(0.5 / Math.PI, 0.5, -0.5 / Math.PI, 0.5),
        ec: function (a) {
            return this.wf.ec(a).Fd(6378137)
        }
    });
    g.Ph.OU = g.extend({}, g.Ph.wE, {
        code: "EPSG:3395", wf: g.To.iV, $D: function () {
            var a = g.To.iV;
            return new g.VE(0.5 / (Math.PI * a.eL), 0.5, -0.5 / (Math.PI * a.fL), 0.5)
        }()
    });
    g.Ph.PU = g.extend({}, g.Ph.wE, {code: "EPSG:4326", wf: g.To.dV, $D: new g.VE(1 / 360, 0.5, -1 / 360, 0.25)});
    g.Ph.Xya = g.extend({}, g.Ph.wE, {wf: g.To.dV, $D: new g.VE(1, 0, 1, 0)});
    g.UI = {
        ec: function (a, b) {
            a = g.a.Ia(a);
            return this.Zi.VC(a, b || this.get("zoom"))
        }, Mh: function (a, b, c) {
            return this.Zi.sD(a, b || this.get("zoom"), c)
        }, ora: function (a, b) {
            return this.ec(a, b)
        }, YBa: function (a, b) {
            return this.Mh(a, b)
            ...
            for (var c = [], e = 0, f = a.length; e < f; e += 1) if (d) {
                ...
                c[e] = [h.x, h.y]
            } else c[e] = this.P4(a[e], !0);
            return c
        }, qoa: function (a) {
            return this.Mh(a.add(g.a.Zb), 20)
        }, ZBa: function (a) {
            return this.ze(a.add(g.a.Zb))
        }, gCa: function (a) {
            return a ?
    ...
    A.Jb = g.aa.extend({
        ja: [g.sa, g.Qe, g.UI], B: {
            ...
            isHotspot: !g.l.Z,
            baseRender: g.l.D0,
            overlayRender: g.l.fta,
            mapStyle: "normal",
            showBuildingBlock: g.l.vf,
            crs: "EPSG3857",
            rotation: 0,
            pitch: 0,
            yaw: 0,
        ...
        detailOnAMAP: function (a) {
            ...
            "en" !== a && "zh_cn" !== a && "zh_en" !== a || a === this.get("lang", null, !0) || (this.set("lang", a), this.Rj && this.Rj.U6(this))
        }, getLang: function () {
        ...
        getScreenShot: function (a, b) {
            ...
            return this.map && g.l.Mk ? this.map.f3(a, b) : ""
            ...
            (new g.fb.vb(c, {callback: "callback", vx: !0, Sc: "REGEO"})).g("complete", function (b) {
            ...
            b.bgColor && g.extend(g.A.oe, b.bgColor);
            ...
            "3D" === b.viewMode && g.l.nq && void 0 === b.showBuildingBlock && !0 === b.showBuildingBlock;
            this.Np = !!b.enableSocket;
            b.server && (g.A.Rd = b.server);
            b.vdataUrl && (g.A.AK = b.vdataUrl);
            if ("string" === typeof a) {
            ...
            b.zooms ? (b.zooms[0] = Math.max(d, b.zooms[0]), !0 === b.expandZoomRange && (c = g.l.Z ? g.l.Nc ? 19 : 20 : 20), b.zooms[1] = Math.min(c, b.zooms[1])) : b.zooms = [d, c];
            b.forceZooms && (b.zooms = b.forceZooms);
            b = this.xla(b);
            c = this.getSize(!0);
            b.center && (b.center = g.a.Ia(b.center));
            this.Zi = this.Ema(b.crs || this.B.crs, b.center || this.B.center);
            this.Hka(c, b);
            d = b.lang;
            "en" !== d && "zh_cn" !== d && "zh_en" !== d && (b.lang = "zh_cn");
            g.h.dg || (b.rotation = 0, b.pitch = 0, b.rotateEnable = !1);
            g.l.zR ? !1 !== b.workerMode && (A.Jb.et ? (b.workerMode = !1, A.Jb.et++) : A.Jb.et = 1) : (b.workerMode = !1, b.preloadMode = !1);
            b.layers && (d = b.layers, delete b.layers, b.layers = d);
            b.baseRender = b.baseRender || g.l.D0;
            b.forceVector && (b.baseRender = g.l.vf ? "vw" : "v");
            ...
            "vw" === b.baseRender && c > g.l.Sra && (b.baseRender = "dv");
            "d" == b.baseRender && b.vectorMapForeign &&
            (b.vectorMapForeign = !1, b.gridMapForeign = !0);
            g.a.Db(this, b);
            this.Xe(this.B);
            "rotateEnable" in b || "3D" !== b.viewMode || !g.l.nq || this.set("rotateEnable", !0);
            "pitchEnable" in b || "3D" !== b.viewMode || !g.l.nq || this.set("pitchEnable", !0);
            ...
            b.vectorMapForeign &&
            g.l.Xt && f.push("MVT", "vectorForeign");
            b.forceVector && (f.push("vectorlayer"), f.push("overlay"));
            "3D" === b.viewMode && g.l.nq && f.push("Map3D");
            g.l.Mk && (b.vectorMapForeign || b.mapStyle || b.nolimg) && f.push("labelcanvas");
            b.editEnable && f.push("edit");
            g.l.Mk && (f.push("AMap.IndoorMap"), -1 !== f.indexOf("Map3D") && f.push("AMap.IndoorMap3D"));
            ...
            this.Era(function () {
                g.pb.Kg(f, function () {
                    if (!e.get("destroy")) {
                        ...
                        b.Re("zoom center centerCoords rotation yaw pitch resolution".split(" "), e.view, !0);
                        b.g("complete", function () {
                            this.q("complete")
                        }, e, !0);
                        b.Zi = e.Zi;
                        e.Re(["zoomSlow", "panTo", "targetLevel", "render"], b);
                        b.Re(["size", "bounds"], e);
                        e.loaded = !0;
                        e.q("coreMapCreated");
                        g.l.Mk && e.ika();
                        e.C = !0;
                        "3D" === e.view.type && (e.AmbientLight || (e.AmbientLight = new g.gw.EU([1, 1, 1], 0.9)), e.DirectionLight || (e.DirectionLight = new g.gw.NU([0, -1, 1], [1, 1, 1], 0.1)));
                        e.C = !1
                    }
                })
            })
            ...
            if (g.l.te || g.Ke) a(); else {
                var c = !0;
                try {
                    var d = JSON.parse(localStorage.getItem("_AMap_anole"));
                    d && d.version === g.l.Bf && d.script ? eval(d.script) : c = !1
                } catch (e) {
                    c = !1
                }
                if (c) b(), a(); else {
                    ...
                    f.id =
                        "amap_anole_js";
                    f.src = g.A.Bc + "://vdata.amap.com/style?v=" + g.A.er + "&key=" + g.A.key + "&mapstyle=normal";
                    c = document;
                    (c.head || c.getElementsByTagName("head")[0] || c.body).appendChild(f);
                    f.onload = function () {
                        if (!g.Ke) {
                            if (g.l.$r) try {
                                var c = {version: g.l.Bf, script: "AMap['anole']=" + JSON.stringify(AMap.anole)};
            ...
            if ((a = new g.Ee(a[0],
                ...
                for (var e = c[1]; e > c[0]; e -= 1) {
                    var f = this.ec(a.xc, e), h = this.ec(a.nc, e);
            ...
            if (!(b && b.center && b.zoom)) {
                var c = this.woa(g.A.Ud, a, b.zooms);
            ...
            if (b instanceof g.T) {
                ...
                if (a.pointToLngLat &&
                    a.lngLatToPoint) return {sD: a.pointToLngLat, VC: a.lngLatToPoint, Gp: a.getResolution};
            ...
            e && (this.tw = new g.uj(d, a, null, 0), this.tw.transition =
                function (a, c, e) {
                    e /= b || 300;
                    if (1 <= e) return c;
                    var f = {}, h;
                    for (h in d) d.hasOwnProperty(h) && (f[h] = "center" === h ? a[h].add(c[h].$a(a[h]).Fd(e)) : a[h] + (c[h] - a[h]) * e);
                    return f
                }, this.tw.Xp = function (b) {
                b === a && (this.tw.stop(), this.yd = null);
                for (var c in b) b.hasOwnProperty(c) && ("center" === c ? (this.C = !0, this.setCenter(b[c], !0), this.C = !1) : this.set(c, b[c]))
            }, this.tw.ln(this))
        }, Gma: function (a) {
            "3D" === this.get("viewMode") && g.l.nq ? (this.set("baseRender", "vw"), this.view = new g.pL(this, a)) : this.view = new g.YE(this, a);
            this.S3()
        },
        S3: function () {
            this.ni = "d" < this.get("baseRender") || "3D" === this.view.type
            ...
            if (this.Vl) {
                ...
                b = this.getLayers();
                this.C = !1;
                for (var c in b) b.hasOwnProperty(c) && "AMap.IndoorMap" === b[c].CLASS_NAME && b[c] !== this.Vl && (a = !1);
                this.Vl.getMap() !== this && this.Vl.setMap(this);
                this.Vl.set("visible", a)
            }
        }, ZO: function () {
            this.P8();
            if (this.view && "3D" !== this.view.type) {
                ...
                if (a && !("dv" < a)) {
                    ...
                    b && c && (g.l.Xt && (d || "all" !== b || "normal" !== c && "amap://styles/normal" !== c) ? (this.set("baseRender", "v"), this.lS = a) : this.lS && (this.set("baseRender", this.lS), this.lS = null));
                    this.S3()
                }
            }
        }, ika: function () {
            var a = this;
            !a.Vl && a.J && (a.indoorMap = a.Vl = new AMap.IndoorMap({innerLayer: !0}), a.yT(), g.a.Qc(function () {
                a.q("indoor_create",
                    {target: a});
                a.set("display")
            }))
            ...
            if (this.map) return this.map.AD()
        }, getAdcode: function () {
            ...
            function a() {
                var a = !1;
                g.a.Qb(b.B.layers, function (b) {
                    if (b.PF && b.constructor === A.o.nb) return a = !0, !1
                }, b);
            ...
            if (!this.z6) {
                ...
                if (d && !c) this.$j(d), this.set("rasterLayer", void 0); else if (!d && c && this.get("layers")) {
                    d = new A.o.nb({innerLayer: !0, map: this, Zj: !0, zIndex: 0});
                    d.Jqa = !0;
                    if (this.B.layers) {
                        var e = null;
                        g.a.Qb(this.B.layers, function (a) {
                            a instanceof A.o.nb && a.PF && (null === e || a.get("zIndex") >
                                e.get("zIndex")) && (e = a)
                        });
                        e && d.Re(["zIndex", "opacity", "zooms", "visible"], e)
                    }
            ...
            a.layers && 0 !== a.layers.length ? this.set("defaultLayer", a.layers[0], !0) : (b = new A.o.nb({innerLayer: !0}), a.layers = [b], b.AO = !0, this.set("defaultLayer", b, !0));
            ...
            0 <= g.a.indexOf(b, a) || (a instanceof A.w.rn ? (this.get("overlays").push(a), this.Ex instanceof A.w.rn && (this.Ex.C = !0, this.Ex.close(), this.Ex.C = !1), this.Ex = a, this.set("contextmenu", a, !0)) : (a instanceof A.w.Pe && (this.Wl instanceof A.w.Pe && this.Wy(this.Wl), this.Wl = a), this.get("overlays").push(a)), this.q("overlays"))
        }, $j: function (a) {
            ...
            if (-1 !== c) {
                if (a.jY) {
                    for (c =
                             b.length; -1 < --c;) {
                        var d = b[c];
                        d.oA !== a && d !== a || b.splice(c, 1)
                    }
                    a = b
                } else a.oA && a.oA.nja(a), a = g.a.Yn(b, c);
                this.set("layers", a)
            }
        }, getZooms: function () {
            ...
            var b = this.get("overlays");
            this.set("overlays", g.a.Yn(b, g.a.indexOf(b, a)))
            ...
            return this.tC(this.get("targetLevel") || this.get("zoom", null, !0))
        }, getCenter: function () {
            ...
            return this.Zi.Gp(b || this.get("zoom")) *
            ...
            return this.view && "3D" === this.view.type ? g.a.lc(a, 4) : Math.round(a)
            ...
            for (var a = this.get("overlays"), b = 0; b < a.length; b += 1) a[b].set("map",
                null, !0);
            this.set("overlays", []);
            if (this.map && this.map.ra) for (a = this.map.ra, b = a.length - 1; 0 <= b; b -= 1) if (a[b].V instanceof A.o.OK) {
                var c = a[b].V;
                c.C = !0;
                c.setMap(null);
                c.C = !1
            ...
            this.Vl && (this.Vl.setMap(), this.indoorMap = this.Vl = null);
            this.set("overlays", []);
            ...
            a && 0 !== a.length && this.Wl && (this.Wl.C = !0, this.Wl.close(), this.Wl.C = !1)
        }, remove: function (a) {
            g.c.add(this,
                "remove");
            ...
            d = this.get("layers");
            e = [];
            if (d) for (var f = 0, h = d.length; f < h; f += 1) d[f] instanceof A.o.OK && e.push(d[f]);
            return c.concat(e)
        }, triggerResize: function () {
            this.map && this.map.RN()
        }, refreshSize: function () {
            this.qF = this.Boa()
        }, Boa: function () {
            return g.h.A2(this.J)
        }, getSize: function () {
            g.c.add(this, "getSize");
            (!this.qF || 10 > this.qF.width *
                this.qF.height) && this.refreshSize();
            return this.qF
            ...
            b = this.loaded && this.map && this.map.yd ? this.map.yd.Y7 : this.get("centerCoords");
            ...
            if (a = this.T2(a)) {
                if (c = this.gI(a, 0, new g.H(40, 40), c, d)) b = b || !this.getBounds().contains(a.ji()) || g.l.Z && 1 < Math.abs(c[0] + this.get("zoom", null, !0)), this.setZoomAndCenter(c[0], c[1], b);
                this.C = !1;
                return a
            }
        }, T2: function (a) {
            if (a) if (a instanceof A.w.sh) a = [a]; else {
                if (!(a instanceof
                    Array)) return null
            ...
            if (a) {
                for (var b, c = 0; c < a.length; c += 1) {
                    var d = a[c];
                    if (d.get("visible") && !(d instanceof A.w.Pe || d instanceof A.w.rn)) {
                        d.C = !0;
                        var e = d.getBounds();
                        d.C = !1;
                        e && (b = b ? b.txa(e) : e.mb())
            ...
            c = this.gI(a, b, c, e, f);
            d = d || g.l.Z && 1 < Math.abs(c[0] + b - this.get("zoom",
                null, !0));
            this.C = !0;
            ...
            a = this.T2(a);
            return this.gI(a, b, c, d, e)
        }, getCoordsBoundByZoomIn3D: function (a) {
            this.dH || (this.dH = new g.pL);
            this.C = !0;
            var b = this.getRotation(), c = this.getPitch(), d = this.getSize(!0).mb();
            this.C = !1;
            ...
            b = b ? Number(b) : 0;
            this.C = !0;
            var f = this.getRotation(), h = this.getPitch(),
                k = this.getSize(!0).mb(), l = this.view.type;
            this.C = !1;
            var m = a.lQ(this);
            a = a.oQ(this);
            this.LB || (this.LB = "3D" === l ? new g.pL : new g.YE);
            this.LB.Xe({size: k, zoom: 3, rotation: f, pitch: h, centerCoords: m}, !0);
            var n = h = 0;
            ...
            do {
                this.LB.Xe({zoom: d}, !0);
                "3D" === l && this.LB.wq();
                for (var q = p = Infinity, r = -Infinity, s = -Infinity, u = 0; u < a.length; u +=
                    1) var v = this.LB.ze(a[u]), p = Math.min(p, v.x), r = Math.max(r, v.x), q = Math.min(q, v.y), s = Math.max(s, v.y);
                p = r - p;
                q = s - q;
            ...
            if (this.C) {
                for (var b = [], c = -1, d = a.length; ++c < d;) {
                    var e = a[c];
                    if (e.jY) for (var e = e.dpa(), f = -1, h = e.length; ++f < h;) {
                        var k = e[f];
                        -1 === g.a.indexOf(a, k) && b.push(k)
                    }
                }
                a = a.concat(b)
            } else for (b = a.length; -1 < --b;) a[b].oA && a.splice(b, 1);
            return a
            ...
            g.c.add(this, "render");
            this.map &&
            this.map.set("display", a ? 1 : 0)
        }, setMask: function (a) {
            g.c.add(this, "setMask");
            this.set("mask", a);
            this.map && (this.map.YI = !0, this.map.set("display"))
        }, drawPolygon: function (a) {
            g.c.add(this, "drawPolygon");
            this.set("draw", "polygon");
            this.set("drawStyle", a || {strokeColor: "#006600", jb: 0.9, fillColor: "#FFAA00", ae: 0.9})
        }, drawCircle: function (a) {
            g.c.add(this, "drawCircle");
            this.set("draw", "circle");
            this.set("drawStyle", a || {strokeColor: "#006600", jb: 0.9, fillColor: "#006600", ae: 0.9})
        }, pI: function () {
            return this.view.pI()
        },
        getCameraState: function () {
            g.c.add(this, "getCameraState");
            if (this.view && "3D" == this.view.type) return this.view.z2()
        }, endDraw: function () {
            this.set("draw", null)
        }, isGoogleTileVisible: function () {
            return this.map.isForeignMapVisible()
        }, isForeignMapVisible: function () {
            if (this.get("gridForeignMap") || this.get("vectorForeignMap")) return this.map && this.map.Pea()
        }, ze: function (a, b, c) {
            g.c.add(this, "p20ToContainer");
            return this.view.ze(a, b, c)
        }, kg: function (a, b, c) {
            g.c.add(this, "containerToP20");
            return this.view.kg(a,
                b, c)
            ...
            this.C = !0;
            this.view.kg(a);
            var d = this.view.D2(a), e = this.map.K.FS, f = this.view.Zc, h = this.get("zoom", null, !0),
                h = Math.pow(2, 20 - h);
            b = b || this.getLayers();
            this.C = !1;
            for (var k = [], l = 0; l < b.length; l += 1) {
                var m = b[l];
                m instanceof A.o.Jq && (m = m.Ho(e, d, f, h, a)) && k.push(m)
            }
            return c ? k : k.length ? (k.sort(function (a, b) {
                return a.Nd - b.Nd
            }), {
                index: k[0].index, point: k[0].rD, distance: k[0].Nd,
                object: k[0].object
            }) : null
        }
    });
    A.Jb.Mb({
        QI: "lngLatToGeodeticCoord",
        qoa: "geodeticCoordToLngLat",
        gI: "getFitZoomAndCenterByBounds",
        I2: "getFitZoomAndCenterByOverlays",
        Zr: "lnglatTocontainer",
    ...
    A.Jb.zb({
        isHotspotChanged: function () {
            if ("undefined" !== typeof this.EC && (this.Xla(), this.get("isHotspot"))) {
                var a = this.get("layers", null, !0);
                a && a.length && !this.EC && this.dJ && this.Ssa()
            }
        }, Ssa: function () {
            if (this.Rj) this.E3(); else {
                var a = this;
                this.C = !0;
            ...
            this.Rj.setMap(this);
            this.Rj.C = !1;
            a.g("mouseover", this.I5, this);
            a.g("click", this.G5, this);
            a.g("mouseout", this.H5, this)
        }, Upa: function () {
            var a = this.Rj;
            a.G("mouseover", this.I5, this);
            a.G("click", this.G5, this);
    ...
    A.event = {
        X: function (a, b, c, d) {
            g.F.g(a, b, c, d);
            return new g.AE(0, a, b, c, d)
        }, jka: function () {
        }, addListener: function (a, b, c, d) {
            g.a.Eh(a.addListener) ? a.addListener(b, c, d) : (a.fe || (a.fe = g.sa.fe), g.sa.g.call(a, b, c, d));
            return new g.AE(1, a, b, c, d)
        }, qx: function (a, b, c, d) {
            g.a.Eh(a.qx) ? a.qx(b, c, d) : (a.fe || (a.fe = g.sa.fe), g.sa.g.call(a, b, c, d, !0));
            return new g.AE(1, a, b, c, d)
        }, qH: function (a) {
            g.a.Eh(a.qH) ? a.qH() : g.sa.gi.call(a)
        }, Yt: function (a, b) {
            g.a.Eh(a.Yt) ? a.Yt(b) : g.sa.gi.call(a, b)
        }, removeListener: function (a) {
            a instanceof
            g.AE && (g.a.Eh(a.mi.removeListener) ? a.mi.removeListener(a) : 0 === a.type ? g.F.G(a.mi, a.RP, a.WQ, a.Se) : 1 === a.type && (a.mi.fe || (a.mi.fe = g.sa.fe), g.sa.G.call(a.mi, a.RP, a.WQ, a.Se)))
        }, O: function (a, b) {
    ...
    var nc = {
        X: "addDomListener",
        jka: "addDomListenerOnce",
        addListener: "addListener",
        qx: "addListenerOnce",
        qH: "clearInstanceListeners",
        Yt: "clearListeners",
    ...
    A.o.ac = g.aa.extend({
        ja: [g.sa, g.Qe], r: function (a) {
            ...
            g.c.add(this, "getContainer");
            if (this.o && this.o.N) return this.o.N.fj()
        }, getZooms: function () {
            return this.get("zooms", null, !0)
            ...
            g.c.add(this, "setMap");
            var b = this.get("map");
            if (a) b && a !== b && b.$j(this), this.set("map", a); else if (b && (b.$j(this), this.set("map", null, !0), this.ei = !1, this.Pg && this.Pg(), this.onRemove)) this.onRemove()
        },
        getMap: function () {
            g.c.add(this, "getMap");
    ...
    A.o.nb = A.o.ac.extend({
        B: {
            ...
            noLimg: 1,
            zooms: [3, 20],
            getTileUrl: g.l.Z ? g.A.ZD : g.A.XC,
            errorUrl: g.a.Gna,
            detectRetina: !0,
            ...
            this.Ela(a);
            var b = a.zooms;
            b && b[1] >= this.Tk[0] ? (b[0] < this.Tk[0] && (b[0] = this.Tk[0]), b[1] > this.Tk[1] && (b[1] = this.Tk[1])) : a.zooms = [this.Tk[0], this.Tk[1]];
            ...
            return a && a !== g.A.XC && a !== g.A.ZD ? !1 : !0
        }, f1: function () {
            if (!this.Mu()) return !1;
            var a = this.get("map");
            return a && a.ni && "zh_cn" === a.get("lang") && !this.noVector ? !0 : !1
        }, Z2: function (a) {
            var b = g.A.VI;
            g.l.ia && this.get("detectRetina") && (b = g.A.VI.replace("scl=1", "scl=2"));
            a && (b = b.replace("ltype=3",
                "ltype=11"));
            return b
        }, Lf: function (a) {
            var b = this.f1(), c = this.get("map");
            this.Mu() && this.set("mapNumber", "GS(2018)1709");
            if (this.Zj) return new g.o.nb(this, a, this.Pq(this.Z2(!0)), this.B.maxDataZoom, !0);
            if (b) if (this.Up = !0, g.o.Uh) {
                if ("dv" === c.get("baseRender") && !this.get("watermark")) {
                    var b = c.get("showBuildingBlock"), d = new g.o.nb(this, a, this.Pq(this.Z2(!b)), void 0, !0);
                    b && (d.Zk = new g.o.nd(new A.o.nb({
                        zooms: [16, 20],
                        innerLayer: !0
                    }), a, ["building"]), d.Zk.type = "\u697c\u5757\u56fe\u5c42", d.Zk.Re(["visible",
                        "opacity", "zIndex"], d, !0), d.Zk.QB(c.get("mapStyle") || "normal"));
                    d.type = "\u6805\u683c\u5e95\u56fe";
                    return d
                }
                if ("v" <= c.get("baseRender") || this.get("watermark")) return "3D" == a.D.view.type ? (c = new g.o.nd(this, a, ["region", "road"]), c.type = "\u77e2\u91cf\u5e95\u56fe", b = new A.o.nb({
                    zooms: [17, 20],
                    zIndex: 50,
                    innerLayer: !0
                }), c.Zk = new g.o.nd(b, a, ["building"]), c.Zk.We = 17, c.Zk.type = "\u697c\u5757\u56fe\u5c42", c.Zk.ky = 1, c.Zk.Re(["visible", "merge", "sort", "opacity"], c, !0), b.W("rejectMapMask", this, !0)) : (c = new g.o.nd(this,
                    a, ["region", "building", "road"]), c.type = "\u77e2\u91cf\u5e95\u56fe"), a.Rka = c
            } else return ["vectorlayer", "overlay"]; else return this.Up = !1, new g.o.nb(this, a, null, this.B.maxDataZoom)
        }, getTileUrlChanged: function () {
            var a = this.get("getTileUrl");
            if (a === g.A.XC || a === g.A.ZD || a === g.A.SJ) this.dJ = !0;
            "string" === typeof a && (a = this.Pq(a));
            this.set("tileFun", a)
        }, Ela: function (a) {
            this.Tk || (this.Tk = [this.B.zooms[0], this.B.zooms[1]]);
            var b;
            ...
            this.f1() ? (this.set("getTileUrl", a), this.qs()) :
    ...
    A.o.nb.mV = A.o.nb.extend({
        B: {
            ...
            if (this.get("map").ni) {
                this.Up = !0;
                var b = g.A.TJ;
                g.l.ia && this.get("detectRetina") && (b = g.A.TJ.replace("scl=1", "scl=2"));
                a = new g.o.nb(this, a, this.Pq(b), this.B.maxDataZoom)
            } else this.Up = !1, a = new g.o.nb(this,
                a);
            return a
        }
    });
    A.o.nb.xV = A.o.nb.extend({
        B: {
            getTileUrl: function (a, b, c) {
                return g.A.Bc + "://tm.amap.com/trafficengine/mapabc/traffictile?v=1.0&t=1&zoom=" + (17 - c) + "&x=" + a + "&y=" + b
            },
            zooms: [6, 20],
            zIndex: 4,
            type: "overlayer",
            ...
            g.c.add(this,
                "stopRefresh");
            this.GJ && (clearInterval(this.GJ), this.GJ = null)
        }, startRefresh: function () {
            g.c.add(this, "startRefresh");
            if (this.get("autoRefresh") && !this.GJ) {
                var a = this;
                this.GJ = setInterval(function () {
                    a.C = !0;
                    a.reload();
                    a.C = !1;
                    a.q("refresh")
            ...
            return "d" !== b.get("baseRender") ? g.o.sw ? a = new g.o.sw(this, a) : ["vt"] : a = new g.o.nb(this, a, null, this.B.maxDataZoom)
        }
    });
    A.o.nb.Pz = A.o.nb.extend({
        B: {
            zooms: [3, 20],
            zIndex: 12,
            detectRetina: !1,
    ...
    A.o.nb.$$ = A.o.nb.Pz.extend({
        B: {
            ...
            this.set("createTile", function (a, e, f, h, k) {
                ...
                "3D" === b.zi && (m.crossOrigin = "anonymous");
    ...
    A.o.nb.aaa = A.o.nb.Pz.extend({
        B: {
            ...
            this.set("createTile", function (a, d, e, f, h) {
                ...
                "3D" === b.zi && (k.crossOrigin = "anonymous");
    ...
    A.o.nb.DE = A.o.nb.Pz.extend({
        B: {detectRetina: !0, zooms: [10, 18], zIndex: 2}, r: function (a) {
            arguments.callee.ka.apply(this, arguments);
            var b = this;
            this.set("createTile", function (a, d, e, f, h) {
                var k = b.He.map.map;
                k.th.nz(a, d, e, function (l) {
                    if (l) h(); else {
                        var m = document.createElement("img");
                        "3D" === b.zi && (m.crossOrigin = "anonymous");
                        g.F.g(m, "load", function () {
                        ...
                        m.src = function (a, c, d) {
                            ...
                            return g.A.Bc + "://grid.amap.com/grid/" + d + "/" +
                                a + "/" + c + "?src=jsapi&key=" + g.A.key + "&lang=" + e + "&dpiType=" + (g.l.Nc ? "wprd" : "webrd")
                        }(a, d, e)
                    }
                })
            })
    ...
    A.o.u9 = A.o.ac.extend({
        B: {zooms: [14, 20], zIndex: 8, visible: !0, merge: !0, sort: !1}, r: function (a) {
            ...
            if (g.l.Xt) return a = new g.o.X$(this, a), a.ky = this.get("heightFactor") || 1, a
        }, setStyle: function (a) {
            this.set("customStyle", a);
            g.c.add(this, "setStyle")
        }
    });
    A.o.IK = A.o.ac.extend({
        B: {visible: !0, zooms: [3, g.l.Z ? 20 : 18], opacity: 1, type: "overlay", zIndex: 6}, r: function (a) {
            arguments.callee.ka.apply(this, arguments)
        }, Lf: function (a) {
            return g.o.Sz ? new g.o.Sz(this, a) : ["imagelayer"]
        }, getMap: function () {
            g.c.add(this, "getMap");
            return this.He.map
        }, show: function () {
            ...
            g.c.add(this, "getBounds");
            return this.get("bounds", null, !0).mb()
    ...
    A.o.w9 = A.o.IK.extend({
        r: function (a) {
            ...
            this.o && (this.o.RD = !0, this.o.set("display"))
        }
    });
    A.o.o$ = A.o.ac.extend({
        B: {
            ...
            g.c.ya(this, b);
            g.l.Mk && (this.ij = !0, b.size && (b.size = g.a.Zp(b.size)), this.C = !0, this.setData(a), g.a.Db(this, b), b.style ? (this.Xe(this.B, !0), this.setStyle(b.style)) : this.setStyle(this.B), this.C = !1)
        }, clear: function () {
            g.c.add(this, "clear");
            ...
            if (a instanceof Array) {
                for (var b = 0; b < a.length; b += 1) a[b].rotation_ = Math.PI * (a[b].rotation || 0) / 180, a[b].size = g.a.Zp(a[b].size), a.lf = Math.max(a.lf || 0, a[b].size.width + a[b].anchor.x), a.Xf = Math.max(a.lf || 0, a[b].size.height + a[b].anchor.y);
                this.dm = a
            } else a.size && (a.size = g.a.Zp(a.size)), a.rotation_ = Math.PI * (a.rotation || 0) / 180, this.Xe(a, !0), this.dm = {
                anchor: this.get("anchor"),
                url: this.get("url"),
                size: this.get("size"),
                rotation_: this.get("rotation_")
            },
                this.dm.lf = this.dm.size.width + this.dm.anchor.x, this.dm.Xf = this.dm.size.height + this.dm.anchor.y;
            this.q("style")
        }, setData: function (a) {
            ...
            g.c.add(this, "setMap");
            g.l.Mk && (a ? (this.get("map") && this.get("map").$j(this), this.set("map", a)) : this.get("map") && (this.get("map").$j(this), this.set("map", null, !0), this.ei = !1, this.Pg && this.Pg()))
        }, Lf: function (a) {
            return g.pb.RC(["cvector"]) ?
                (a = new g.o.$c(this, a), this.W("datas", a), a) : ["cvector"]
        }
    });
    A.o.A9 = A.o.ac.extend({
        r: function (a) {
            ...
            for (var a = this.get("opacity", null, !0), b = -1, c = this.um.length; ++b < c;) this.um[b].setOpacity(a)
        }, addLayer: function (a) {
            if (!this.Wc(a)) {
                a.oA = this;
                var b = this.get("map");
            ...
            return -1 !== g.a.indexOf(this.um, a)
        }, show: function () {
            for (var a = -1, b = this.um.length; ++a < b;) this.um[a].show()
        }, hide: function () {
            for (var a = -1, b = this.um.length; ++a < b;) this.um[a].hide()
    ...
    A.o.Fq = A.o.ac.extend({
        c$: {visible: !0, zIndex: 20, opacity: 1, zooms: [3, 20], collision: !1, alwaysRender: !0},
        B: {zooms: [3, 20]},
        Tx: function () {
            this.j && this.j.cz(this.wk)
        },
        r: function (a) {
        ...
        Tm: function (a, b) {
            for (var c = b._LabelMarkerId ||
                null, d = 0; d < a.length; d++) if (a[d].data.id === c) return d;
            return -1
        },
        removeItem: function () {
        },
        ...
        HX: function () {
            ...
            return this.Ff(a.width) || this.Ff(a.height) ? this.xY(a) ? a.split(",") : this.Sea(a) ? [a, a] : a : [a.width, a.height]
        },
        Cda: function () {
            var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
            return this.Ff(a.Q) ||
            this.Ff(a.P) ? this.xY(a) ? a.split(",") : a : [a.Q, a.P]
        },
        add: function (a) {
            a.j = this;
            var b = a.B, c = {
                data: {
                    id: a._LabelMarkerId || void 0,
                    name: b.title || "",
                    position: this.Cda(b.position) || void 0,
                    zooms: b.zooms || void 0,
                    rank: b.rank || void 0
                },
                opts: {
                    opacity: "number" === typeof b.opacity ? b.opacity : 1,
                    zIndex: "number" === typeof b.zIndex ? b.zIndex : 1,
                    icon: {},
                    text: {}
                }
            };
            if (b.icon) {
                var d = b.icon, e = d.size, f = d.clipSize;
                e && (d.size = this.HX(e));
                f && (d.clipSize = this.HX(f));
                c.opts.icon = b.icon
            }
            b.text && (c.opts.text = b.text, b.text.content && (c.data.txt =
                b.text.content));
            this.wk.push(c);
            this.Tx();
            a.k7 && a.k7()
        ...
        remove: function (a) {
            this.wk && (a = this.Tm(this.wk, a), -1 !== a && (this.wk.splice(a, 1), this.Tx()))
        },
        clear: function () {
            this.j && this.j.clear()
        },
        ...
        on: function (a) {
            this.j ?
                (this.ph(arguments), this.j.H0(a)) : this.du.push(arguments)
        },
        off: function (a) {
            this.j && this.j.L8(a)
        }
    });
    A.o.OK = A.o.Sz.extend({
        r: function (a, b, c) {
            ...
            g.c.add(this,
                "setMap");
            a ? (this.get("map") && (this.get("map").$j(this), this.p1 && A.event.removeListener(this.p1), this.J1 && A.event.removeListener(this.J1)), this.set("map", a)) : this.get("map") && (this.get("map").$j(this), this.He.map = null)
        }, mapChanged: function () {
            this.get("map") && (this.get("map").XG(this), this.get("clickable") && (this.p1 = A.event.addListener(this.get("map"), "click", this.Isa, this), this.J1 = A.event.addListener(this.get("map"), "dblclick", this.Jsa, this)))
        }
    });
    A.w.sh = g.aa.extend({
        ja: [g.sa, g.Qe, {Ia: g.a.Ia}], B: {extData: {}, bubble: !1, clickable: !0, draggable: !1}, r: function () {
            this.WF = g.a.ub(this)
        }, qCa: function () {
            return this.WF
        }, VAa: function () {
            ...
            this.get("map", null, !0) && this.get("map", null, !0).JB(this)
        }, aQ: function (a) {
            var b = 0;
            ...
            g.c.add(this, "setMap");
            a !== this.get("map", null, !0) && (a ? (this.get("map", null, !0) && this.get("map", null, !0).Wy(this), this.set("map", a)) : this.get("map", null, !0) && (this.get("map", null, !0).Wy(this), this.set("map", null, !0)))
        }, getMap: function () {
            g.c.add(this, "getMap");
            return this.get("map", null, !0)
    ...
    A.w.$c = A.w.sh.extend({
        r: function (a) {
            A.w.$c.Tc.r.apply(this, arguments)
        }, show: function () {
            g.c.add(this, "show");
            this.set("visible", !0);
            ...
            this instanceof A.w.Us && (h = b.concat(e).concat(d));
            this instanceof A.w.$s && (h = b.concat(d).concat(f));
    ...
    A.w.QE = A.w.$c.extend({
        B: {
            ...
            A.w.QE.Tc.r.apply(this, arguments)
            ...
            this.w && this.w.get("deltaPos") && (a = this.w.EA(a, this.w.get("deltaPos")));
            return a
        }, qd: function () {
            var a = this.get("path");
            if (!a || !a.length) return null;
            a[0] instanceof g.T && (a = [a]);
            for (var b = new g.Ee(180, 90, -180, -90), c = 0; c < a.length; c += 1) for (var d = a[c], e = d.length - 1; 0 <= e; e -= 1) b.extend(d[e]);
            return b
        }
    });
    A.w.QE.Mb({qd: "getBounds"});
    A.w.Th = g.aa.extend({
        ja: [g.sa, g.Qe],
        B: {
            size: new g.vd(36, 36),
        ...
        r: function (a) {
            ...
            g.c.ya(this, a);
            a = a || {};
            a.size && (a.size = g.a.Zp(a.size));
            a.imageSize && (a.imageSize = g.a.Zp(a.imageSize));
            g.a.Db(this, a);
            this.Xe(this.B)
        },
    ...
    A.w.m$ = g.aa.extend({
        ja: [g.sa, g.Qe], B: {coords: [], type: ""}, r: function (a) {
    ...
    A.w.qb = A.w.sh.extend({
        B: {
            ...
            var a = this.get("position", null, !0).mb();
            return new g.Ee(a, a.mb())
        }, mapChanged: function () {
            this.dl("zoom");
            var a = this.get("map", null, !0);
            a && (this.get("position", null, !0) || this.set("position", a.get("center")), a.JB(this), this.W("zoom", a))
        }, getZooms: function () {
            ...
            g.c.add(this, "setRotation");
            g.l.te || this.set("angle", a)
        }, setAngle: function (a) {
            g.c.add(this, "setAngle");
            g.l.te || "number" !== typeof a || this.set("angle", a)
        }, getAngle: function () {
            ...
            if (!(2 > a.length)) {
                ...
                this.set("move", {Tf: e, speed: b, tb: c, Lla: d})
            }
        }, stopMove: function () {
            ...
            a && !g.a.Ok(a) && (a = g.extend({}, this.get("label"), a));
            this.set("label",
                a)
        }, getLabel: function () {
    ...
    A.w.f$ = A.w.sh.extend({
        B: {position: null, zooms: [3, 20], opacity: 1}, r: function (a) {
            a = a || {};
            ...
            var a =
                this.j.wk, b = this.Tm(a, this);
            return -1 !== b ? a[b].data.position : null
        }, setPosition: function (a) {
            var b = this.j.wk, c = this.Tm(b, this);
            -1 !== c && (b[c].data.position = a);
            this.j.Tx()
        }, getZooms: function () {
            var a = this.j.wk, b = this.Tm(a, this);
            ...
            var c = this.j, d = this;
            if (c) {
                var c = c.wk, e = this.Tm(c, this), f = c[e], h = this;
                this.j._markerBindArray || (this.j._markerBindArray = []);
                this.j._markerBindArray.push(f);
                this.j.on(a, function (a) {
                    var c = h.Tm(h.j._markerBindArray, h);
                    -1 !== e && -1 !== c && (c = f && f.data.id, a && a.data && a.data.data && a.data.data.id && a.data.data.id === c && (a.target = d, b(a)))
                })
            } else this.TP.push(arguments)
        }, off: function () {
            var a = this.Tm(this.j._markerBindArray, this);
            -1 !== a && this.j._markerBindArray.splice(a,
                1)
        }
    });
    A.w.rn = A.w.sh.extend({
        B: {visible: !1, items: []}, r: function (a) {
            ...
            this.get("items").push({Is: a, tb: b, nJ: c});
            this.q("items")
        }, removeItem: function (a, b) {
            g.c.add(this, "removeItem");
            var c = this.get("items"), d, e;
            for (e = 0; e < c.length; e += 1) if (d = c[e], d.Is === a && d.tb === b) {
                c.splice(e, 1);
                break
            }
            this.q("items")
            ...
            b = g.a.Ia(b);
            this.set("position", b);
            this.map ? this.map && this.map !== a && (this.map.Wy(this), this.map = a, this.setMap(a)) : (this.map = a, this.setMap(a));
            ...
            this.C = !0;
            this.setMap(null);
            this.map && (this.map = this.map.Ex = null, this.q("close", {type: "close", target: this}));
            this.C = !1
        }
    });
    A.w.Pe = A.w.sh.extend({
        B: {
            visible: !0,
            offset: new g.H(0, 0),
            showShadow: !1,
            ...
            a = a || {};
            this.Jg = !0;
            a && a.size && (a.size = g.a.Zp(a.size));
            g.a.Db(this, a);
            this.Xe(this.B);
            a.position && this.set("position", g.a.Ia(a.position), !0);
            a.height && this.set("altitude", this.aQ(a.height), !0)
        }, open: function (a, b, c) {
            g.c.add(this, "open");
            b = g.a.Ia(b);
            if (a && !this.mK && (b =
                ...
                this.q("change", {type: "change", target: this});
                c = this.aQ(c) || this.get("altitude");
                var d = this.get("map", null, !0);
                d && d === a ? (this.set("altitude", c, !0), this.set("position", b)) : (this.map = a, a.Wl && a.Wl.close(), this.set("position", b, !0), this.set("altitude", c, !0), this.C = !0, this.setMap(a), this.C = !1);
                this.q("open", {type: "open", target: this})
            }
        }, close: function () {
            g.c.add(this, "close");
            this.w && this.w.map && (this.C = !0, this.setMap(null), this.map = null, this.q("change", {
                type: "change",
                target: this
            }),
                this.C = !1)
        ...
        getSize: function (a) {
            ...
            if (b) return b;
            if (this.w && !a) return new g.vd(this.w.fh.offsetWidth, this.w.fh.offsetHeight)
        }, getIsOpen: function () {
            g.c.add(this, "getIsOpen");
            return !!this.get("map")
        }
    });
    A.w.Vb = A.w.QE.extend({
        B: {
            isOutline: !1,
            outlineColor: "#000000",
            geodesic: !1,
            ...
            for (var a = this.get("path"), b = 0, c = 0; c < a.length - 1; c += 1) b += a[c].qe(a[c + 1]);
    ...
    A.w.Jz = A.w.Vb.extend({
        B: {tolerance: 4, interpolateNumLimit: [3, 300]}, r: function (a) {
            ...
            var a = this.get("map");
            return g.Yv.Yoa(this.get("path"), a && a.Zi || g.Ph.LK, Math.pow(2, 2), this.B)
            ...
            for (var a = this.get("path", null, !0), b = [], c = 0, d = a.length; c < d; c++) {
                ...
                if (e instanceof g.T) {
                    var f = [];
                    if (e.controlPoints) for (var h = 0, k = e.controlPoints.length; h < k; h++) f.push(e.controlPoints[h].wQ()), f.push(e.controlPoints[h].sQ());
                    f.push(e.wQ());
                    f.push(e.sQ());
                    b.push(f)
                } else b.push(e)
            ...
            if (g.a.isArray(a) && "object" === b) {
                for (b = 0; b < a.length; b += 1) a[b] = this.Uha(a[b]);
                return a
            }
            return [this.fEa(a)]
        }, Uha: function (a) {
    ...
    A.w.Ec = A.w.QE.extend({
        r: function (a) {
            ...
            if (!a.length || a[0] instanceof g.T) b = this.DQ(a); else {
                b = this.DQ(a[0]);
                for (var c = 1; c < a.length; c += 1) b -= this.DQ(a[c])
            }
            ...
            a = [a.Q, a.P];
            for (var c, d = 0, e = b.length; d < e && (c = this.tla(b[d]), g.zd.Mp(c) || c.reverse(), c = g.zd.Md(a, c, 0 === d ? !0 : !1), 0 < d && (c = !c), c); d += 1) ;
            return c
        }, tla: function (a) {
    ...
    A.w.Ug = A.w.$c.extend({
        B: {
            ...
            a.center && (a.center = g.a.Ia(a.center));
            a.zIndex = "number" === typeof a.zIndex ? a.zIndex : 10;
            g.a.Tj(a.radius, "string") && (a.radius = parseFloat(a.radius), isNaN(a.radius) && delete a.radius);
            g.a.Db(this, a);
            ...
            (a = g.a.Ia(a)) && a instanceof g.T && (this.w && this.w.get("deltaPos") && this.w.set("deltaPos", [0, 0], !0), this.set("center", a), this.q("change", {
                type: "change",
                target: this
            }), this.Jg || (this.Jg = !0, this.get("map") && this.get("map").q("overlays")), b || this.q("setCenter"))
        }, getCenter: function () {
            g.c.add(this, "getCenter");
            var a = this.get("center", null, !0);
            this.w && this.w.get("deltaPos") && (a =
                this.w.EA([a], this.w.get("deltaPos"))[0]);
            return a
        }, reset: function () {
            var a = this.get("center", null, !0);
            this.w && this.w.get("deltaPos") && (a = this.w.EA([a], this.w.get("deltaPos"))[0], this.w.set("deltaPos", [0, 0], !0));
            this.set("center", a)
            ...
            return this.get("center").qe(a) <= this.get("radius") ? !0 : !1
        }
    });
    A.w.JU = A.w.Ug.extend({
        r: function (a) {
            this.CLASS_NAME = "AMap.CircleMarker";
            g.c.ya(this, a);
            a = a || {};
            a.unit = "px";
            void 0 === a.radius ? a.radius = 20 : g.a.Tj(a.radius, "string") && (a.radius = parseFloat(a.radius), isNaN(a.radius) && (a.radius = 20));
            A.w.JU.Tc.r.apply(this, arguments)
        }, getBounds: function () {
            this.C = !0;
    ...
    var pc = g.aa.extend({
        r: function (a) {
            var b = Array(3), c;
            c = a instanceof Array ? a : a instanceof g.jl || a instanceof g.Oa ? a.elements : arguments;
            b[0] = c[0] || 0;
            b[1] = c[1] || 0;
            b[2] = c[2] || 0;
            this.elements = b
        }, length: function () {
            return Math.sqrt(this.M4())
        }, M4: function () {
            var a = this.elements;
    ...
    function rc(a, b) {
        this.Ky = void 0 !== a ? a : new g.Oa(1, 0, 0);
        this.$B = void 0 !== b ? b : 0
    }
    ...
    rc.prototype = {
        set: function (a, b) {
            ...
            var a = 1 / this.Ky.length();
            this.Ky.hn(a);
            this.$B *= a;
            return this
        }, BH: function (a) {
            return this.Ky.tf(a) + this.$B
        }
    };
    ...
    function vc(a, b, c, d, e, f) {
        this.pD = [void 0 !== a ? a : new g.mw, void 0 !== b ? b : new g.mw, void 0 !== c ? c : new g.mw, void 0 !== d ? d : new g.mw, void 0 !== e ? e : new g.mw, void 0 !== f ? f : new g.mw]
    }
    ...
    vc.prototype = {
        set: function (a, b, c, d, e, f) {
            ...
            return (new g.SU).copy(this)
        }, copy: function (a) {
            for (var b = this.pD, c = 0; 6 > c; c++) b[c].copy(a.pD[c]);
            return this
        }, EI: function () {
            var a = new g.Oa, b = new g.Oa, c = a.elements, d = b.elements;
            return function (e) {
                var f = this.pD, h = e.max.elements;
                e = e.min.elements;
                for (var k = 0; 6 > k; k++) {
                    var l = f[k], m = l.Ky.elements;
                    c[0] = 0 < m[0] ? e[0] : h[0];
                    d[0] = 0 < m[0] ? h[0] : e[0];
                    c[1] = 0 < m[1] ?
                        e[1] : h[1];
    ...
    (function (a) {
        ...
        b.prototype.toFixed = function (b) {
            for (var d = this.elements, e = 0; 16 > e; ++e) 0 !== d[e] && (d[e] = a.a.lc(d[e], b));
            return this
        };
        ...
        b.prototype.Hg = function () {
            return (new b).Cva(this)
        };
        b.prototype.uT = function (a, b, e, f, h, k) {
            var l, m, n, p;
        ...
        b.prototype.cta = function (a, d, e, f, h, k) {
            return this.concat((new b).uT(a, d, e, f, h, k))
        };
        b.prototype.Ava = function (a, b, e, f, h, k) {
            var l, m, n, p;
        ...
        b.prototype.jQ = function (a, d, e, f, h, k) {
            return this.concat((new b).Ava(a, d, e, f, h, k))
        };
        b.prototype.s7 = function (a, b, e, f) {
            var h, k;
        ...
        b.prototype.perspective = function (a, d, e, f) {
            return this.concat((new b).s7(a, d, e, f))
        };
        ...
        b.prototype.dz = function (a, b, e, f) {
            var h, k, l, m, n, p, q, r;
            a = Math.PI * a / 180;
            h = this.elements;
            k = Math.sin(a);
        ...
        b.prototype.rotate = function (a, d, e, f) {
            return this.concat((new b).dz(a, d, e, f))
        };
    ...
    A.w.Us = A.w.Ec.extend({
        B: {
            ...
            g.c.ya(this, b);
            var b = g.extend({}, this.B, b), c = this.kr(b);
            b.path = c;
            A.w.Us.Tc.r.call(this, b);
            this.set("path", c);
            this.get("center") && this.get("map") || (this.Jg = !1);
            this.on("movepoly", function (b) {
                var c =
                    a.get("map");
                b = c.Qd(c.Ab(a.get("center")).add(b.wJ));
            ...
            g.a.Eh(A.w.Us.Tc.mapChanged) && A.w.Us.Tc.mapChanged.apply(this);
            this.C = !0;
            this.setPath(this.kr());
            this.C = !1;
            !this.Jg && this.get("map") && (this.Jg = !0, this.get("map").q("overlays"))
        }, setCenter: function (a, b) {
            g.c.add(this, "setCenter");
            (a = g.a.Ia(a)) && a instanceof g.T && (this.w && this.w.get("deltaPos") && this.w.set("deltaPos", [0, 0], !0), this.set("center", a), this.set("path", this.kr()), this.Jg || (this.Jg = !0, this.get("map") && this.get("map").q("overlays")),
            b || (this.q("setCenter"), this.q("change", {type: "change", target: this})))
        }, setRadius: function (a) {
            var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
            g.c.add(this, "setRadius");
            a && 2 === a.length && (this.set("radius", a), this.set("path", this.kr()), b || (this.q("change", {
                type: "change",
                target: this
            }), this.q("setPath")))
        }, setOptions: function (a) {
            A.w.Us.Tc.setOptions.call(this, a);
            this.C = !0;
            ...
            g.c.add(this, "getCenter");
            var a = this.get("center", null, !0);
            this.w && this.w.get("deltaPos") && this.w.EA([a], this.w.get("deltaPos"))[0];
            return a
        }
    });
    A.w.$s = A.w.Ec.extend({
        B: {
            ...
            var c = this.kr(b);
            b.path = c;
            A.w.$s.Tc.r.call(this, b);
            this.setPath(c);
            this.B.bounds && this.get("map") || (this.Jg = !1);
            this.on("movepoly", function (b) {
                var c = a.get("map"),
                    f = a.get("bounds"), h = c.Qd(c.Ab(f.xc).add(b.wJ));
                b = c.Qd(c.Ab(f.nc).add(b.wJ));
                "3D" === c.view.type && a.set("deltaPos", [0, 0]);
                a.set("bounds", new g.Ee(h, b))
            });
            this.C = !1
        }, kr: function () {
            var a = [],
            ...
            if (b) {
                ...
                b.C = !1;
                g.a.Qb([new g.T(c.Q, c.P, !0), new g.T(d.Q, c.P, !0), new g.T(d.Q, d.P, !0), new g.T(c.Q, d.P, !0)], function (b) {
                    return a.push(b)
                })
            }
            return a
        }, mapChanged: function () {
            g.a.Eh(A.w.$s.Tc.mapChanged) &&
            A.w.$s.Tc.mapChanged.apply(this);
            this.C = !0;
            this.setPath(this.kr());
            this.C = !1;
            !this.Jg && this.get("map") && (this.Jg = !0, this.get("map").q("overlays"))
            ...
            this.C = !0;
            A.w.$s.Tc.setOptions.call(this, a);
            a.bounds && this.setBounds(a.bounds, !0);
            this.C = !1
        }, setBounds: function (a) {
            var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
            g.c.add(this, "setBounds");
            a && a instanceof g.Ee && (this.set("bounds", a), this.set("path", this.kr()), this.Jg || (this.Jg = !0, this.get("map") && this.get("map").q("overlays")),
    ...
    A.w.uV = A.w.qb.extend({
        B: {text: "", textAlign: "center", verticalAlign: "middle", offset: new g.H(0, 0)}, r: function (a) {
            this.CLASS_NAME = "AMap.Text";
            g.c.ya(this, a);
            A.w.uV.Tc.r.apply(this, arguments);
            this.Cea();
            this.C = !0;
            ...
            g.c.add(this,
                "setText");
            a || 0 === a || (a = "");
            g.h.Hwa(this.BB, "amap-overlay-text-empty", !a);
            ...
            g.c.add(this, "setStyle");
            a = a || {};
            for (var b in a) a.hasOwnProperty(b) && (this.BB.style[b] = a[b]);
            this.D6()
        }, D6: function () {
            this.C = !0;
            this.setContent(this.BB);
    ...
    g.VU = {
        find: function (a) {
            return g.a.find(this.ww || [], a)
        }, bI: function () {
            return this.ww || []
        }, Wc: function (a) {
            return null !== this.find(a)
        }, add: function (a) {
            var b = this, c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : g.a.is,
                d = this.ww || (this.ww = []);
            g.a.isArray(a) ? g.a.Qb(a, function (a) {
                b.add(a, c)
            }) : null === this.find(a) && (d.push(a), c(a));
            return this
        }, remove: function (a) {
            var b = this, c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : g.a.is, d = this.ww;
            if (d) if (g.a.isArray(a)) g.a.Qb(a, function (a) {
                b.remove(a,
                    c)
            }); else {
    ...
    A.w.tn = A.w.sh.extend({
        ja: [g.VU], r: function () {
            var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
            this.CLASS_NAME = "AMap.OverlayGroup";
            g.c.ya(this);
            A.w.tn.Tc.r.apply(this);
            this.map = null;
            this.add(a)
        }, oc: function (a) {
            g.c.add(this, "setMap");
    ...
    A.w.tn.Mb({
        find: "getOverlay",
        bI: "getOverlays",
        JB: ["addOverlay", "addOverlays"],
        Wc: "hasOverlay",
        Wy: ["removeOverlay", "removeOverlays"],
        cd: "clearOverlays",
        Qb: "eachOverlay",
        oc: "setMap",
        Db: "setOptions",
    ...
    (function (a, b) {
        ...
        function e(a) {
            ...
            a = b.a.Ia(a);
            for (var c = [], d = 0, e = a.length; d < e; d++) c[d] = a[d].cl();
            a[a.length - 1].cb(a[0]) || c.push(a[0].cl());
            return c
        }

        a.w.TU = a.w.tn.extend({
            r: function (c) {
                this.CLASS_NAME =
                    "AMap.GeoJSON";
                b.c.ya(this, c);
                a.w.TU.Tc.r.call(this, []);
                this.C = !0;
                this.B = b.extend({
                    getMarker: function (b, c) {
                        return new a.w.qb({innerOverlay: !0, position: c})
                    }, getPolyline: function (b, c) {
                        return new a.w.Vb({path: c, innerOverlay: !0})
                    }, getPolygon: function (b, c) {
                        return new a.w.Ec({path: c, innerOverlay: !0})
                ...
                for (var a = this.bI(), c = [], d = 0, e = a.length; d < e; d++) a[d].C = !0, c[d] = a[d].toGeoJSON(), a[d].C = !1;
                return c
            }, xea: function (a) {
                if (a) {
                    b.a.isArray(a) || (a = [a]);
                ...
                for (var d = "Feature" === c.type ? c.geometry : c, d = d ? d.coordinates : null, e = [], l = 0, m = d.length; l < m; l++) e.push(this.mW(b.extend({}, c, {
                    type: "Feature",
                ...
                for (var d = "Feature" === c.type ? c.geometry : c, d = d ? d.coordinates : null, e = [], l = 0, m = d.length; l < m; l++) e.push(this.lW(b.extend({}, c, {
                    type: "Feature",
                ...
                for (var d = "Feature" === c.type ? c.geometry : c, d = d ? d.coordinates : null, e = [], l = 0, m = d.length; l < m; l++) e.push(this.nW(b.extend({}, c, {
                    type: "Feature",
                ...
                for (var d = ("Feature" === c.type ? c.geometry : c).geometries, e = [], l = 0, m = d.length; l < m; l++) e.push(this.KM(b.extend({}, c, {
                    type: "Feature",
        ...
        a.w.qb.zb({
            toGeoJSON: function () {
                b.c.add(this, "toGeoJSON");
                this.C = !0;
                var a = this.getExtData() || {}, c = this.getPosition().cl();
                this.C = !1;
                return {
                    type: "Feature", properties: a._geoJsonProperties || {}, geometry: {
                        type: "Point",
    ...
    A.o.TK.Mb({
        find: "getLayer",
        bI: "getLayers",
        XG: ["addLayer", "addLayers"],
        Wc: "hasLayer",
        $j: ["removeLayer", "removeLayers"],
        Qla: "clearLayers",
        Qb: "eachLayer",
        oc: "setMap",
        Db: "setOptions",
    ...
    g.zd = {
        Ar: function (a, b) {
            for (var c = Infinity, d = 0, e = 1, f = b.length; e < f; d = e, e += 1) c = Math.min(c, g.zd.Yva(a, [b[d], b[e]]));
            return Math.sqrt(c)
        }, Yva: function (a, b) {
            return this.gK(a, this.q1(a, b))
        }, gK: function (a, b) {
    ...
    (function (a) {
        function b(b, c) {
            ...
            return {
                project: function (b) {
                    ...
                    var d = a.mm.eu, e = Math.cos, f = b.P * d, k =
                        c.P * d, h = 2 * a.mm.MP, d = c.Q * d - b.Q * d,
                        e = (1 - e(k - f) + (1 - e(d)) * e(f) * e(k)) / 2;
                    return h * Math.asin(Math.sqrt(e))
                }, ringArea: function (b) {
                    b = this.normalizeLine(b);
                    var c = a.mm.MP * a.mm.eu, d = 0, e = b.length;
                    if (3 > e) return 0;
                    for (var f = 0; f < e - 1; f += 1) var k = b[f], h = b[f + 1], u = k.Q * c * Math.cos(k.P * a.mm.eu), k = k.P * c, v = h.Q * c * Math.cos(h.P * a.mm.eu), d = d + (u * h.P * c - v * k);
                    f = b[f];
                    b = b[0];
                    e = f.Q * c * Math.cos(f.P * a.mm.eu);
                    f = f.P * c;
                    h = b.Q * c * Math.cos(b.P * a.mm.eu);
                    d += e * b.P * c - h * f;
        ...
        a.extend(e.prototype, {
            clone: function (b) {
                return new e(a.extend({}, this.Ob, b))
            }, isPoint: function (b) {
                ...
                a.extend(this, d && d.project && d.unproject ? d : "plane" === d ? c() : b(d, this.Ob.maxZoom))
            }, distance: function () {
                ...
                b = a.zd.q1(this.project(b), this.Tw([c, d]));
                ...
                if (!d && 0 !== d || 0 > d) d = this.Ob.onSegmentTolerance;
                ...
                var d = this.Tw(c, !0);
                return a.zd.Md(this.project(b), d, !1)
    ...
    (function (a) {
        a.zE = function () {
            ...
            function c(a, b) {
                ...
                b || (b = a);
                var c = a, d;
                do if (d = !1, c.N7 || !m(c, c.next) && 0 !== l(c.Ga, c, c.next)) c = c.next; else {
                    s(c);
                    c = b = c.Ga;
                    if (c === c.next) break;
                    d = !0
            ...
            function d(a, b, e, f, r, u, C) {
                if (a) {
                    if (!C && u) {
                        var F = a, B = F;
                        do null === B.z &&
                        (B.z = h(B.x, B.y, f, r, u)), B.Fo = B.Ga, B = B.Sk = B.next; while (B !== F);
                        B.Fo.Sk = null;
                        B.Fo = null;
                        var F = B, z, H, G, I, K, N, M = 1;
                        do {
                            B = F;
                            G = F = null;
                            for (I = 0; B;) {
                                I++;
                                H = B;
                                for (z = K = 0; z < M && (K++, H = H.Sk, H); z++) ;
                                for (N = M; 0 < K || 0 < N && H;) 0 !== K && (0 === N || !H || B.z <= H.z) ? (z = B, B = B.Sk, K--) : (z = H, H = H.Sk, N--), G ? G.Sk = z : F = z, z.Fo = G, G = z;
                                B = H
                            }
                            G.Sk = null;
                            M *= 2
                    ...
                    for (F = a; a.Ga !== a.next;) {
                        B = a.Ga;
                        H = a.next;
                        if (u) a:if (G = a.Ga, I = a.next, 0 <= l(G, a, I)) G = !1; else {
                            ...
                            for (z = a.Sk; z && z.z <= M;) {
                                if (z !== a.Ga && z !== a.next && k(G.x, G.y, a.x, a.y, I.x, I.y, z.x, z.y) && 0 <= l(z.Ga, z, z.next)) {
                                    G = !1;
                                    break a
                                }
                                z = z.Sk
                            ...
                            G = !0
                        } else a:if (G = a.Ga, I = a.next, 0 <= l(G, a, I)) G = !1; else {
                            for (K = a.next.next; K !== a.Ga;) {
                                if (k(G.x, G.y, a.x, a.y, I.x, I.y, K.x, K.y) && 0 <= l(K.Ga, K, K.next)) {
                                    G = !1;
                                    break a
                                }
                                K = K.next
                        ...
                        if (G) b.push(B.ge /
                            e), b.push(a.ge / e), b.push(H.ge / e), s(a), F = a = H.next; else if (a = H, a === F) {
                            if (C) if (1 === C) {
                                C = b;
                                F = e;
                                B = a;
                                ...
                                if (2 === C) a:{
                                    ...
                                    do {
                                        for (F = C.next.next; F !== C.Ga;) {
                                            if (B = C.ge !== F.ge) if (B = void 0, B = C.next.ge !== F.ge) if (B = void 0, B = C.Ga.ge !== F.ge) {
                                                B = B = void 0;
                                                b:{
                                                    B = C;
                                                    do {
                                                ...
                                                if (B = !B) if (B = void 0, B = p(C, F)) if (B = void 0, B = p(F, C)) {
                                                    B = C;
                                                    H = !1;
                                                    G = (C.x + F.x) / 2;
                                                    I = (C.y + F.y) / 2;
            ...
            function q(a, b) {
                var c = new u(a.ge, a.x, a.y), d = new u(b.ge, b.x, b.y), e = a.next, f = b.Ga;
                a.next = b;
                b.Ga = a;
                c.next = e;
                e.Ga = c;
    ...
    g.fb = g.fb || {};
    g.fb.hL = g.aa.extend({
        ja: [g.sa], r: function (a, b) {
            this.B = {callback: "cbk", type: "json", charset: "utf-8"};
            b = b || {};
            g.a.Db(this, b);
            this.url = a;
            this.send(a, b.Sc, b.z1, b.eT, b.responseType)
        }, send: function (a) {
            var b = g.h.create("script");
            b.type = "text/javascript";
            b.charset = this.B.charset;
            var c = this;
            g.l.te ? b.onreadystatechange = function () {
    ...
    g.fb.vb = g.fb.hL.extend({
        yla: function () {
            if (g.a.j7) return g.a.iK.push(this), !0
        }, Yua: function () {
            ...
            if (!this.B.vx || !this.yla()) {
                a = encodeURI(a);
                var f = this.B.fun;
                if (!f || window[f]) f = g.a.L2("jsonp_", 6) + "_";
                var h = document.createElement("script");
                h.type = "text/javascript";
                h.charset = "utf-8";
                h.async = !0;
                var k = this;
                g.l.te || (h.onerror = function () {
                    e();
                    k.q("error", {info: "REQUEST_FAILED", url: a})
                });
                window[f] = function (a) {
                    e();
                    if (k.B.callbackFunction) k.B.callbackFunction.call(k.B.context, a); else if (3E4 === a.errcode && a.data) g.a.j7 = !0, g.pb.load("AMap.AntiCrabFrame", function () {
                        g.a.vx || (g.a.vx = new g.p9);
                        g.a.iK.push(k);
                        g.a.vx.open(k.B.Sc, a.data.host, k.mD || "", k.url)
                    }); else {
                ...
                if (-1 !== a.indexOf(g.A.Rd + "/v") || -1 !== a.indexOf("yuntuapi.amap.com/datasearch") ||
                    -1 !== a.indexOf("webapi.amap.com/")) b = b + "&platform=JS&logversion=2.0" + ("&appname=" + g.A.Pt), b += "&csid=" + g.a.S8(), b += "&sdkversion=" + g.A.er;
                if (c = this.B.KH) {
                    var l = [], m;
                ...
                g.fb.vb.xca = document.getElementsByTagName("body")[0] || document.getElementsByTagName("head")[0];
                g.fb.vb.xca.appendChild(h)
            }
        }
    });
    g.fb.XMLHttpRequest = g.fb.hL.extend({
        send: function (a, b, c, d, e) {
            var f = this;
            if ((g.l.te || g.l.N3) && window.XDomainRequest) {
                var h = this.i9 = new XDomainRequest;
                ...
                var k = this.i9 = new XMLHttpRequest;
    ...
    for (xc = 0; xc < Hc.length; xc += 1) Z.PlaneGeometryUtil[Hc[xc]] = function () {
        var a = g.yj[Hc[xc]], b = Hc[xc];
        return function () {
            g.c.ya(Z.PlaneGeometryUtil);
            g.c.add(Z.PlaneGeometryUtil, b);
            return a.apply(g.yj, Array.prototype.slice.call(arguments))
        }
    }();
    ...
    Z.TileLayer.Satellite = A.o.nb.oV;
    Z.TileLayer.RoadNet = A.o.nb.mV;
    Z.TileLayer.google = A.o.nb.DE;
    Z.TileLayer.Flexible = A.o.nb.Pz;
    Z.TileLayer.WMS = A.o.nb.$$;
    Z.TileLayer.WMTS = A.o.nb.aaa;
    Z.TileLayer.Traffic = A.o.nb.xV;
    Z.Panorama.Events = A.event;
    Z.TileLayer.PanoramaLayer = A.o.nb.Oya;
    Z.UA = {ie: g.l.Rr, ielt9: g.l.te, ielt11: g.l.bqa, mobile: g.l.Z, android: g.l.Al, ios: g.l.NC};
    Z.Browser = {
        ...
        ielt9: g.l.te,
        baidu: g.l.eH,
        isLocalStorage: g.l.$r,
        isGeolocation: !!navigator.geolocation,
        mobileWebkit: g.l.esa,
        mobileWebkit3d: g.l.k5,
        mobileOpera: !!g.l.dsa,
        retina: g.l.Nc,
        touch: !!g.l.Af,
        msPointer: !!g.l.m5,
    ...
    var Ic = {
        colorNameToHex: g.a.rH,
        rgbHex2Rgba: g.a.W6,
        argbHex2Rgba: g.a.hr,
        isEmpty: g.a.Ok,
        deleteItemFromArray: g.a.Mx,
        deleteItemFromArrayByIndex: g.a.Yn,
        indexOf: g.a.indexOf,
        format: g.a.lc,
        isArray: g.a.isArray,
        isDOM: g.a.II,
        includes: g.a.ja,
        requestIdleCallback: g.a.fT,
        cancelIdleCallback: g.a.WO,
        requestAnimFrame: g.a.Qc,
        cancelAnimFrame: g.a.fi,
        color2RgbaArray: g.a.sp,
        color2Rgba: g.a.cma
    };
    ...
    if (!Kc.WC && "undefined" !== typeof arguments && arguments.callee) try {
        if (g.l.$r && window.localStorage) {
            var Lc = window.localStorage["_AMap_" + g.bJ];
            Lc && JSON.parse(Lc).version === Kc.tj || window.localStorage.setItem("_AMap_" + g.bJ, JSON.stringify({
                version: Kc.tj,
                script: "(" + arguments.callee + ")(config)"
            }));
            new g.fb.XMLHttpRequest(Kc.yb + "/maps/cookie?key=amap_ver&value=" + Kc.tj, {Sc: "GET", eT: "text/plain"})
        }
    } catch (Mc) {
    }
    ;g.uj = g.aa.extend({
        r: function (a, b, c, d) {
            ...
            this.frames = 0;
            this.ov = !0;
            this.y0 = g.a.Qc(this.update);
            this.kha = g.a.bind(this.Xp, a || this)
        }, update: function () {
            this.frames += 1;
            ...
            "number" === typeof b && Math.abs(b - this.end) < this.precision ?
                (this.stop(), b = this.end) : this.y0 = g.a.Qc(this.update);
            this.Yg = a;
            this.kha(b)
        }, stop: function (a) {
            g.a.fi(this.y0);
    ...
    g.uj.Easing = {
        Linear: {
            ...
            In: function (a) {
                ...
                return g.uj.Easing.Bounce.In(1 - a)
            }
        }, Cubic: {
            In: function (a) {
                return 1 - a * a * a
    ...
    g.Jb = g.aa.extend({
        ja: [g.sa, g.Qe, g.UI], r: function (a, b) {
            this.fc = g.a.bind(this.fc, this);
            this.D = b;
            this.Zi = b.Zi;
            this.cm = "";
            this.Xg = this.yg = this.Ck = !1;
            this.zn = {};
            this.J = a;
            this.nfa();
            this.vqa();
            ...
            this.oe = g.A.oe[c] || g.A.oe["default"];
            this.SG = "#a3ccff";
            this.uB = b.get("skyColor") || "#cce0ff";
            this.W("editEnable", b);
            this.pd ? this.W("style", b, !0) : this.W("styleUrl", b);
            this.W("hightlight", b, !0);
            this.W("labelzIndex", b, !0);
            if (g.l.hK) {
                c = new A.o.nb({innerLayer: !0, zIndex: b.get("labelzIndex"), visible: !1});
                this.Ac = new g.o.Aj(c, this, ["point", "road"]);
                this.Ac.type = "\u77e2\u91cf\u6807\u6ce8";
                var d = this.D.get("defaultLayer");
                d && c.W("rejectMapMask", d, !0);
                b.labelsLayer = this.Ac.V;
                this.Ac.V.g("complete", this.Sq, this,
                    !0);
                this.Ac.V.g("renderComplete", this.Sq, this);
                this.Ac.OA = this.Ac.Ig = !0
            }
            ...
            this.W("bounds", b);
            this.W("draw", b);
            this.Re("zoomAndCenter destroy defaultCursor jogEnable animateEnable baseRender overlayRender gridMapForeign vectorMapForeign".split(" "), b);
            this.Re("rotateEnable pitchEnable dragEnable keyboardEnable doubleClickZoom scrollWheel zoomEnable touchZoom".split(" "),
                b, !0);
            this.get("jogEnable") ? this.Ju = !0 : this.Ju = !1;
            this.Bea();
            this.Iea();
            this.cY && this.cY();
            ...
            g.l.Nc && 3 < c && (this.G0 = !0);
            this.U = {Od: !1};
            this.PJ()
        }, editEnableChanged: function () {
            this.pd = this.get("editEnable")
        }, labelzIndexChanged: function () {
            this.Ac && this.Ac.set("zIndex", this.get("labelzIndex"))
        }, styleChanged: function () {
            this.Rk = !0
        }, mapStyleChanged: function () {
            if (this.D.ni) {
                this.cm && (this.set("style", ""), this.cu = this.cm = "");
                var a = this.get("mapStyle");
                this.Rk = !0;
                this.oe = g.A.oe[a] || g.A.oe["default"];
                this.AD()
            }
            ...
            if (this.D.ni) {
                ...
                if (a !== this.cm) {
                    ...
                    "normal" === c ? (this.cm = "", this.set("nolimg", !!this.D.get("nolimg_param")), this.set("style", ""), this.cu = "") : (this.uz = !0, this.set("nolimg", !0), b = new g.fb.vb(32 > c.length ? g.A.Bc + "://webapi.amap.com/style?name=" + c + "&key=" + g.A.key : g.A.Bc + "://webapi.amap.com/v4/map/styles?styleid=" +
            ...
            a = g.Eq.closestOnLine(b, a.RT().path);
            return new g.T(a[0], a[1])
        }, Ala: function () {
            var a = this.get("limitBounds"), b = this.get("bounds");
            b.xc && b.xc.Q > b.nc.Q && (b.nc.Q += 360);
            if (!a.contains(b)) {
                if (b instanceof g.No) return this.roa(a, b);
                var c = this.get("center").mb();
                a.gj() < b.gj() ? c.Q = a.ji().Q : (a.xc.Q > b.xc.Q && (c.Q += a.xc.Q - b.xc.Q), a.nc.Q < b.nc.Q && (c.Q += a.nc.Q - b.nc.Q));
                a.ej() < b.ej() ? c.P = a.ji().P : (a.xc.P > b.xc.P && (c.P += a.xc.P - b.xc.P), a.nc.P < b.nc.P && (c.P += a.nc.P - b.nc.P));
                return c
            }
        }, RN: function () {
            var a = this.CT;
            this.D.refreshSize();
            var b = this.get("size");
            b && a && !b.cb(a) && (this.CT = b, this.uv = !0, this.set("display"), this.T6(b), this.get("resizeEnable") &&
            this.ma("resize", {wsa: a, u5: b}))
        }, TZ: function () {
            var a = this;
            a.RN();
            a.MN = setTimeout(function () {
                a.TZ()
            }, 200)
        }, Fba: function () {
            this.MN && (clearTimeout(this.MN), this.MN = null)
        }, nfa: function () {
            this.D.C = !0;
            this.CT = this.D.getSize();
            this.D.C = !1;
            if (g.l.te || g.l.a9 && g.l.NC || g.l.Ura) this.TZ(); else {
                var a = this;
                g.F.qka(this.J, function (b) {
                    a.RN(b)
                })
            }
        }, vqa: function () {
            ...
            this.ql = g.h.create("div", a);
            this.ql.style.display = "none";
            b.nr = g.h.create("div",
                b.Yc, "amap-drags");
            b.o = g.h.create("div", b.nr, "amap-layers");
            b.w = g.h.create("div", b.nr, "amap-overlays");
            b.controls = g.h.create("div", a, "amap-controls");
            b.Vu = g.h.create("a", a, "amap-logo");
            var c = window.location.host;
            -1 === c.indexOf("amap.com") && -1 === c.indexOf("gaode.com") && (b.Vu.href = g.l.Z ? "http://m.amap.com" : "http://gaode.com", b.Vu.target = "_blank");
            g.h.create("img", b.Vu).src = g.l.Nc ? this.D.B.logoUrlRetina : this.D.B.logoUrl;
            b.Pm = g.h.create("div", a, "amap-copyright");
            b.Pm.style.display = "none";
            350 < g.h.qI(this.J).width &&
            (b.Pm.innerHTML = this.D.B.copyright, b.Pm.Y4 = g.h.create("span", b.Pm, "amap-mcode"), this.AD());
            this.Sa = b
        }, AD: function () {
            ...
            if (a) {
                ...
                this.D.C = !1;
                "GS(2018)1709" === c && a && "normal" !== a && "amap://styles/normal" !== a && (c = "", this.Sa.Pm.style.visibility = "hidden", this.Sa.Vu.style.display = "none");
                c && this.Sa.Pm.Y4 &&
                (this.Sa.Pm.Y4.innerHTML = "- " + c + "\u53f7", this.Sa.Pm.style.visibility = "visible", this.Sa.Vu.style.display = "block");
                return c
            }
        }, iX: function () {
            var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : !1;
            g.zj && (a ? g.zj.flush() : this.o2 || (this.o2 = g.a.Qc(function () {
                g.zj.flush();
                this.o2 = null
            }, this)))
        }, TS: function (a) {
            var b = this, c = this.D.get("rasterLayer");
            c && (this.D.set("rasterLayer", void 0), this.D.z6 = !0, this.D.Zj = this.D.La, this.Kl.vI = !1, c.o && (c.o.eD = !0), a || (this.US = g.a.fT(function () {
                b.US = null;
                b.D && b.D.$j(c)
            })));
            a && this.US && g.a.WO(this.US)
        }, Sq: function () {
            function a() {
                for (var a = d.get("layers"), b = d.get("zoom"), c = 0; c < a.length; c += 1) {
                    var e = a[c].get("zooms");
                    if (!(a[c].Zj || a[c].W3 || !e || b > e[1] || b < e[0] || !a[c].get("visible") || a[c].o && a[c].o.ga && 0 === a[c].o.ga.length || a[c].o && a[c].o.eD || a[c].o && a[c].o.La)) return !1
                }
                a = d.D.get("features");
                return ("all" === a || g.a.ja(a, "point")) && d.Ac && d.Ac.get("visible") && 0 < d.Ac.ga.length && !d.Ac.La && !d.Ac.EN ? !1 : !0
            }

            function b() {
                var a = {id: d.D.id};
                g.ne.$e.end(g.extend(a, {key: "rds"}));
                g.ne.$e.send(g.extend(a,
                    {
                        params: {
                            rs: d.get("baseRender"),
                ...
                d.D && d.D.Vl && d.D.Vl.eB && d.D.Vl.eB();
                d.D.s6 = 1;
                d.iX();
                d.set("display");
                d.UC = !0
            ...
            if (!this.xP) if (this.UC) 1 === this.ht && 13 === this.get("zoom") && (g.a.vC.stop(this.EF), g.ne.$e.send({
                id: this.D.id,
                params: {fps: this.EF.vC, type: "fps", rs: this.get("baseRender")}
            }), this.ht = 2), this.iX(); else {
                var d = this, e = this.D.get("rasterLayer"),
                    f = a();
                e ? (e.o && e.o.La && (this.D.La || c()), f && (this.D.La || c(), this.TS(), b())) : f && (this.D.La || c(), b(), this.D.z6 = !0)
            }
        }, layersChanged: function () {
            this.ra = this.ra || [];
            for (var a = this.get("layers"), b = this.ra.length - 1; 0 <= b; b -= 1) this.ra[b] === this.ud || this.ra[b] === this.os || this.ra[b].OA || this.ra[b].V.OA || -1 !== g.a.indexOf(a, this.ra[b].V) || (this.ra[b].Pg(), this.ra[b].Zk && this.ra[b].Zk.Pg(), this.ra[b].V.G("complete", this.Sq, this), this.ra[b].V.G("renderComplete", this.Sq, this), this.ra = g.a.Yn(this.ra, b));
            for (var c = !1,
                     d = !0, e = this.get("labelzIndex"), b = 0; b < a.length; b += 1) if (!a[b].W3) if (a[b].ei) -1 === g.a.indexOf(this.ra, a[b].o) && this.ra.push(a[b].o); else {
                var f = this.Lf(a[b]);
                f && (this.ra.push(f), a[b].ei = !0, a[b].o = f);
                a[b].g("complete", this.Sq, this, !0);
                a[b].g("renderComplete", this.Sq, this)
            }
            for (b = 0; b < this.ra.length; b += 1) f = this.ra[b].V, f.Up && f.get("visible") && (c = !0, !1 === f.get("detectRetina") && (d = !1), e = f.get("textIndex") || e);
            this.Ac && (c || "3D" !== this.D.view.type ? this.Ac.EN = !1 : (c = g.a.find(a, function (a) {
                if (A.o.Ws && a instanceof
                    A.o.Ws && a.get("visible")) return !0
            }), this.Ac.EN = c = !!c));
            a = g.a.indexOf(this.ra, this.Ac);
            c && this.D.get("showLabel") ? (-1 === a && this.ra.push(this.Ac), this.Ac.ia = d && g.l.ia, this.Ac.QB(this.get("mapStyle") || "normal"), this.Ac.set("zIndex", e), this.Ac.set("visible", !0), this.D.EC = !0, this.D.get("isHotspot") ? this.Ac.Qsa() : this.Ac.eP()) : (this.Ac && (this.Ac.set("visible", !1), this.D.EC = !1, this.Ac.eP()), this.D.EC = !1);
        ...
        controlsChanged: function () {
            ...
            if (a.add && 0 < a.add.length) for (; 0 < a.add.length;) b = a.add.shift(), (c = b.Mt || b.addTo) && c.call(b, this.D, this.Sa.controls); else if (a.remove && a.remove.length) for (; 0 < a.remove.length;) b = a.remove.shift(), (c = b.jv || b.removeFrom) && c.call(b, this.D, this.Sa.controls)
        }, e0: function () {
            if (!this.xP) {
                var a = this;
                this.j0 = !1;
                a.ud || (a.ud = new g.o.$c(new A.o.$c, a), a.ud.lf = 36, a.ud.Xf = 36, a.ud.set("zIndex", 120), a.ra.push(a.ud), a.ud.kC = !0);
                for (var b = a.get("overlays"), c = [],
                         d = 0; d < a.jd.length; d += 1) -1 === g.a.indexOf(b, a.jd[d].Wb) && (a.jd[d].Wb instanceof A.w.Pe || a.jd[d].Wb instanceof A.w.rn ? a.jd[d].Pg() : (a.ud && a.jd[d] instanceof g.w.qb ? (a.ud.Ng = g.a.Mx(a.ud.Ng, a.jd[d].L), a.ud.G6([a.jd[d].L])) : a.os && a.os.G6([a.jd[d].L]), a.jd[d].L.ba ? (g.h.remove(a.jd[d].L.ba), a.jd[d].L.ba = null) : a.jd[d].L.Ya && (g.h.remove(a.jd[d].L.Ya.Rf), g.h.remove(a.jd[d].L.Ya.Yb), a.jd[d].L.Ya = null), a.jd[d].en && a.jd[d].en.stop(), a.jd[d].Wb.ei = !1, a.jd[d].Wb.el(), a.jd[d].Wb.w = null, a.jd[d].Wb = null, a.jd[d].L.dna(),
                    a.jd[d].L = null, a.jd[d].el(), a.jd[d].He = null, a.jd[d].gi(), a.jd[d].map = null), c.push(a.jd[d]));
                for (d = 0; d < c.length; d += 1) a.jd = g.a.Yn(a.jd, g.a.indexOf(a.jd, c[d]));
                var e = [], f = [];
                g.a.pva(function (b) {
                    if (!b.ei && b.Jg) {
                        var c = b.w || a.kla(b);
                        c && (a.jd.push(c), c instanceof g.w.Pe || c instanceof g.w.rn ? c.Ly(a) : c instanceof g.w.qb ? e.push(c.L) : f.push(c.L), b.ei = !0)
                    }
                }, b);
                e.length && a.ud.px(e);
                f.length && (a.os || (a.os = new g.o.$c(new A.o.$c, a), a.os.set("zIndex", 110), a.ra.push(a.os)), a.os.px(f));
                a.set("display", 0)
            }
        }, overlaysChanged: function () {
            this.jd =
                this.jd || [];
            this.get("overlays") && 0 === this.get("overlays").length ? this.e0() : this.j0 || (g.a.Qc(this.e0, this), this.j0 = !0)
            ...
            if (a) {
                ...
                var b, c = this;
                g.pb.load("overlay", function () {
                    for (var d in a) a.hasOwnProperty(d) && (b = a[d], c.Wl[d] = c.Wl[d] || new g.w.Pe(b, c))
                })
            }
        }, kla: function (a) {
            var b = null;
            if (a instanceof
                A.w.qb) b = new g.w.qb(a, this); else if (a instanceof A.w.rn) b = new g.w.rn(a, this); else if (a instanceof A.w.Pe) b = new g.w.Pe(a, this); else {
                var c = ["overlay"];
                "d" === this.get("overlayRender") ? (c.push("dvector"), g.l.po ? c.push("svg") : c.push("vml")) : c.push("cvector");
                if (!this.Lxa && !g.pb.RC(c)) {
                    var d = this;
                    g.pb.Kg(c, function () {
                        this.Lxa = !0;
                        d.overlaysChanged()
                ...
                a instanceof A.w.Ec ? b = new g.w.Ec(a, this) : a instanceof A.w.Jz ? b = new g.w.Jz(a, this) : a instanceof A.w.Vb ? b = new g.w.Vb(a, this) : a instanceof A.w.Ug ? b = new g.w.Ug(a,
                    this) : a instanceof A.w.Us ? b = new g.w.Ec(a, this) : a instanceof A.w.$s && (b = new g.w.Ec(a, this))
            }
            return b
        }, v2: function () {
            var a = this.oe;
            !this.cu || this.th && this.th.ap || (a = "function" === typeof this.cu ? this.cu(this.Kl.R.zoom) : this.cu);
            return a
        }, CAa: function () {
            function a() {
            }

            var b = new g.o.$c, c = [], d = new g.T(116.405467, 39.907761);
            new g.style.vg.Th;
            ...
            var b = new g.o.$c, c = [], c = (new g.P9({map: this})).IS(a);
            b.px(c);
            this.ra.push(b);
            this.set("display", 0)
        }, Lf: function (a) {
            ...
            a = a.Lf(this);
            if (!a) return null;
            if (a.length && "string" == typeof a[0]) g.pb.Kg(a, function () {
                b.layersChanged()
            }); else return a;
            return null
        }, uCa: function () {
            ...
            if (a) if (g.a.fi(this.FD), g.l.Al) {
                var b =
                    this;
                setTimeout(function () {
                    b.fc()
                }, 0)
            } else this.fc(); else this.Sv || (this.FD = g.a.Qc(this.fc), this.Sv = !0)
        }, fc: function () {
            this.FD = null;
            if (!this.xP) {
                this.q("render");
                ...
                if (this.ra && (a.size = this.D.get("size"), a.size.width && a.size.height)) {
                    for (var b = this.D.view.type, c = [], d = 0, e = this.ra.length; d < e; d += 1) this.ra[d].zi && this.ra[d].zi !== b ? this.ra[d].La = !0 : (c.push(this.ra[d]), this.ra[d].Zk && c.push(this.ra[d].Zk));
                    c.sort(function (a, b) {
                    ...
                    a.Uka = 15E5 < a.size.width * a.size.height * c * c;
                    ...
                    a.Ss = a.R.zoom > b;
                    a.Df = a.R.zoom > b ? "zoomOut" :
                        a.R.zoom < b ? "zoomIn" : "stable";
                    a.PDa = !0;
                    a.G0 = this.G0;
                    for (var b = !1, f, c = !1, d = 0; d < this.ra.length; d += 1) this.ra[d].oi && this.ra[d].V.get("visible") && a.R.zoom <= this.ra[d].V.get("zooms")[1] && (a.YS = !0), this.ra[d].se().Nc && (b = !0);
                    for (d = 0; d < this.ra.length; d += 1) this.ra[d].V.HO && a.YS && (!this.Ck && this.ra[d].V.get("visible") && (f = this.ra[d].V.HO(), f.aDa = 1, f.zoom = a.R.zoom), c = !0);
                    this.wb = [];
                    c && f && this.wb !== f && (this.wb = f);
                    a.wb = this.wb;
                    a.Nc = b;
                    a.scale = Math.pow(2, a.R.zoom - a.R.ye);
                    this.Kl = a;
                    this.hd = this.D.get("mask");
                    a.hd =
                        this.hd;
                    a.YI = this.YI;
                    if (f = this.iI()) f.fc(a), this.Rk = this.fQ = this.YI = !1
                }
            }
        }, iI: function () {
            if (!this.K || this.K.type !== this.D.view.type || this.K.Kra) if (this.K = null, "3D" == this.D.view.type) {
                var a = this;
                g.pb.load("Map3D", function () {
                    a.K || (a.K = new g.Ba.LE(a), a.set("display"))
                })
            ...
            delete g.ne.ny[this.D._amap_id];
            this.xP = 1;
            this.TS(!0);
            this.U = {};
            this.Ac && (this.Ac.V.G("complete", this.Sq, this), this.Ac.Pg(), this.ra = g.a.Yn(this.ra, g.a.indexOf(this.ra, this.Ac)));
            this.th && this.th.bf && this.th.bf.V && this.th.bf.V.setMap();
            this.ija && clearTimeout(this.ija);
            this.Nia();
            this.Nfa();
            this.vN && this.vN();
            this.Tja();
            ...
            this.J = this.J.AL = null;
            this.gi();
            this.ue && (this.ue.stop(), this.ue = null);
            this.Cf && (this.Cf.stop(), this.Cf = null);
            ...
            if (d) {
                this.Lp || (this.Lp = []);
                b = 0;
                for (c = this.Lp.length; b < c; b += 1) this.Lp[b].tua();
                g.pb.load("interaction", function () {
                    var b = new g.Iya({type: d, o: a.os}, a);
                    a.Lp.push(b);
                    a.loaded = !0
                })
            } else if (this.Lp) for (b = 0, c = this.Lp.length; b < c; b += 1) this.Lp[b].tua(), this.Lp[b].ZAa(), this.G("click", this.Lp[b].JCa,
                this)
        }, ze: function (a, b, c) {
            return this.D.view.ze(a, b, c)
        }, kg: function (a, b, c) {
            return this.D.view.kg(a, b, c)
        }, f3: function (a, b) {
            ...
            for (l = 0; l < k.length; l += 1) {
                var m = k[l];
                if (g.h.Ym(m, "amap-layer") || g.h.Ym(m, "amap-e") || g.h.Ym(m,
                    "amap-labels")) if ("CANVAS" === m.tagName) {
    ...
    g.Jb.zb({
        Bea: function () {
            this.TA = !1;
            g.l.Af && ("3D" === this.D.view.type ? this.Xaa() : this.Vaa());
            g.l.Z || this.Saa()
        }, Nia: function () {
            g.l.Af && ("3D" === this.D.view.type ? this.Tfa() : this.Sfa());
            g.l.Z || this.Ofa()
        }, rotateEnableChanged: function () {
            this.fva = this.get("rotateEnable");
            g.l.Af && this.J0 && "3D" !== this.D.view.type && (this.fva ? this.J0() : this.vsa())
        }, zoomEnableChanged: function () {
            this.get("zoomEnable") ? (g.l.Af && this.JO && "3D" !== this.D.view.type && this.JO(), g.l.Z || this.Uaa()) : (g.l.Af && this.ZR && this.ZR(), g.l.Z || this.Rfa())
        },
        mousewheelChanged: function () {
            ...
            var e, f = {};
            a || (a = window.event);
            var h = g.F.Pl(a, this.Sa.Yc);
            g.l.Af && ("touchend" !== a.type ? this.U.ifa = h : h = this.U.ifa);
            f.sb = h;
            f.Na = this.kg(h);
            f.Na && (f.Na = f.Na.toFixed(3));
            f.Tf = this.Qd(f.Na);
            c || (c = this.TA ? this.TA ? [this.TA] : null : this.oda(f.Na, d)) && 0 < c.length && c[0].$q && (e = c[0].$q, f.Ht = c[0]);
            e || "info" === a.rf || (e = this);
            f.bd = e;
            f.Hza = a.altKey;
            f.ctrlKey = a.ctrlKey;
            ...
            var a = this.U;
            a.Sf && (a.Lj.sb.x === a.Sf.x && a.Lj.sb.y === a.Sf.y ? a.yg = !1 : (a.yg = !0, a.Yo || (a.Cp.q("dragstart", a.Bp), a.Yo = !0), a.Cp.q("dragging", a.Lj), a.Sf = a.Lj.sb))
        }, Wva: function (a) {
    ...
    g.Jb.zb({
        Iea: function () {
            this.zn = {};
            this.g("moveend", this.E5, this);
            g.l.Al && (g.l.uK || g.l.eH) && this.g("zoomend", this.zU, this);
            this.g("movestart", this.F5, this);
            this.g("zoomstart", this.L5, this);
            this.g("zoomend", this.K5, this);
            this.FL();
            this.ht = 0;
            this.EF = {};
            "undefined" === typeof window.requestAnimationFrame && (this.ht = 2)
        }, L5: function () {
            2 !== this.ht && 12 === this.get("zoom") && (this.ht = 1, g.a.vC.start(this.EF));
            this.Ck = !0
        }, K5: function () {
            1 === this.ht && 13 !== this.get("zoom") && (this.ht = 0, g.a.vC.cancel(this.EF));
            this.Ck =
                !1;
            this.set("display")
        }, A_: function (a, b) {
            ...
            this.Dt();
            this.T6();
            !a.q4 && this.D.get("limitBounds", null, !0) ? (a = this.Ala()) && !a.cb(this.get("center")) ?
                this.$J(this.get("zoom"), a, !1, !0) : this.ma("moveend") : this.ma("moveend");
            this.set("display")
        }, F5: function () {
            this.yg = !0;
            this.Dt()
        }, dragEnableChanged: function () {
            (this.lC = this.get("dragEnable")) ? this.EL() : this.uN()
        }, ma: function (a, b) {
            if (this.D.fe(a)) {
                var c;
                b && (c = b.u5 ? {type: a, newsize: b.u5, oldsize: b.wsa} : {
                    type: a,
                    pixel: b.sb,
                    target: this.D,
                    lnglat: b.Tf
            ...
            this.g("click", this.eZ);
            this.g("dblclick", this.iZ);
            g.l.Af && this.fW();
            g.l.Z || this.Taa()
        }, Pfa: function () {
            this.G("click", this.eZ);
            ...
            c === this.get("zoom") || this.Cf && this.Cf.ov && c === this.Cf.end || this.Hz(c, !1, a)
        }, eZ: function (a) {
            this.ma("click", a)
        }, iZ: function (a) {
            this.get("doubleClickZoom") && this.get("zoomEnable") && this.kG(a.Na, 1);
            this.ma("dblclick", a)
        }, mAa: function (a) {
            this.kG(a.AFa, a.b8);
            this.ma("touchend",
            ...
            this.lC && ("3D" === this.D.view.type ? (this.g("dragstart", this.oZ), this.g("dragging", this.kZ), this.g("dragend", this.mZ)) : (this.g("dragstart", this.nZ), this.g("dragging", this.jZ), this.g("dragend", this.lZ)))
        }, uN: function () {
            this.lC || ("3D" === this.D.view.type ? (this.G("dragstart", this.oZ), this.G("dragging", this.kZ), this.G("dragend", this.mZ)) : (this.G("dragstart", this.nZ), this.G("dragging", this.jZ), this.G("dragend", this.lZ)))
        }, nZ: function (a) {
            this.NR(a);
            ...
            this.U.mC =
                a.sb.y;
            this.ue && (this.ue.stop(), this.Gr(!0));
            this.ma("dragstart");
            this.ma("movestart");
            this.q("movestart", a);
            this.bwa()
        }, jZ: function () {
            var a = this.U, b = a.Lj.sb.x - a.Rx, c = a.Lj.sb.y - a.mC;
            if (c || b) {
                this.U.yg = !0;
                this.A_(b, c);
                a.Rx = a.Lj.sb.x;
                ...
                a = this.get("centerCoords").$a((new g.H(a, d)).Fd(this.S));
                (d = this.h1(a)) && (c = Math.round(this.ze(d).$a(this.ze(a)).y));
                this.xo(this.Sa.nr, b, c);
                a.x =
                    (a.x + g.a.Da) % g.a.Da;
                this.set("centerCoords", a, !0);
                this.set("center", this.Qd(a), !0);
                this.Ju && (this.Yg ? (a = new Date, this.ot = 100 < a - this.Yg ? new g.H(0, 0) : new g.H(b, c), this.Yg = a) : this.Yg = new Date);
                this.ma("dragging");
                this.ma("mapmove")
            } else this.U.yg = !1, this.ot = null, this.Dt()
        }, xo: function (a, b, c) {
            if (a && !(1 > Math.abs(b) && 1 > Math.abs(c))) {
                var d = parseFloat(a.style.top) || 0, e = parseFloat(a.style.left) || 0, f = "";
                this.rotation && (f = g.h.Es[g.h.dg] + ":rotate(" + this.rotation + "deg);overflow:visible;");
                a.style.cssText = "position:absolute;top:" +
                    (d + c) + "px;left:" + (e + b) + "px;" + f
            }
        }, h1: function (a) {
            var b = this.D.view.IV(), c = this.CT.height * this.S / 2;
            return a.y < b.dc + c ? (a.y = b.dc + c, a) : a.y > b.vc - c ? (a.y = b.vc - c, a) : null
        }, lZ: function () {
            this.Kv();
            100 < new Date - this.Yg && (this.ot = null);
            this.U.Sf = null;
            this.Xg = !1;
            this.Dt();
            this.ma("dragend");
            if (this.Ju && this.ot) if (this.U.yg) {
                var a = this.ot, b = new g.H(0, 0);
                this.ue = new g.uj(a, b, function (a, b, e) {
                    return 600 <= e ? b : a.Fd(1 - Math.pow(e / 600, 2)).floor()
                }, 1);
                this.ue.Xp = function (a) {
                    if (2 > Math.abs(a.x) && 2 > Math.abs(a.y)) this.ue.stop(),
                        this.q("moveend"), this.Gr(), this.ot = this.Yg = null; else {
                        var b = a.x, e = a.y, f = this.rotation;
                        f && (f *= Math.PI / 180, b = a.x * Math.cos(f) + Math.sin(f) * a.y, e = -Math.sin(f) * a.x + Math.cos(f) * a.y);
                        b = this.get("centerCoords").$a((new g.H(b, e)).Fd(this.S));
                        e = this.h1(b);
                        f = a.y;
                        e && (f = Math.round(this.ze(e).$a(this.ze(b)).y));
                        this.xo(this.Sa.nr, a.x, f);
                ...
                this.ue.ln(this)
            } else this.q("moveend"), this.Gr(!0), this.ot = this.Yg = null;
            else this.q("moveend"), this.Gr(), this.ot = this.Yg = null
        }, bwa: function () {
            if (!this.U.refresh) {
                var a = this, b = null;
                this.U.refresh = setInterval(function () {
                    b !== a.U.Sf && (a.set("display", 0), b = a.U.Sf)
                }, g.l.Z ? 400 : 100)
            }
        }, zU: function () {
            if (g.l.Al && (g.l.uK || g.l.eH)) {
                ...
                (c.Jt && (c.Jt.width = 0), c.jx && (c.jx.width = 0))
            }
        }, Gr: function (a) {
            this.U.refresh && (clearInterval(this.U.refresh), this.U.refresh = null);
            a || (this.zU(), this.set("display", 0))
        }, T6: function (a) {
            this.set("refresh", a)
        }
    });
    g.Jb.zb({
        setZoomSlow: function (a) {
            this.$J(a, null, !this.get("animateEnable"))
        }, setPanTo: function (a) {
            this.$J(null, a, !this.get("animateEnable"))
        }, zoomAndCenterChanged: function (a) {
            var b = a[0];
            b < this.get("zooms")[0] && (b = this.get("zooms")[0]);
            b > this.get("zooms")[1] && (b = this.get("zooms")[1]);
            this.$J(b, a[1], a[2] || !this.get("animateEnable"))
        }, zoomChanged: function () {
            ...
            this.q("closeOverlays");
            this.Mza ? this.PJ(!0) : this.PJ(!1)
        }
    });
    g.zV = g.aa.extend({
        ja: [g.sa, g.Qe], r: function (a, b) {
            this.type = "2D";
            this.Xe(b, !0);
            a && this.Wka(a)
        }, Wka: function (a) {
            this.map = a;
            this.Re(["size", "refresh", "maxPitch"], a);
            this.centerChanged();
            a.Re(["zoom", "center", "centerCoords", "rotation", "pitch"], this)
        }, IV: function () {
            this.vL || this.jma();
            return this.vL
        }, jma: function () {
            ...
            if (this.get("center") instanceof g.T) {
                a = new g.Ee(-180, -85, 180, 85);
                var b = this.map.Ab(a.Nj());
                a = this.map.Ab(a.io());
            ...
            return {
                ...
                S: Math.pow(2, 20 - b),
                ye: Math.round(b),
                rg: Math.pow(2, 20 - Math.round(this.get("zoom")))
            }
            ...
            var a = this.map;
            a.C = !0;
            var b = this.IV(), c = this.get("centerCoords"),
                d = a.getSize();
            a.C = !1;
    ...
    g.YE = g.zV.extend({
        Nl: function () {
            var a = this.get("size"), b = this.get("centerCoords"), c = parseInt(this.get("rotation")) % 360,
                ...
                e = new g.Ef(b.$a(a.Fd(e)), b.add(a.Fd(e))), c = this.map.get("targetLevel");
            if (c > d - 1) {
                var f = Math.pow(2, 20 - c);
                e.l9 = new g.Ef(b.$a(a.Fd(f)), b.add(a.Fd(f)))
            }
            e.Z7 = c || d;
            e.tc = a;
            return e
            ...
            a = Math.pow(2, 20 - a);
            return new g.Ef(c.$a(b.Fd(a)), c.add(b.Fd(a)))
        }, qd: function () {
            var a = this.Nl(), b = a.Pd.x, c = a.Xb.y, a = new g.H(a.Xb.x, a.Pd.y), b = new g.H(b, c);
            return new g.Ee(this.map.Qd(a), this.map.Qd(b))
        }, zoomChanged: function () {
        }, ze: function (a, b) {
            this.get("size");
            var c =
                a.mb(), d = this.get("centerCoords"), e = c.$a(d);
            e.x < -g.a.Da / 2 ? e.x += g.a.Da : e.x > g.a.Da / 2 && (e.x -= g.a.Da);
            var c = this.get("size").WD().dd(2), f = this.get("rotation") * Math.PI / 180,
                d = e.x * Math.cos(f) - Math.sin(f) * e.y, e = Math.sin(f) * e.x + Math.cos(f) * e.y;
            return c.add((new g.H(d, e)).Fd(Math.pow(2, (b || this.get("zoom")) - 20)))
        }, kg: function (a, b) {
            var c = this.get("size").WD().dd(2), d = a.$a(c), e = this.get("rotation") * Math.PI / 180,
    ...
    g.pL = g.zV.extend({
        ...
        rotationChanged: function (a) {
            ...
            if (!this.Cxa() && (this.nU(), this.ena(), this.map)) {
        ...
        ena: function () {
            ...
            return g.a.uf() - this.jfa > a
        }, nU: function () {
            var a = this.get("centerCoords"), b = this.get("pitch"), c = this.get("rotation"),
                d = (new g.Dc).v7(-a.x + g.a.Zb.x, -a.y + g.a.Zb.y, 0);
            this.qla = {x: a.x - g.a.Zb.x, y: a.y - g.a.Zb.y};
            a = (new g.Dc).dz(180 - b, 1, 0, 0);
            this.Lta = (new g.Dc).set(a);
            c = (new g.Dc).dz(c, 0, 0, 1);
            this.us = (new g.Dc).set(c);
            this.ioa = d.Hg();
            this.Zc = (new g.Dc).v7(0, 0, -this.Nm).multiply(a.multiply(c.multiply(d))).toFixed(8);
            this.Zc.Ue = this.Zc.Hg()
        }, Cxa: function (a) {
            a = a || this.get("zoom");
            ...
            this.Iy = this.Nm / 10;
            this.QH = 50 * this.Nm;
            this.Pma = (this.Nm - this.Iy) / (this.QH - this.Iy);
            this.Wf.s7(a, c, this.Iy, this.QH);
            this.Wf.Ue = this.Wf.Hg();
            a = this.Wf;
            var c = new g.SU, b = c.pD, e = this.Wf.elements, d = e[0], f = e[1], h = e[2], k = e[3], l =
            ...
            var a = this.map;
            a.map.uv && (this.wq(), this.R[3] = a.get("size").toString());
            var b = this.R.toString();
            if (b !== this.p6) {
                var c = this.get("zoom"), d = this.Az;
                d.zoom = c;
                d.KB = this.KB;
                d.top =
                    this.top;
                ...
                d.ye = Math.round(c);
                d.N5 = Math.floor(c);
                d.rg = Math.pow(2, 20 - d.ye);
                d.Ysa = Math.pow(2, 20 - d.N5);
                d.Wf = this.Wf;
                d.Zc = this.Zc;
                this.p6 = d.key = b
            }
            this.Az.eh = this.get("center");
            this.Az.uq = g.a.uf();
            this.Az.oo = this.oo();
            return this.Az
        }, Nl: function () {
            ...
            var e = new g.H(0, d);
            c = this.kg(e, !0);
            if (55 < this.He.pitch || !c) for (; !c;) d += a / 40, e.y = d, c = this.kg(e, !0);
            this.top = d / a;
            e.x = b;
            d = this.kg(e, !0);
        ...
        ze: function (a, b, c) {
            ...
            var b = this.get("size");
            a = new g.jl([a.x / b.width * 2 - 1, 1 - a.y / b.height * 2, -1, 1]);
            a.multiply(this.Iy);
            return this.Wf.Ue.mh(a)
        }, kg: function (a, b, c) {
            var d;
            ...
            a = new g.jl([e, d, -1, 1]);
            a.multiply(this.Iy);
            if (!this.Wf.Ue) return null;
            a = this.Wf.Ue.mh(a);
            e = new g.jl([e, d, 1, 1]);
            e.multiply(this.QH);
            d = this.Wf.Ue.mh(e);
            var f = this.Zc.Ue, e = f.mh(a).elements;
            a = f.mh(d).elements;
            c = (e[2] - (-c || 0)) / (e[2] - a[2]);
            if (0 > a[2] || 0 > c || b && c > 2.5 * this.Pma) return null;
            b = e[0] - c * (e[0] - a[0]);
            c = e[1] - c * (e[1] - a[1]);
            return isNaN(b) || isNaN(c) ? null : (new g.H(b, c)).add(g.a.Zb)
        }, n5: function (a) {
            for (var b = this.get("centerCoords"), c = g.a.Zb.x, d = g.a.Zb.y, e = this.get("size"), f = g.a.Da, h = b.x + f / 2, b = b.x - f / 2, k = [], l = new g.jl([0, 0, 0, 1]), m = l.elements, n = new g.H(0, 0), p = g.Dc.multiply(this.Wf, this.Zc), q = 0, r = a.length; q < r; q++) if (a[q]) {
            ...
            var b = this.get("size");
            a = this.Wf.mh(this.Zc.mh((new g.jl).copy(a)));
    ...
    g.Jb.zb({
        c1: function (a, b, c) {
            var d = this;
            d.pE ? (clearTimeout(d.pE), d.pE = null) : (d.ma("zoomstart", {zoom: a}), d.q("zoomstart"));
            ...
            if (e !== a) {
                ...
                "3D" !== this.D.view.type && (g.l.Z || g.l.te) && (b = !0);
                a = a || e;
                ...
                c = function (c) {
                    ...
                    var d = this.kg(l);
                    this.set("zoom", c);
                    var e = this.kg(l), d = e && e ? e.$a(d) : new g.H(0, 0);
                    this.set("centerCoords", this.get("centerCoords").$a(d).toFixed(3));
                    d.x && d.y && this.ma("mapmove");
                    c === a && a << 0 === a && (this.set("targetLevel", null), h && !this.pE && (this.ma("zoomchange"), this.ma("zoomend")), this.q("zoomend"), k && this.q("moveend"), this.Cf = null)
                };
                var m;
                this.yd && this.yd.ov && (this.yd.stop(), this.yd.YQ && (d = !0), this.yd.CC && (m = !0), this.yd = null, this.set("targetLevel",
                    null));
                this.Cf && this.Cf.ov && (this.Cf.stop(), d = !0, this.Cf.CC && (m = !0), this.Cf = null, this.set("targetLevel", null));
                h && !d && this.ma("zoomstart");
                k && !m && this.ma("movestart");
                this.q("zoomstart");
                b ? c.call(this, a) : (this.Cf = new g.uj(e, a, null, 0.04), this.Cf.YQ = h, this.Cf.CC = k, this.Cf.transition = function (a, b, c) {
                    return c >= g.A.YG ? b : (b - a) * (1 - Math.pow(1 - c / g.A.YG, 4)) + a
                }, this.Cf.Xp = c, this.Cf.ln(this, !0), this.set("targetLevel", a))
            }
        }, $J: function (a, b, c, d) {
            var e = null;
            a || (a = this.yd ? this.yd.mwa : this.get("targetLevel") || this.get("zoom"));
            var e = b ? this.Ab(b).toFixed(3) : this.yd ? this.yd.Y7 : this.get("centerCoords"),
                f = a !== this.get("zoom"), h = !e.cb(this.get("centerCoords")), k = b = !1;
            this.Cf && this.Cf.ov && (this.Cf.stop(), b = !0, this.Cf.CC && (k = !0), this.Cf = null, this.set("targetLevel", null));
            this.yd && this.yd.ov && (this.yd.stop(), this.yd.YQ && (b = !0), this.yd.CC && (k = !0), this.yd = null, this.set("targetLevel", null));
            this.ue && (this.ue.stop(), this.ue = null);
            if (f || h) {
                if (!this.D.view.Nl().contains(e) || f && "3D" !== this.D.view.type && (g.l.Z || g.l.te)) c = !0;
                if (c) f && (b ||
                (this.q("zoomstart"), this.ma("zoomstart")), this.set("zoom", a), this.ma("zoomchange"), this.ma("zoomend"), this.q("zoomend")), h && (k || d || (this.ma("movestart"), this.q("movestart")), this.set("centerCoords", e), this.ma("mapmove"), this.q("moveend", {q4: d})), this.set("targetLevel", null); else {
                    this.set("targetLevel", a);
                    var l = a - this.get("zoom"), m = e.$a(this.get("centerCoords")).toFixed(3);
                    this.yd = new g.uj(1, 0, null, 0.001);
                    this.yd.YQ = f;
                    this.yd.CC = h;
                    this.yd.Y7 = e;
                    this.yd.mwa = a;
                    this.yd.transition = function (a, b, c) {
                        return Math.pow(1 -
                            Math.min(g.A.YG, c) / g.A.YG, 2)
                    };
                    this.yd.Xp = function (b) {
                        0.02 > b ? (this.yd && (this.yd.stop(), this.yd = null), f && (this.set("zoom", a), this.ma("zoomchange"), this.ma("zoomend"), f = !1, this.q("zoomend")), h && (this.set("centerCoords", e), this.q("mapmove"), this.q("moveend", {q4: d})), this.set("targetLevel", null)) : (f && this.set("zoom", a - l * b), h && (b = e.$a(m.Fd(b)).toFixed(3), this.set("centerCoords", b), this.ma("mapmove")));
                        this.set("display", 1)
                    };
                    this.yd.ln(this);
    ...
    g.o.ac = g.aa.extend({
        ja: [g.sa, g.Qe], r: function (a, b) {
            ...
            this.kb = [3, 18];
            this.cF = g.a.ub(this);
            a && this.Re(["opacity", "visible", "zIndex", "zooms"], a);
            a.zi = b.D.view.type;
            this.e = b;
            this.W("display", b)
        }, Pg: function () {
            this.oi && this.eP();
            if (g.Ea && g.Ea.yq && g.Ea.yq.length) {
                var a = g.a.indexOf(g.Ea.yq, this);
                -1 !== a && (g.Ea.yq = g.a.Yn(g.Ea.yq, a))
            }
            if (a = this.Kb) {
            ...
            this.el();
            var c;
            this.N && (this.N.Kj(), this.N = null, c = "-" + this.bc);
            this.Zf && (this.Zf.Kj(), this.Zf = null, c = "-" + this.bc);
            if (c) for (var d in g.Ea.qj) g.a.qC(d, c) && delete g.Ea.qj[d]
        }, ma: function (a, b) {
            this.V.q(a, b)
            ...
            g.h.iq(a, this.opacity)
        }, opacityChanged: function () {
            var a = this.get("opacity");
            this.opacity = Math.min(Math.max(0, a), 1);
            if (a = this.Kb) if (a.length) for (var b = 0; b < a.length; b +=
                1) this.tT(a[b]); else this.tT(a);
            this.e && this.e.D && "3D" == this.e.D.view.type && this.set("display", 0)
        }, eo: function () {
            return this.e.hd && !this.V.get("rejectMapMask")
        }, fI: function () {
            var a = this.get("bounds");
            if (a) {
                if (a instanceof g.Ee) {
                    var b = a.Nj(), a = a.io(), c = this.e.Ab(new g.T(180, 0)).x, d = this.e.Ab(b), e = this.e.Ab(a),
                        f = this.e.get("center");
                    b.Q > a.Q && (0 < f.Q ? e.x += c : d.x -= c);
                    this.I = [d.x, d.y, e.x, e.y]
                } else a instanceof g.Ef ? this.I = [a.Xb.x, a.Xb.y, a.Pd.x, a.Pd.y] : a instanceof g.ZE && "3D" === this.V.zi && (b = a.path[1], d =
                    this.e.Ab(a.path[0]), e = this.e.Ab(b), this.I = [d.x, d.y, e.x, e.y, a.i7, a.height]);
                return this.I
            }
            return null
        }
    ...
    g.cg = g.aa.extend({
        ja: [g.sa], r: function (a, b) {
            ...
            return this.count >= this.bp
        }, oFa: function (a) {
            this.bp !== a && (this.bp = a | 0) && this.Z_(this.bp)
        }, Wc: function (a) {
            return !!this.e[a]
        }, get: function (a, b) {
            var c = this.fX(a);
            ...
            var c = this.fX(a);
            c ? c.value = b : (c = new g.cg.Hq(a, b), this.e[a] = c, this.KA(c), this.count += 1, this.count > this.bp && this.Z_(this.bp))
        }, Mv: function (a) {
            this.remove(a)
        },
        remove: function (a) {
            return this.e.hasOwnProperty(a) && this.kB(this.e[a]) ? !0 : !1
        }, forEach: function (a, b) {
            for (var c = this.Vc.next; c !== this.Vc; c = c.next) a.call(b, c.value, c.key, this)
        }, vJ: function (a, b) {
            return this.e.hasOwnProperty(a) ? this.e[a].value : b
        }, iEa: function () {
            return this.Vc.next.value
        }, jEa: function () {
            return this.Vc.Ga.value
        }, shift: function () {
            return this.UZ(this.Vc.next)
        }, m1: function () {
            this.SA.length = 0
        }, W4: function (a) {
            this.SA.push(a)
            ...
            0 === this.count ? (this.Vc.Ga = null,
                a.Ga = this.Vc, this.Vc.next = a) : (this.AB.next = a, a.Ga = this.AB);
            this.count += 1;
            this.AB = a
        }, sxa: function (a) {
            a = new g.cg.Hq("", a);
            0 === this.count ? (this.Vc.Ga = null, a.Ga = this.Vc, this.AB = this.Vc.next = a) : (this.Vc.next.Ga = a, a.next = this.Vc.next, a.Ga = this.Vc, this.Vc.next = a);
            this.count += 1
        }, osa: function () {
            if (this.count) {
                this.count -= 1;
                var a = this.Vc.next;
                a.next ? (a.next.Ga = this.Vc, this.Vc.next = a.next) : (this.Vc.next = null, this.AB = this.Vc.Ga = null);
                a.next = null;
                a.Ga = null;
                return a.value
            }
            ...
            return this.UZ(this.Vc.Ga)
        },
        fX: function (a) {
            if (this.e.hasOwnProperty(a)) return a = this.e[a], this.fF && (a.remove(), this.KA(a)), a
        }, KA: function (a) {
            this.fF ? (a.next = this.Vc.next, a.Ga = this.Vc, this.Vc.next = a, a.next.Ga = a) : (a.Ga = this.Vc.Ga, a.next = this.Vc, this.Vc.Ga = a, a.Ga.next = a)
        }, Z_: function (a) {
            if (!(this.count <= a || this.count < 2 * this.SA.length)) {
                for (var b = this.fF ? this.Vc.Ga : this.Vc.next, c = {}, d = 0, e = this.SA.length; d < e; d++) c[this.SA[d]] = !0;
                for (a = Math.ceil(2 * a / 3); b && this.count > a && (d = this.fF ? b.Ga : b.next, b.key && !c[b.key] && this.kB(b) && this.mJ(b.value),
                    b = d, b !== this.Vc && b !== this.AB);) ;
            }
        }, kB: function (a) {
            ...
            this.Vc !== a && (this.MB && console.log("Warnning!!!"), this.kB(a));
            return a.value
        }, clear: function () {
            this.e = {};
            this.Vc = new g.cg.Hq("", null);
            this.Vc.Ga = this.Vc.next = this.Vc;
            this.count = 0
        }
    });
    g.cg.Hq = function (a, b) {
        this.key = a;
        this.value = b
    };
    g.cg.Hq.prototype.Ga = null;
    g.cg.Hq.prototype.next = null;
    g.cg.Hq.prototype.remove = function () {
    ...
    function Qc(a, b, c) {
        ...
        clearTimeout(a.Bwa);
        var d = a.Fra;
        d.jn.remove(a.url) && d.kfa();
        d = a.Oqa ? a.ga : a.wa;
        a.ga = null;
        (c || b || a.eQ) && a.Gc(b ? d : null, a);
        a.x4 ? (a.x4.gi(), a.x4 = null) : d && (d.onload = null, d.onerror = null, d.onabort = null, a.wa = null)
    }

    g.FE = g.aa.extend({
        Jza: "assets/image/blank.gif", r: function (a, b, c) {
            this.timeout = b || 15E3;
            this.bq = new g.cg(1024);
            this.jn = new g.cg(1024);
            this.x1 = a;
            this.QP = c
        }, NL: function (a) {
            a && this.jn.count >= this.x1 && (a = this.jn.Vc.Ga.value, a.Om && (this.jn.remove(a.url), this.PV(a)));
            for (; this.bq.count && !(this.jn.count >= this.x1);) this.tca(this.bq.shift())
        }, kfa: function () {
            if (!this.xW) {
                this.xW = !0;
                var a = this;
            ...
            a.startTime = +new Date;
            a.QJ = !0;
            b.complete ? Qc(a, !0) : (this.jn.set(a.url, a), b.onload = Pc(a, !0), b.onerror = Pc(a, !1, !0), b.onabort = Pc(a, !1), a.Bwa = setTimeout(Pc(a, !1, !0), this.timeout))
        }, PV: function (a) {
            a.QJ && (Qc(a, !1), a.Om = !0, a.zAa = !0)
        }, vDa: function (a, b, c) {
            return this.By(a.url, b, c, !0, a.qa.z + "_" + a.qa.x + "_" + a.qa.y)
        }, By: function (a, b, c, d, e) {
            var f = this.jn.get(a);
            if (f && f.Om) f.Om = !1, f.Gc = b, f.eQ = c; else {
                f = new Oc(a, b, c);
                f.Oqa = d;
                f.key = e;
                if (this.bq.get(g.a.ub(f))) return;
                this.bq.set(g.a.ub(f),
                    f);
                this.NL(!0)
            }
            return f
            ...
            var d = this.jn.get(a);
            if (d && d.Om) d.Om = !1, d.Gc = b, d.eQ = c; else {
                d = new Oc(a, b, c);
                d.koa = !0;
                if (this.bq.get(g.a.ub(d))) return;
                this.bq.set(g.a.ub(d), d);
                this.NL(!0)
            }
            return d
        }, $0: function (a) {
            a.Om || (a.Om = !0, this.bq.remove(g.a.ub(a)))
        }, clear: function (a) {
            this.bq.forEach(function (a) {
                a.Om = !0
            });
            this.bq.clear();
            if (a) for (; 0 < this.jn.length;) a = this.jn.pop(), this.PV(a); else this.jn.forEach(function (a) {
                a.Om = !0
            })
        }
    });
    ...
    g.Dq = Rc;
    g.o.nb = g.o.ac.extend({
        r: function (a, b, c, d, e) {
            arguments.callee.ka.apply(this, arguments);
            this.W("tileSize", a);
            this.W("tiles", a);
            this.Re(["zooms", "type", "detectRetina", "errorUrl"], a);
            a.PF && (this.W("lang", b, !0), this.W("mapStyle", b, !0), this.W("style", b, !0), this.W("features", b, !0));
            var f = "overlayer" === a.get("type") || !1 === a.get("blend");
            this.pk = !f && !g.l.Z;
            if (g.l.te || g.l.kGa) this.pk = !1;
            var h = b.get("size"), h = h.width * h.height / 65536;
            this.ia = g.l.Z && g.l.ia && this.get("detectRetina");
            g.l.Nc && g.l.Z && 9 < h && (this.pk =
                !1);
            this.Ji = !f && !a.Zj;
            this.Ki = !f && !a.Zj;
            this.lK = c;
            this.W("reload", a);
            a.Kqa ? this.W("createTile", a) : this.W("tileFun", a);
            this.We = d;
            this.fR = e
            ...
            this.e.pd || (this.set("reload"), this.V.qs())
        }, featuresChanged: function () {
            this.set("reload");
            this.V.qs()
            ...
            this.Un = function (b, c, d) {
                var e = a(b.qa.x, b.qa.y, b.qa.z);
                if (!b.Vr || b.Vr.Om) b.loaded =
                    !1, b.Vr = ("3D" === this.e.D.view.type ? g.Ul.wra : g.Ul.By).call(g.Ul, e, function (a) {
                    b.Vr = null;
                    a ? c(a) : d()
                }, !1)
            }
            ...
            this.V.C = !1;
            this.Un = function (b, c, d) {
                a.call(this.j.V, b.qa.x, b.qa.y, b.qa.z, c, d, b)
            };
            this.set("reload")
        }, se: function () {
            var a = this.V.get("zooms", null, !0);
            this.V.Jqa && (a = [Math.min(a[0], 18), Math.min(a[1], 18)]);
            return {
                ...
                Un: this.V.get("createTile"),
                jo: this.lK || this.V.get("tileFun"),
                Nc: this.V.Up ? !1 : this.V.get("detectRetina") && g.l.ia && g.l.Z,
                hd: this.eo()
            }
        }, Cl: function (a) {
            if (g.N.Wd.Ei) return new g.N.Wd.Ei(this, a)
        }
    });
    g.Ul = new g.FE(6, null);
    g.o.$c = g.o.ac.extend({
        r: function (a, b) {
            ...
            this.Yu = [];
            this.Hl = new g.o.J9;
            a && (this.W("style", a), this.W("cursor", a, !0), this.Zva = a.get("stable") || !1, this.W("dataSources", a), this.W("bubble", a));
            this.W("display", b);
            this.Paa()
        }, se: function () {
            return {
            ...
            a && a.length ? "string" === typeof a ? (new g.fb.vb(a)).g("complete", function (a) {
                ...
                this.La = !0;
                this.V.q("complete")
            }, this) : a.length && (this.V5(a), this.zr = a, this.Sl = !0, this.set("display"), this.La = !0, this.V.q("complete")) : this.clear()
        }, getDatas: function () {
            return this.zr
        }, xxa: function () {
            if (this.V.ij) {
        ...
        ma: function (a, b) {
            var c = {type: a, data: "mouseout" === a ? this.hfa || null : b.Ht.eb, target: this.V};
            this.hfa = "mouseout" === a ? null : b.Ht.eb;
            this.V.q(a, c)
        }, kc: function (a) {
            this.ma(a.type, a)
        }, Paa: function () {
            ...
            if ("geojson" === a) return new g.P9({map: this.map});
            if ("topjson" === a) return new g.eza({map: this.map});
            if ("subway" === a) return new g.$ya({map: this.map})
        }, Dta: function (a) {
            if (a) {
                var b = [], b = [], c = {};
                if (a.rules) {
                    for (var b = a.rules, d = 0, e = b.length; d < e; d += 1) {
                        for (var f = [], h = b[d].symbolizers, k = 0, l = h.length; k < l; k += 1) h[k].fill && (f[k] = new g.style.vg.QU(h[k].fill)), h[k].stroke && (f[k] = new g.style.vg.rV(h[k].stroke));
                        h = f;
                        b[d].jK = h;
                        b[d] = new g.style.E$(b[d])
                    }
                    c.rules = b
                }
                if (a.symbolizers) {
                    b = a.symbolizers;
                    a = 0;
                    for (d = b.length; a < d; a += 1) b[a].fill && (b[a] = new g.style.vg.QU(b[a].fill)),
                    b[a].stroke && (b[a] = new g.style.vg.rV(b[a].stroke));
                    c.jK = b
                }
                a = new g.kL(c)
            } else a = new g.kL({});
            ...
            c.g("complete", function (c) {
                c = this.ga[a] = this.hpa(b).IS(c);
                this.px(c);
                this.ma("complete")
            }, this);
            c.g("error", this.cc, this)
        }, gua: function (a) {
            "px" === a.target.get("unit") ? (this.lf = Math.max(a.Yk, this.lf), this.Xf = Math.max(a.Yk, this.Xf)) : a.Yk > this.ds && (this.ds = a.Yk, this.Ey = this.ds / this.map.D.Zi.Gp(20))
        }, WG: function (a) {
            this.Hl.add(a);
            if (!this.kC &&
                !this.V.ij) {
                if (0 === a.name.indexOf("circle") || 0 === a.name.indexOf("ellipse")) {
                    a.g("rad", this.gua, this);
                    var b = a.get("radius");
                    b.length && (b = Math.max.apply(null, b));
                    "px" === a.get("unit") ? (this.lf = Math.max(b, this.lf), this.Xf = Math.max(b, this.Xf)) : this.ds ? b > this.ds && (this.ds = b, this.Ey = this.ds / this.map.D.Zi.Gp(20)) : (this.ds = b, this.Ey = this.ds / this.map.D.Zi.Gp(20))
                }
                b = a.get("strokeWeight") || 0;
                if (!this.Fy || b > this.Fy) this.Fy = b
            }
            this.Zva || a.W("feature", this, !0)
        }, px: function (a) {
            this.Sl = !0;
            ...
            var b, c;
            b = this.Hl.Wm([a[0] + g.a.Da, a[1], a[2] + g.a.Da, a[3]]);
            c = this.Hl.Wm([a[0] - g.a.Da, a[1], a[2] - g.a.Da, a[3]]);
            a = this.Hl.Wm(a);
            return g.extend(a, g.extend(b, c))
        }, rCa: function (a) {
            var b, c = this.get("style"), d = a.$k;
            c instanceof g.kL || (c = this.Dta(c));
            if (d && 0 < d.length) b = c.C1(d, a); else {
                if (c.c7.length || c.$k.length) b = c.Cma(a);
                b || (b = a.Koa())
            }
            return b
        }, PQ: function (a) {
            ...
            this.Sl = !0;
            var b = a.target, c = b.sc();
            0 !== this.Hl.Poa([g.a.ub(b)]).length && (this.Hl.remove(b, a.$u), c && !a.Vma && this.Hl.add(b))
        }, G6: function (a) {
            this.Sl = !0;
            for (var b, c = 0, d = a.length; c <
            d; c += 1) b = a[c], b.da.$u = null, b.Fr(!0), b.dl("feature")
        }, uFa: function (a, b) {
            return a[1].zIndex === b[1].zIndex ? g.a.ub(a[1]) - g.a.ub(b[1]) : a[1].zIndex - b[1].zIndex
        }, Vva: function (a, b) {
            return a[2] - b[2]
        }, gFa: function (a) {
            return a.xCa() === g.o.jza.Uya
        }, Cl: function (a) {
            return this.kC ? new g.N.xe.kl(this, a) : "c" === this.map.get("overlayRender") && g.N.canvas.kl ? new g.N.canvas.kl(this, a) : g.N.Wd.kl && "d" === this.map.get("overlayRender") ? new g.N.Wd.kl(this, a) : null
        }
    });
    g.o.$c.zb({
        Dl: function (a) {
            return this.kC ? new g.Ba.xe.kl(this, a) : this.V.ij ? new g.Ba.p$(this, a) : new g.Ba.kl(this, a)
        }
    });
    g.o.J9 = g.aa.extend({
        r: function () {
            ...
            var b = g.a.ub(a), c = a.sc();
            this.Jp[b] || (this.count += 1, this.Jp[b] = a, c && !g.I.cb(c.qd(), [Infinity, Infinity, -Infinity, -Infinity]) && this.ES.Tr(c.qd(), a))
        }, mCa: function () {
            return this.Jp
        }, Wm: function (a) {
            return this.ES.iva(a)
        }, Poa: function (a) {
            var b = a.length, c = [], d;
            for (d = 0; d < b; d += 1) this.Jp[a[d]] && c.push(this.Jp[a[d]]);
            return c
        }, remove: function (a, b) {
            var c = g.a.ub(a).toString(), d = a.sc();
            this.Jp[c] && (this.Jp[c] =
                null, d && (c = "undefined" !== typeof b ? b : d.qd(), this.ES.remove(c, a)))
        }
    });
    g.ok = g.aa.extend({
        r: function (a) {
            this.d5 = "undefined" !== typeof a ? a : 6;
            this.ZI = Math.floor(this.d5 / 2);
            this.VJ = {I: [Infinity, Infinity, -Infinity, -Infinity], Gb: []};
            this.count = 0
        }, Hla: function (a, b) {
            var c = -1, d = [], e;
            d.push(b);
            ...
            do {
                ...
                for (var h = f.length - 1; 0 <= h; h -= 1) {
                    ...
                    var l = g.ok.fz(k.I[2] - k.I[0], k.I[3] - k.I[1], k.Gb.length + 1),
                        k = g.ok.fz((k.I[2] > a.I[2] ? k.I[2] : a.I[2]) - (k.I[0] < a.I[0] ? k.I[0] : a.I[0]), (k.I[3] > a.I[3] ? k.I[3] : a.I[3]) -
            ...
            var c;
            if (0 === b.Gb.length) b.I = g.I.mb(a.I), b.Gb.push(a); else {
                var d = this.Hla(a, b), e = a;
                do {
                    ...
                    if ("undefined" !== typeof e.Ne || "undefined" !== typeof e.Gb || f) {
                        ...
                        if (c.Gb.length <= this.d5) if (0 < d.length) e = {I: g.I.mb(c.I)}; else break; else e = f = this.lra(c.Gb), 1 > d.length && (c.Gb.push(f[0]), d.push(c), e = f[1])
                    } else g.I.extend(c.I, e.I), e = {I: g.I.mb(c.I)}
                } while (0 < d.length)
            }
        }, lra: function (a) {
            for (var b = this.Ita(a); 0 < a.length;) this.Jta(a, b[0], b[1]);
            return b
        }, Ita: function (a) {
            for (var b =
            ...
            return [{I: g.I.mb(b.I), Gb: [b]}, {I: g.I.mb(c.I), Gb: [c]}]
        }, Jta: function (a, b, c) {
            for (var d = g.ok.fz(b.I[2] - b.I[0], b.I[3] - b.I[1],
                b.Gb.length + 1), e = g.ok.fz(c.I[2] - c.I[0], c.I[3] - c.I[1], c.Gb.length + 1), f, h, k, l = a.length - 1; 0 <= l; l -= 1) {
                var m = a[l],
                    n = [b.I[0] < m.I[0] ? b.I[0] : m.I[0], b.I[2] > m.I[2] ? b.I[2] : m.I[2], b.I[1] < m.I[1] ? b.I[1] : m.I[1], b.I[3] > m.I[3] ? b.I[3] : m.I[3]],
                    n = Math.abs(g.ok.fz(n[1] - n[0], n[3] - n[2], b.Gb.length + 2) - d),
                    m = [c.I[0] < m.I[0] ? c.I[0] : m.I[0], c.I[2] > m.I[2] ? c.I[2] : m.I[2], c.I[1] < m.I[1] ? c.I[1] : m.I[1], c.I[3] > m.I[3] ? c.I[3] : m.I[3]],
                    m = Math.abs(g.ok.fz(m[1] - m[0], m[3] - m[2], c.Gb.length + 2) - e), p = Math.abs(m - n);
            ...
            if (!1 === c[1]) {
                var d = 0, e = [];
                do d = e.length, e = e.concat(this.K6.apply(this, c)); while (d !== e.length);
                return e
            }
            return this.K6.apply(this, c)
        }, K6: function (a, b, c) {
            var d = [], e = [], f = [];
            ...
            do {
                ...
                if ("undefined" !== typeof b) for (; 0 <= k;) {
                    var l = c.Gb[k];
                    if (g.I.Gg(a, l.I)) if (b && "undefined" !== typeof l.Ne && l.Ne === b || !b && ("undefined" !== typeof l.Ne || g.I.y1(a, l.I))) {
                        "undefined" !== typeof l.Gb ? (f = this.$y(l, !0, [], l), c.Gb.splice(k, 1)) : f = c.Gb.splice(k, 1);
                        g.ok.OS(c);
                        b = void 0;
                        c.Gb.length < this.ZI && (h = this.$y(c, !0, [], c));
                        break
                    } else "undefined" !== typeof l.Gb && (e.push(k), d.push(c), c = l, k = l.Gb.length);
                    k -= 1
                } else if ("undefined" !== typeof h) {
                    c.Gb.splice(k + 1, 1);
                    0 < c.Gb.length && g.ok.OS(c);
                    k = 0;
                    for (l = h.length; k < l; k += 1) this.b4(h[k], c);
                    h.length = 0;
                    0 === d.length && 1 >= c.Gb.length ? (h = this.$y(c, !0, h, c), c.Gb.length = 0, d.push(c), e.push(1)) : 0 < d.length && c.Gb.length < this.ZI ? (h = this.$y(c, !0, h, c), c.Gb.length = 0) : h = void 0
                } else g.ok.OS(c)
            } while (0 < d.length);
            return f
        }, search: function (a, b) {
            return this.$y({I: a}, !1, [], this.VJ, b)
        }, iva: function (a, b) {
            return this.$y({I: a}, !1, [], this.VJ, b, !0)
            ...
            do {
                ...
                for (var l = d.length - 1; 0 <= l; l -= 1) {
                    var m = d[l];
                    if (g.I.Gg(a.I, m.I)) if ("undefined" !== typeof m.Gb) k.push(m.Gb); else if ("undefined" !== typeof m.Ne) if (b) c.push(m); else if ("undefined" === typeof e || m.type === e) m = m.Ne, "undefined" !== typeof f ? h[g.a.ub(m)] = m : c.push(m)
                }
            } while (0 < k.length);
    ...
    g.w = g.w || {};
    g.w.sh = g.aa.extend({
        ja: [g.sa, g.Qe], nta: ["position", "altitude", "visible", "clickable", "bubble"], r: function (a, b) {
            this.map = b;
            this.Re(this.nta, a);
            this.W("zIndex", a);
            this.W("draggable", a);
            ...
            this.get("draggable") ? this.EL() : this.uN()
        }, ma: function (a, b) {
            var c;
            ...
            this.get("clickable") ? this.DL() : this.a0()
        }, Waa: function () {
            this.get("clickable") && this.DL();
            ...
            this.g("dragstart", this.wt);
            this.g("dragging", this.ut);
            this.g("dragend",
                this.vt)
        }, wt: function (a) {
            this.map.NR(a);
            ...
            if ("2D" == b) {
                var c = a.sb.$a(this.Sf), b = c.x, c = c.y;
                this.Sf = a.sb;
                var d = this.map.get("rotation") * Math.PI / 180, e = b * Math.cos(d) + Math.sin(d) * c,
                    b = -Math.sin(d) * b + Math.cos(d) * c;
                this.xo(new g.H(e, b));
                this.ma("dragging", a)
            } else "3D" == b && a.Na && (c = a.sb.$a(this.Sf), b = c.x, c = c.y, e = a.Na.$a(this.B4), a.Tf.$a(this.A4), this.Sf = a.sb, "function" === typeof this.Hy && this.Hy(b, c, e), this.B4 =
                a.Na, this.A4 = a.Tf, this.ma("dragging", a))
        }, vt: function (a) {
            this.map.Kv();
            ...
            this.G("dragstart", this.wt);
            this.G("dragging", this.ut);
            this.G("dragend", this.vt)
        }, vM: function (a) {
            var b, c, d = [];
            if (a) for (b = 0, c = a.length; b < c; b += 1) d.push(this.wM(a[b]));
            return d
        }, wM: function (a) {
            a = this.map.Ab(a);
            return [a.x, a.y]
        }, Vf: function (a) {
            var b = this.L.ib || this.map.get("centerCoords"), c = Math.pow(2, 20 - this.map.get("zoom"));
            return [(a[0] -
                b.x) / c, (a[1] - b.y) / c]
        }, EA: function (a, b) {
            ...
            if (e) for (var e = [], f = 0, h = a.length; f < h; f++) {
                ...
                d.push(e)
            } else for (e = 0, f = a.length; e < f; e++) h = c.Ab(a[e]), h.x += b[0], h.y += b[1], d.push(c.Qd(h));
            return d
        }
    });
    g.w.qb = g.w.sh.extend({
        mD: "content contentDom icon opacity angle autoRotation offset textAlign verticalAlign shadow title label isTop shape topWhenClick topWhenMouseOver noSelect anchor".split(" "),
        xka: {
            AMAP_ANIMATION_NONE: !1,
            AMAP_ANIMATION_DROP: g.uj.Easing.Bounce,
            AMAP_ANIMATION_BOUNCE: g.uj.Easing.Cubic
        },
        r: function (a, b) {
            arguments.callee.ka.apply(this, arguments);
            this.Re(this.mD, a);
        ...
        NM: function (a, b, c) {
            ...
            if (d && "AMAP_ANIMATION_NONE" !== d) {
                var e = this;
                this.en = new g.uj;
                this.en.transition = function (c, h, k) {
                    if ("AMAP_ANIMATION_NONE" === d) return 0;
                    if (a && 600 <= k) return e.en.stop(), 0;
                    c = 0 === Math.floor(k / 600) % 2 ? "Out" : "In";
                    "out" === b ? c = "Out" : "in" === b && (c = "In");
                    return e.xka[d][c](k % 600 / 600)
                };
                c = c || 40;
                this.en.Xp = function (a) {
                    e.set("AnimationOffset", e.wN.add(new g.H(0, -1 * c * a)))
                };
                this.wN = new g.H(0, 0);
                this.en.ln()
            }
        ...
        d_: function () {
            this.en && (this.en.stop(), this.set("AnimationOffset", this.wN));
        ...
        animationChanged: function () {
            this.en && (this.en.stop(), this.set("AnimationOffset", this.wN), this.en = null);
            var a = this.get("animation");
            a && "AMAP_ANIMATION_NONE" !== a && ("AMAP_ANIMATION_DROP" === a ? this.NM(!0, "in", 100) : this.NM())
        },
        Xg: function () {
            this.Bq && this.Bq.set("position", this.get("position"))
        },
        raiseOnDragChanged: function () {
            this.get("raiseOnDrag") ? (this.g("dragstart", this.d_, this), this.g("dragging", this.Xg, this), this.g("dragend", this.UW, this)) : (this.G("dragstart",
                this.d_, this), this.G("dragging", this.Xg, this), this.G("dragend", this.UW, this))
        },
        xo: function (a) {
            var b = this.get("position");
            a = this.map.Ab(b).add(a.Fd(Math.pow(2, 20 - this.map.get("zoom"))));
            b instanceof g.T ? this.set("position", this.map.Qd(a)) : this.set("position", a)
        },
        Hy: function (a, b) {
            var c = this.get("position"), d = this.get("altitude"), c = this.map.Zr(c, d),
                d = this.map.tp(new g.H(c.x + a, c.y + b), null, d);
            this.set("position", d)
        },
        mla: function () {
            var a = this.get("content"), b = this.get("shadow"), c = this.get("offset"), d = this.get("label"),
                e, f = this;
            e = a ? this.O0(a, c) : this.NO(this.get("icon"), function () {
                f.L && f.L.ba ? (g.l.li && g.a.iepngFix(e), f.offsetChanged(), f.wK()) : f.map && f.map.set("display")
            });
            this.set("contentDom", e, !0);
            b && (a = this.U0(b, c), this.set("shadowDom", a, !0));
            d && d.content && this.set("labelDom", this.OO(d.content), !0)
        },
        OO: function (a) {
        ...
        Ut: function () {
            ...
            if (this.map && a && !this.L) {
                ...
                a.$q = this;
                this.W("coords", a, !0);
                a.Re("offset textAlign verticalAlign isTop zIndex params noSelect".split(" "), this)
            }
        },
        getParams: function () {
            return {
                ...
                MI: this.get("labelDom"),
                x7: this.get("shadowDom"),
                opacity: this.get("opacity"),
        ...
        offsetChanged: function () {
            function a(a) {
                ...
                var f = b.get("anchor"), m = b.L.Gj || g.h.ao(b.L.Bg);
                b.L.Gj = m;
                c = m[0];
                m = m[1];
                f && (f = f.split("-"),
            ...
            if (this.map) if (this.L && this.L.ba) {
                ...
                "2D" == c ? (c = this.map.Ab(this.get("position")), c = c.$a(this.L.Ka).dd(Math.pow(2, 20 - this.map.get("zoom"))), this.L.ba && (this.L.ba.bB && this.L.ba.parentNode !== this.L.ba.bB ? this.map.set("display") :
                    a(c))) : "3D" == c && (c = this.get("position"), c = this.map.Zr(c, this.get("altitude")), this.L.ba && (this.L.ba.bB && this.L.ba.parentNode !== this.L.ba.bB ? this.map.set("display") : a(c)))
        ...
        positionChanged: function () {
            if (this.L) {
                ...
                this.map && (this.L.y$ = !0, this.offsetChanged())
            }
        },
        ...
        dF: function () {
            this.L && (this.L.Gj = null, this.L.Vd = !0, this.map && (this.map.ud.Ql = !0, this.map.set("display")))
        },
        contentChanged: function () {
            if (this.L) {
                this.L.Gj = null;
                this.map.ud.Ql = !0;
                -1 === g.a.indexOf(this.map.ud.Ng, this.L) && this.map.ud.Ng.push(this.L);
                var a = this.get("contentDom");
                this.L.ba && this.L.ba === a.parentNode && this.L.ba.removeChild(a);
                var a = this.get("content"), b = this.get("offset"), a = this.O0(a, b);
                this.set("contentDom", a);
                this.L.ba ? (g.l.li && g.a.iepngFix(a), this.L.ba.appendChild(a), this.L.Bg = a, this.offsetChanged(),
                    this.wK()) : this.map && this.map.set("display")
            }
        },
        iconChanged: function () {
            if (this.L && this.L.ba && !this.get("content")) {
                ...
                var a = this.get("icon");
                this.get("offset");
                var b = this, c = this.NO(a, function () {
                    b.L && b.L.ba ? (g.l.li && g.a.iepngFix(c), b.offsetChanged(), b.wK()) : b.map && b.map.set("display")
                });
        ...
        shadowChanged: function () {
            if (this.L && this.L.ba) {
                ...
                if (a = this.get("shadow")) {
                    var b = this.get("offset"), a = this.U0(a, b);
        ...
        titleChanged: function () {
            this.L && this.L.Bg && "string" === typeof this.get("title") && this.L.Bg && this.get("title") && (this.L.Bg.title = this.get("title"))
        },
        wK: function (a, b) {
            a = a || this.get("label");
            b = b ||
                this.get("labelDom");
            if (a && b) {
                var c = a.direction, d = this.L.Gj || g.h.ao(this.L.Bg), e = d[0], d = d[1], f = g.h.ao(b), h = f[0],
                    k = f[1];
                this.L.Ru = f;
                var l = f = 0;
                switch (c) {
        ...
        labelChanged: function (a) {
            ...
            if (this.L && this.L.ba) {
                ...
                a && a.content && (c = "", a.content && (c = this.OO(a.content), b.appendChild(c), this.wK(a, c)), this.set("labelDom", c))
            } else a && a.content ? this.set("labelDom", this.OO(a.content), !0) : this.set("labelDom", null)
        },
        isTopChanged: function () {
            var a = this.map.ud.nK, b = this.get("isTop"), c = this.get("zIndex");
            a ? a === this ? this.L && this.L.ba && (this.L.ba.style.zIndex = b ? this.map.ud.sq + 10 : c, this.map.ud.nK = b ? this : null) : (a.L && a.L.ba && (a.L.ba.style.zIndex = b ? a.get("zIndex") : this.map.ud.sq +
                10), this.L && this.L.ba && (this.L.ba.style.zIndex = b ? this.map.ud.sq + 10 : c), this.map.ud.nK = b ? this : a) : (this.map.ud.nK = this, this.L && this.L.ba && (this.L.ba.style.zIndex = b ? this.map.ud.sq + 10 : c))
        },
        visibleChanged: function () {
            this.L && this.L.ba && (this.get("visible") && !this.Wb.get("outOfZooms") ? this.L.ba.style.display = "block" : this.L.ba.style.display = "none")
        },
        eta: function () {
            this.visibleChanged()
        },
        angleChanged: function () {
            if (!g.l.te && this.L && this.L.ba) {
                var a = this.L, b = a.get("params"), c = b.textAlign, d = b.verticalAlign, e =
                    b.offset, b = e.x, e = e.y;
                this.dF();
                if ("AMap.Text" == a.np) {
                    var e = b = 0, f = a.Gj || g.h.ao(a.Bg), h = f[0], k = f[1];
                    a.Gj = f;
                    switch (c) {
                        case "center":
                            b = h / 2;
        ...
        zIndexChanged: function () {
            ...
            if (a > this.map.ud.sq) {
                this.map.ud.sq = a;
                var b = this.map.ud.nK;
                b && b.L && b.L.ba && (b.L.ba.style.zIndex = a + 10)
            }
            this.L && this.L.ba && (this.L.ba.style.zIndex = this.get("isTop") ? this.map.ud.sq +
                10 : this.get("zIndex"))
        },
        opacityChanged: function () {
            var a = this.get("contentDom"), b = this.get("shadowDom");
            a && g.h.iq(a, this.get("opacity"));
            b && g.h.iq(b, this.get("opacity"))
        },
        O0: function (a) {
            var b;
        ...
        NO: function (a, b) {
            ...
            a ? ("string" === typeof a ? (c = a, n = !0) : (c =
                ...
                x: 0,
                y: 0
            }) : (c = g.A.qi + "/mark_bs.png", f = {x: 0, y: 0}, d = 19, e = 33, l = 19, m = 33);
            ...
            k.style.left =
                f.x + "px";
            h.appendChild(k);
            g.h.iq(g.l.te && n ? k : h, this.get("opacity"));
            d && e || (h.wL = !1);
            g.F.g(k, "load", function q() {
                this.L && (this.L.Gj = null);
                this.map && this.map.ud && (this.map.ud.Ql = !0);
                g.F.G(k, "load", q, this);
                if (this.L && this.L.ba) {
        ...
        moveChanged: function () {
            var a = this.get("move");
            if (!1 === a) return this.fwa();
            void 0 !== a && ("pause" === a.action ? this.Gta() : "[object Array]" ===
            Object.prototype.toString.call(a.Tf) ? a.Tf && ("resume" === a.action && this.XF ? this.moveTo(a.Tf[a.Tf.ep || 0], a.speed, a.tb) : (this.XF && this.q("movestop"), a.Tf.ep = 0, this.set("position", a.Tf[0]), this.isa(a.Tf, a.speed, a.tb, a.Lla))) : this.moveTo(a.Tf, a.speed, a.tb, !0))
        },
        moveTo: function (a, b, c, d) {
            if (!(0 >= b)) {
                var e = this.get("position");
                a.$a(e);
                var f = Math.round(a.qe(e) / 1E3 / b * 36E5);
                if (0 === f) return this.q("moveend");
                this.si && (this.si.stop(), this.si = null);
                this.si = new g.uj(e, a);
                c = c || function (a) {
                    return a
                };
                this.si.transition =
                ...
                this.si.Xp = function (b) {
                    this.set("position", b);
                    d && this.Wb.q("moving", {passedPath: [this.si.start, this.get("position")]});
                    this.q("moving");
                    b.cb(a) && (this.si && (this.si.stop(), this.si = null), this.Wb.q("moveend"), this.q("moveend"))
                };
                this.get("autoRotation") && !g.l.te && (b = "2D" == (this.map.D.view.type || "2D") ? this.lda(e, a) : this.mda(e, a), this.set("angle", b));
                this.si.ln(this)
            }
        },
        fwa: function () {
            this.si && (this.si.stop(),
                this.si = null, this.q("movestop"))
        },
        Gta: function () {
            this.si && (this.si.stop(), this.si = null, this.q("movepause"))
        },
        isa: function (a, b, c, d) {
            ...
            function f() {
                a.ep < a.length - 1 ? (a.ep += 1, this.moveTo(a[a.ep], b, c)) : (this.ma("movealong"), d ? (a.ep = 0, this.set("position", a[0]), this.moveTo(a[a.ep], b, c)) : this.q("movestop"))
            }

            var h = Math.min(a.ep || 0, a.length - 1);
            this.XF || (this.XF = !0, this.g("moving", e, this), this.g("moveend", f, this),
        ...
        mda: function (a, b) {
            var c = this.map, d = c.Zr(a), c = c.Zr(b), e = 0;
            c.qe(d);
    ...
    g.w.rn = g.w.sh.extend({
        r: function (a, b) {
            ...
            this.gm();
            this.dl("resolution");
            this.dl("centerCoords");
            this.dl("render");
            this.W("resolution", a);
            this.W("centerCoords", a);
            this.W("render", a);
            this.map.g("movestart", this.Am, this);
            this.map.g("mapmove", this.Am, this);
            this.map.g("zoomstart", this.Am, this);
            this.map.g("click", this.Am, this);
            this.map.g("closeOverlays", this.Am, this);
            this.map.g("rotate", this.Am, this)
        }, Am: function () {
            this.mp.map && (this.mp.C = !0, this.mp.close(), this.mp.C = !1)
        }, mapChanged: function () {
        }, positionChanged: function () {
            this.gm()
            ...
            if ("object" === typeof c) b.appendChild(c); else if ("string" === typeof c) b.innerHTML = c; else if ((c = this.get("items")) && c.length) {
                ...
                c.sort(function (a, b) {
                    return isNaN(a.nJ) || isNaN(b.nJ) ? 0 : a.nJ - b.nJ
                });
                for (b = 0; b < c.length; b += 1) (function (b) {
                    var c = b.Is, h = b.tb, k = g.h.create("li", d);
                    k.innerHTML = c;
            ...
            var a =
                this.map, b = this.J;
            a && b && (this.map.get("zoom"), b = this.get("position"), b = a.Zr(b), a = b.y, b = b.x, this.J.style.right = "", this.J.style.bottom = "", this.J.style.left = b + "px", this.J.style.top = a + "px")
        }, Pg: function () {
            this.J && (this.map.G("click", this.Oza, this), this.map.Sa.w.removeChild(this.J), this.mp.ei = !1, this.J = this.mp.He.map = null, this.map.G("movestart", this.Am, this), this.map.G("zoomstart", this.Am, this), this.map.G("click", this.Am, this), this.map.G("closeOverlays", this.Am, this), this.map.G("rotate", this.Am, this))
        },
        visibleChanged: function () {
    ...
    g.w.Pe = g.w.sh.extend({
        r: function (a, b) {
            arguments.callee.ka.apply(this, arguments);
            this.Re("content contentDom position contentU altitude isCustom autoMove showShadow closeWhenClickMap size offset anchor".split(" "), a);
            this.W("retainWhenClose", a, !0);
            a.W("toBeClose", this);
            this.ef = a
        }, Ly: function (a) {
            this.mma || (this.Fg(), this.Ks());
            this.dl("resolution");
            this.dl("centerCoords");
            this.dl("render");
            this.W("resolution", a);
            ...
            var b = g.h.create("div", a, "amap-info-shadowContainer"), c = g.h.create("div", a), d = this.get("anchor"),
            ...
            if (a) {
                var b = this.get("isCustom"), c = this.fh, d = this.xT;
                c.innerHTML = "";
                var e = null;
                if (b) {
                    ...
                    g.l.te && (e += " amap-info-content-ie8");
                    e = this.nqa = d = g.h.create("div", c, e);
                    "string" === typeof a ? d.innerHTML = a : d.appendChild(a);
                    this.oma = d;
                    a = g.h.create("a", this.nqa, "amap-info-close");
                    a.innerHTML = "\u00d7";
                    this.dP = a;
                    a.href = "javascript: void(0)";
                    g.l.Af && (g.F.g(a, "touchstart", function (a) {
                        g.F.stop(a)
                    }, this), g.F.g(a, "touchend", function (a) {
                        g.F.stop(a);
                        this.ef.C = !0;
                        this.ef.close();
                        this.ef.C = !1
                    ...
                    this.get("anchor");
                    g.h.create("div", c, g.l.te ? "amap-info-sharp-old" : "amap-info-sharp");
                    this.xT.style.display = "block"
                }
                g.F.dwa(e)
            }
        }, pU: function () {
            ...
            if (!a && b) {
                var a = this.xT, b = g.h.qI(this.fh), c = b.height - 23, d = b.width;
                if (g.l.li || g.l.Hu) c = this.fh.childNodes[0].offsetHeight, d = this.fh.childNodes[0].offsetWidth + 26;
                b = "background-image:url(" + g.A.yb +
                    (g.l.li ? "/theme/v1.3/iws.gif);" : "/theme/v1.3/iws.png);");
                a.innerHTML = "";
                var e = [], f;
                f = e[1] = {};
                f.height = 0.5 * c + 4;
            ...
            var a = this.map, b = this.Yb, c = this.get("position"), d = this.get("anchor");
            if (a && b && c) {
                a = a.Zr(c, this.get("altitude"));
                d && (this.fh.className = d + " amap-info-contentContainer");
                var e = g.h.qI(this.fh);
                if (g.l.li || g.l.Hu) e.width = this.fh.childNodes[0].offsetWidth + 14;
                b = e.height;
                c = this.get("offset");
                this.get("isCustom");
                e = e.width;
                ...
                d = this.oma;
                if (this.dP && d.childNodes[0]) {
                    for (b = a = 0; b < d.childNodes.length; b += 1) a += d.childNodes[0].clientHeight || 0;
                    a > (this.get("size").height || d.clientHeight) ? this.dP.style.right = "20px" : this.dP.style.right = "5px"
                }
            }
        }, Qba: function () {
            ...
            if (this.get("position") && this.get("autoMove") && this.fh) {
                for (var a = this.map, b = new g.vd(this.fh.offsetWidth, this.fh.offsetHeight), c = a.Zr(this.get("position"), this.get("altitude")).add(this.Qba()), d = c.add(b.WD()), e = a.get("size"), f = a.Coa(),
                         h = 0, k = 0, l = 0; l < f.length; l += 1) {
                    var m = f[l], n = 0, p = 0;
                    0 === m[1] && 0 === m[2] ? (n = m[3] - (c.x + h), p = m[0] - (c.y + k), 0 < n && 0 < p && (Math.abs(n) < Math.abs(p) ? h += n : k += p)) : 0 === m[2] && 0 === m[3] ? (n = e.gj() - m[1] - (d.x + h), p = m[0] - (c.y + k), 0 > n && 0 < p && (Math.abs(n) < Math.abs(p) ? h += n : k += p)) : 0 === m[0] && 0 === m[3] ? (n = e.gj() - m[1] - (d.x + h), p = e.ej() - m[2] - (d.y + k), 0 > n && 0 > p && (Math.abs(n) < Math.abs(p) ? h += n : k += p)) : 0 === m[0] && 0 === m[1] && (n = m[3] - (c.x + h), p = e.ej() - m[2] - (d.y + k), 0 < n && 0 > p && (Math.abs(n) < Math.abs(p) ? h += n : k += p))
                }
                c = c.add(new g.H(h, k));
                d = d.add(new g.H(h,
                    k));
                l = f = 0;
                0 > c.x || b.gj() > e.gj() ? f = 20 - c.x : e.gj() < d.x && (f = e.gj() - d.x - 25);
                0 > c.y || b.ej() > e.ej() ? l = 5 - c.y : e.ej() < d.y && (l = e.ej() - d.y - 15);
                f += h;
                l += k;
                if (f || l) a.D.C = !0, a.D.panBy(f, l), a.D.C = !1
            }
        }, bma: function () {
            this.get("closeWhenClickMap") && (this.map.g("clickstart", this.gZ, this, !1), this.map.g("clickend", this.fZ, this, !1))
        }, gZ: function () {
            this.ef.ei && (this.ef.C = !0, this.ef.getIsOpen() && (this.ef.mK = !0), this.ef.C = !1)
        }, fZ: function () {
            this.ef.ei && (this.ef.mK && (this.ef.C = !0, this.ef.close(), this.ef.C = !1), this.ef.mK = !1)
        },
        Pg: function () {
            this.Yb && this.map && (this.ef.mK = !1, this.get("closeWhenClickMap") && (this.map.G("clickstart", this.gZ, this), this.map.G("clickend", this.fZ, this)), this.get("retainWhenClose") ? this.map.ql.appendChild(this.Yb) : (this.Yb.parentNode === this.map.Sa.w && this.map.Sa.w.removeChild(this.Yb), this.ef.w = null), this.map = null, this.ef.ei = !1, this.Wb.q("close", {
                type: "close",
                target: this.Wb
            }))
        }, Zza: function () {
            ...
            this.map && this.Yb && (this.gm(), this.XV())
        }, anchorChanged: function () {
            this.positionChanged()
        }, offsetChanged: function () {
            this.positionChanged()
    ...
    g.Ca.Fe = g.aa.extend({
        ja: [g.sa, g.Qe], r: function () {
            ...
            if (g.Ca.Ec && this instanceof g.Ca.Ec) {
                var b = a.length;
                this.xf = Array(b);
                for (var c, d, e = 0; e < b; e += 1) if (c = a[e], d = new g.Ca.cV(c), this.xf[e] = d, 0 === e) {
                    if (0 === c.length) break;
                    d.Mp(c) || c.reverse()
    ...
    g.Rh = g.aa.extend({
        ja: [g.sa, g.Qe], r: function (a) {
            ...
            this.style = this.$k = this.$q = this.I4 = this.da = this.da.Aa = null;
            this.el();
            this.gi()
        }, xpa: function () {
            return this.$k
            ...
            this.$k = a;
            this.zIndex = this.$k[0].mk || this.zIndex
        }, sc: function () {
            return this.da
        },
        qT: function (a) {
            a && (this.da = a, this.W("coords", a, !0), this.NA || this.PM) && (a.W("radius", this), a.W("center", this), a.W("resolution", this), a.W("strokeWeight", this))
        }, setStyle: function (a) {
            this.Jva(a);
            this.Fr()
            ...
            this.da.$u = this.da.qd();
            this.da.jg = null;
            this.Fr()
        }, Fr: function (a) {
            this.set("feature", {target: this, Vma: a, $u: this.da.$u || this.da.qd(), nsa: this.da.qd()});
            this.da.$u = this.da.qd()
        }, visibleChanged: function () {
            this.Fr()
        }, CCa: function (a) {
            for (var b =
                0; b < this.$k.length; b += 1) {
                var c = this.$k[b];
                if (a.cb(c.Fx(this))) return c
            }
        }, Koa: function () {
            var a = this.sc(), b = [];
            a.ki() === g.Ca.Ge.NE || a.ki() === g.Ca.Ge.KE ? b.push(new g.style.me.Ec({
                fillColor: "#78cdd1",
                ae: 0.2,
                strokeColor: "#122e29",
                jb: 0.5,
                hc: 1
            })) : a.ki() === g.Ca.Ge.QK || a.ki() === g.Ca.Ge.bV || a.ki() === g.Ca.Ge.ZK ? b.push(new g.style.me.Ro({
                color: "#888888",
                width: 1,
                zIndex: 10
            })) : a.ki() !== g.Ca.Ge.lw && a.ki() !== g.Ca.Ge.$K || b.push(new g.style.me.Th({
                url: g.A.yb + "/theme/v1.3/markers/0.png", width: 36, height: 36, rotation: 0,
                oGa: -12, qGa: -36, zIndex: 100
            }));
            return b
        }
    });
    ...
    g.Ca.ug = g.Ca.Fe.extend({
        r: function (a, b) {
            ...
            if (!this.jg) {
                var a = this.va[0], b = this.va[1];
                if (this.ij) this.jg = [a, b, a, b]; else {
    ...
    g.N.ac = g.aa.extend({
        ja: [g.sa, g.Qe], r: function (a, b) {
            ...
            if (Math.floor(e) !== e) b(c, f); else {
                ...
                if (f.Ql) {
                    for (var e = f.Ng, h = !0, k = [], l = 0; l < e.length; l += 1) {
                        var m = e[l].Bg;
                        if (m) if (m.parentNode && m.parentNode.parentNode && this.K && m.parentNode.parentNode !== this.K.ql && "none" !== m.parentNode.style.display) {
                            var n = g.h.ao(m), m =
                                n[0], n = n[1];
                            if (m && n) {
                ...
                h = Math.max(h, k || 0);
                e = Math.max(e, k || 0);
                if (e = f.Wm([a[0] - e, a[1] - h, a[0] + e, a[1] + h])) {
                    for (var q in e) if (e.hasOwnProperty(q) &&
                        (h = e[q], h.get("visible") && !h.get("noSelect"))) if (k = h.sc(), k instanceof g.Ca.ug) if (this.ij) {
                        l = this.j.dm;
                        ...
                        var m = l.size.width * this.S, n = l.size.height * this.S, p = l.anchor.x * this.S,
                            r = l.anchor.y * this.S, k = k.va, s = l.rotation_, u = [a[0], a[1]];
                        if (s) {
                        ...
                        m = g.I.KO([[u[0] - m + p, u[1] - n + r], [u[0] + p, u[1] +
                        r]]);
                        g.I.Md(m, k) && c.push(h)
                    } else if ("undefined" !== typeof k.get("radius")) l = k.va, l = new g.H(l[0], l[1]), m = new g.H(a[0], a[1]), k = k.get("radius"), "px" === h.get("unit") ? m.qe(l) / Math.pow(2, 20 - this.zoom) < k && c.push(h) : m.qe(l) * Math.cos(h.get("center").P * Math.PI / 180) <= k / this.Sp * Math.pow(2, 20 - this.zoom) && c.push(h); else if ("AMap.Text" == h.np) l = h.get("params"), l.visible && h.ba && g.h.QC(d, h.ba, "amap-markers") && c.push(h); else {
                        if (l = h.get("params"), l.visible && h.ba) if (l.shape) for (k = k.va, s = l.lp % 360, u = [a[0], a[1]], s && (v = (a[0] -
                            k[0]) / this.S, x = (a[1] - k[1]) / this.S, t = Math.PI * s / 180, s = Math.cos(-t), w = Math.sin(-t), t = v * s - x * w, v = v * w + x * s, u[0] = k[0] + t * this.S, u[1] = k[1] + v * this.S), m = h.width * this.S, n = h.height * this.S, p = l.offset.x * this.S, r = l.offset.y * this.S, m = g.I.KO([[u[0] - m - p, u[1] - n - r], [u[0] - p, u[1] - r]]), k[0] instanceof Array || (k = [k]), n = k.length - 1; 0 <= n; n -= 1) {
                            if (g.I.Md(m, k[n])) {
                                l.shape ? this.PC(h, u, k) && c.push(h) : c.push(h);
                                break
                            }
                        } else g.h.QC(d, h.ba, "amap-markers") && c.push(h)
                    } else k.Md ? k.Md(a) && c.push(h) : k.Px && 1.8 * k.Px(a) <= h.get("strokeWeight") *
                        this.S && c.push(h);
                    this.ij ? c.sort(function (a, b) {
                        return a.Il > b.Il ? -1 : 1
                    }) : c.sort(function (a, b) {
                        return a.get("isTop") ? -1 : b.get("isTop") ? 1 : a.get("zIndex") > b.get("zIndex") || a.get("zIndex") === b.get("zIndex") && a.Il > b.Il ? -1 : 1
                    });
                    b(c, f)
                } else b([], f)
            }
            ...
            if ("circle" === a.B.type) {
                ...
                if ("poly" ===
                    a.B.type) return e = a.B.coords, e = this.nH(e), g.zd.Md(d, e);
                if ("rect" === a.B.type) return e = a.B.coords, a = e[0], b = e[1], c = e[2], e = e[3], e = [[a, b], [c, b], [c, e], [a, e]], g.zd.Md(d, e)
            }
            return !1
        }, nH: function (a) {
            for (var b = [], c = 0; c / 2 < a.length / 2; c += 2) b.push([a[c], a[c + 1]]);
            return b
        }, M2: function (a, b, c, d, e, f, h) {
    ...
    g.N.Jb = g.aa.extend({
        ja: [g.sa, g.Qe], r: function (a) {
            ...
            this.oe = a || g.a.Dk("ff" + this.e.oe.slice(1))
            ...
            for (var h = b.length, k = [], l = 0, m, n = [], p = 0; p < h; p += 1) m = b[p], m instanceof g.o.$c && m.get("visible") && (n.push(this.xu(m)),
                l += 1);
            for (h = 0; h < n.length; h += 1) n[h].vu(a, f, d, e)
        }
    });
    g.G1 = {
        dI: function (a, b, c) {
            ...
            return {Vy: f, gJ: h, ps: d, dD: e}
        }, Apa: function (a) {
            var b = this, c = g.a, d = [], e = {};
            c.Qb(a.nodes, function (a) {
                !1 !== a.value && null !== a.value && (e[a.zoom] = g.A.Bc + "://" + a.value, d.push(a.zoom))
            });
            return function (a) {
                a = c.lc(a, 1);
            ...
            return function (a) {
                ...
                if (void 0 === e[a]) {
                    var k = b.dI(a, d, e);
                    e[a] = f && "none" !== f && k.gJ !== k.Vy && k.ps !== k.dD ? c.g3(k.ps, k.dD, (a - k.Vy) / (k.gJ - k.Vy), f) : k.ps
                }
                return e[a]
            }
        }, soa: function (a) {
            ...
            var d = this, e = g.a, f = [], h = {}, k =
                a.transitional;
            e.Qb(a.nodes, function (a) {
                null !== a.value && !1 !== a.value && (h[a.zoom] = e.Aka(a.value, c ? "rgba" : "webgl"), f.push(a.zoom))
            });
            return function (a) {
                var b = null;
                a = e.lc(a, 1);
                if (void 0 === h[a]) {
                    var b = d.dI(a, f, h), n = b.ps;
                    if (k && "none" !== k && b.Vy !== b.gJ && b.ps.join("") !== b.dD.join("")) for (var n = n.slice(0), p = (a - b.Vy) / (b.gJ - b.Vy), q = 0, r = b.dD.length; q < r; q++) n[q] = e.g3(b.ps[q], b.dD[q], p, k);
                    h[a] = n
                }
                b = h[a];
            ...
            for (f in c) if (c.hasOwnProperty(f)) {
                ...
                } : d.call(this, b[h], c[f])) : e.Eqa && (a[f] = !0)
            }
        }, hr: function (a, b) {
            for (var c = [], d = 0, e = a.length; d < e; d += 2) {
                var f = 0,
            ...
            if (b[c]) console.log("customType repeat!!", c); else {
                var d = {}, e = {visible: "visible", zT: "showLabel", ck: "showIcon"},
                    f = [["color", {color: "color"}, {opacity: "opacity"}], ["fillColor", {fillColor: "fillColor"}, {ae: "fillOpacity"}], ["strokeColor", {strokeColor: "strokeColor"}, {jb: "strokeOpacity"}], ["textFillColor", {qwa: "textFillColor"}, {rwa: "textFillOpacity"}], ["textStrokeColor", {twa: "textStrokeColor"}, {uwa: "textStrokeOpacity"}], ["backgroundColor", {backgroundColor: "backgroundColor"},
                        {Jka: "backgroundOpacity"}]];
                if (a.styles) {
                    a = a.styles;
                    this.tJ(d, a, e, this.soa, {Eqa: !0});
                    for (var e = 0, h = f.length; e < h; e++) {
                        var k = f[e];
                        a[k[0]] ? this.tJ(d, a, k[1], this.Aoa, {Fqa: !0}) : this.tJ(d, a, k[2], this.gpa)
                    }
                    a.texture && (this.tJ(d, a, {Ua: "texture"}, this.Apa), d.ld = [], g.a.Qb(a.texture.nodes, function (a) {
                        a.value && d.ld.push(g.A.Bc + "://" + a.value)
                    }))
                } else {
                    ...
                    for (h = f.length; e < h; e++) {
                        ...
                        void 0 !== a[m] ? d[k] = {canvas: this.hr(a[m], "str"), Oe: this.hr(a[m])} : d[n] = a[l]
                    }
            ...
            if (a) for (var e in a) if (a.hasOwnProperty(e) && g.a.Tj(a[e], "object")) {
                var f = a[e], h = e;
                c && (h = c + ":" + e);
                if (f.detailedType) this.Y5(f, b, h), this.qS(f.detailedType, b, h, f); else if (f.subType) this.qS(f.subType, b, h); else {
                    if (void 0 !== f.code) {
            ...
            if (!this.Jx || this.Jx.zoom != a) {
                var b = g.a.Eh, c = {zoom: a}, d;
                for (d in this.hi) if (this.hi.hasOwnProperty(d)) {
                    var e = this.hi[d];
                    c[d] = {};
            ...
            if (this.e.D.ni) {
                a = a || this.get("style");
                this.Ol.hA || (this.Ol = g.a.bind(this.Ol,
                    this), this.Ep = g.a.bind(this.Ep, this), this.Ol.hA = !0);
                var b = g.a, c = {};
                this.qS(a, c);
                this.hi = c;
                a = this.hi["regions:land"];
                var c = this.hi.water, d = this.hi.sky, e = this.hi.buildings, f, h, k, l, m, n = this.dk;
                if (a) {
                    var p = "rgba(0, 0, 0, 0)";
                    if (a.visible) {
                        var q = this.Ep(b.W6(this.e.oe.substr(1)), a.opacity, a.color, !0, n);
                        q && (p = this.Ez(q, a.visible, "rgba(0, 0, 0, 0)"), q = this.Ol(b.mv(this.e.oe.substr(1)), a.opacity, a.color, !0, n), f = this.Ez(q, a.visible))
                    }
                    this.e.cu = p
                } else this.e.cu = "";
                c && c.visible && (h = this.Ol(b.mv(this.e.SG.substr(1)),
                    c.opacity, c.color, !0, n), h = this.Ez(h, c.visible));
                d && d.visible && (k = this.Ol(b.mv(this.e.uB.substr(1)), void 0, d.color, !0, n), k = this.Ez(k, d.visible));
                e && (e.visible ? (l = this.Ol(b.Dk(this.e.gF[0]), void 0, e.fillColor, !0, n), l = this.Ez(l, e.visible), m = this.Ol(b.Dk(this.e.gF[1]), void 0, e.strokeColor, !0, n), m = this.Ez(m, e.visible)) : (l = [1, 1, 1, 0], m = [1, 1, 1, 0]));
                this.aS && this.aS(f, h, k, [l, m]);
                this.O8 ? this.O8(this.hi) : this.set("display");
                delete this.Jx;
                this.lU(n)
            }
        }, Ez: function (a, b) {
            var c = 2 < arguments.length && void 0 !== arguments[2] ?
                arguments[2] : [0, 0, 0, 0], d = g.a.Eh;
            if (d(a) && d(b)) {
                var e = a;
                a = function (a) {
                    return b(a) ? e(a) : c
            ...
            if (a) {
                if (void 0 !== b) return a = a.split(","), c = b, "function" === typeof b && (c = b(e)), a[3] = g.a.lc(c, 3) + ")", a.join(",");
                if (c) return "function" === typeof c.canvas ? d ? c.canvas : c.canvas(e) : c.canvas
            }
            return a
        }, Ol: function (a, b, c, d, e) {
            if (a) {
                if (b) return c = b, "function" === typeof b && (c = b(e)), [a[0], a[1], a[2], g.a.lc(c, 3)];
            ...
            return a
                         ...
                         b, c) {
            var d = this.hi;
            this.Jx && c && c == this.Jx.zoom && (d = this.Jx);
            ...
            if (f = this.lI(b, void 0, e)) if ("function" === typeof f.visible && !f.visible(e) || !1 === f.visible) h = ""; else {
                var h = 1, k = "";
                if (c) if (f.fillColor || f.ae) h = f.ae, k = f.fillColor; else {
                    if (f.color || f.opacity) h = f.opacity, k = f.color
                } else if (f.strokeColor || f.jb) h = f.jb, k = f.strokeColor; else if (f.color || f.opacity) h = f.opacity, k = f.color;
                h = d(a, h, k, !1, e)
            }
            this.Pr === b &&
            (h = this.wu(h || a));
            ...
            this.Pr === b && (f = this.wu(f || a));
            return f
        }, ay: function (a, b, c, d, e, f) {
            var h = a, k = b, l = c, m = !0, n = !0, p = 1;
            f = f || this.dk;
            var q = this.lI(d, e, f);
            q && ("function" === typeof q.visible && !q.visible(f) || !1 === q.visible || "function" === typeof q.zT && !q.zT(f) || !1 === q.zT ? (n = m = !1, h = k = l = "") : (h = this.Ep(a, q.rwa, q.qwa,
                !1, f), k = this.Ep(b, q.uwa, q.twa, !1, f), l = this.Ep(c, q.Jka, q.backgroundColor, !1, f), m = "function" === typeof q.ck ? q.ck(f) : q.ck));
            f = !1;
            this.Pr === d ? f = !0 : void 0 !== e && this.Pr === d + "-" + e && (f = !0);
            f && (h = this.wu(h || a), k = this.wu(k || b), l = this.wu(l || c), p = 1 - 1.6 * this.HC, n = m = !0);
            return [h, k, l, m, n, p]
        }, $x: function (a, b, c, d, e) {
            var f = null, h = a, k = b;
            d = d ? this.Ep : this.Ol;
            var l = e || this.dk;
            if (f = this.lI(c, void 0, e)) "function" === typeof f.visible && !f.visible(l) || !1 === f.visible ? h = k = "" : (h = d(a, f.ae, f.fillColor, !1, l), k = d(b, f.jb, f.strokeColor,
                !1, l));
            this.Pr === c && (b = k || b, h = this.wu(h || a), k = this.wu(b));
            return [h, k]
        }
    };
    g.N.Jb.zb(g.G1);
    g.N.canvas.Jb = g.N.Jb.extend({
        r: function (a) {
            ...
            var b = this.e.v2();
            b && this.MS !== b && this.e.D.ni && (this.e.l7(b), this.MS = b);
            this.e.Sa.nr.style.cssText = "";
            var c = a.ra, b = a.R, d = this.e.D.get("features"), e = a.size.width, f = a.size.height;
            this.dk = "vw" === this.e.D.He.baseRender ? g.a.lc(b.zoom, 1) : a.R.ye;
            this.S = b.S;
            if (!this.Ka || 1E4 < Math.abs(b.hb.x - this.Ka.x) / this.S || 1E4 < Math.abs(b.hb.y - this.Ka.y) /
                this.S) this.Ka = b.hb;
            this.Ka.x - b.hb.x < -g.a.Da / 2 ? this.Ka = new g.H(this.Ka.x + g.a.Da, this.Ka.y) : this.Ka.x - b.hb.x > g.a.Da / 2 && (this.Ka = new g.H(this.Ka.x - g.a.Da, this.Ka.y));
            for (var h = 0; h < c.length; h += 1) {
                var k = c[h], l = this.xu(k), m = c[h].se();
                if (l && l.j) if (!m.visible || k.eD || m.kb[0] > b.zoom || m.kb[1] < b.zoom || k.ga && 0 === k.ga.length) {
                    if (l = l.fj()) if (l.length) for (m = 0; m < l.length; m += 1) l[m].parentNode === this.J && this.J.removeChild(l[m]); else l.parentNode === this.J && this.J.removeChild(l)
                } else if (this.vR(k, d)) {
                    l.fc(a, m);
                    l.$m &&
                    (a.Pf = l.Pf);
                    var k = l.fj(), n, p, q = l.transform;
                    if (!q || !k || l.Ig && !this.e.D.La) c[h].Nk && k.parentNode !== this.J && (this.J.appendChild(k), c[h].Kb = k); else {
                        c[h].Kb = k;
                        k.length || (k = [k], q = [q]);
                        for (var r = 0; r < k.length; r += 1) if (n = k[r], p = q[r], !p.ly) {
                            var s = p.translate.x, u = p.translate.y;
                            c[h].JI || (s = g.a.lc(s, 2), u = g.a.lc(u, 2));
                            var v = p.scale;
                            1E-5 > Math.abs(s) && (s = 0);
                            1E-5 > Math.abs(u) && (u = 0);
                            var x = [];
                            x.push("position:absolute");
                            x.push("z-index:" + (p.mk || c[h].get("zIndex")));
                            c[h].kC ? (x.push("top:" + Math.floor(f / 2 + u) + "px"), x.push("left:" +
                                Math.floor(e / 2 + s) + "px")) : n.o4 ? (x.push("height:" + n.height * v + "px"), x.push("width:" + n.width * v + "px"), x.push("top:" + (f / 2 - u * v) + "px"), x.push("left:" + (e / 2 - s * v) + "px")) : (1 !== v && (x.push(g.h.Es[g.h.dg] + "-origin:" + s + "px " + u + "px"), x.push(g.h.Es[g.h.dg] + ":scale3d(" + v + "," + v + ",1)")), x.push("top:" + Math.floor(f / 2 - u) + "px"), x.push("left:" + Math.floor(e / 2 - s) + "px"), l.kj && (x.push("height:" + n.height + "px"), x.push("width:" + n.width + "px")));
                            l.JI || 1 === m.opacity || "number" !== typeof m.opacity || x.push(g.h.S2(n, m.opacity));
                            n.parentNode !==
            ...
            if ("all" === b || void 0 === a.zl) return !0;
            for (var c = 0, d = a.zl.length; c <
            d; c++) if (g.a.ja(b, "region" === a.zl[c] ? "bg" : a.zl[c])) return !0;
            return !1
        }, zoomChanged: function () {
            var a = this.e.get("zoom");
            this.dk = "vw" === this.e.D.He.baseRender ? g.a.lc(a, 1) : Math.round(a);
            this.hi && this.lU(this.dk)
        }
    });
    g.N.Ei = g.N.ac.extend({
        r: function (a, b) {
            arguments.callee.ka.apply(this, arguments);
            this.W("reload", a, !0);
            ...
            this.ta = new g.cg(c);
            var e = this;
            this.ta.mJ.q0(function (a) {
                e.sA(a)
            });
            this.ta.MB = function (a) {
                return a.Rb ? (a.Rb.Ui -= 1, 0 == a.Rb.Ui && (a.Ou = !1), delete a.Rb, !0) : a.Ou ? a.Ui ? !1 : !0 : !0
            };
            this.ad = 1;
            this.wn = 50;
            this.ZV = !0;
            this.j.ta = this.ta;
            this.Ul = new g.FE(6, null, a.QP);
            new g.FE(5, null, a.QP)
        }, av: function () {
            this.clear();
            this.Tg = null;
            this.ta.clear();
            this.ta.MB = null;
            this.ta = this.ta.mJ.bF = null;
            this.Cc && (this.Cc.G("tiles", this.kD, this), this.Cc.G("ack", this.jD, this), this.Cc.G("disable", this.hD, this), this.Cc = null);
            this.kj && g.F.G(this.Qa, "webglcontextlost", this.gD, this);
            this.e.G("zoomend", this.Mj, this);
            this.e.G("moveend", this.Mj, this)
        }, reloadChanged: function () {
            this.j && (this.j.La = !1);
            this.ta.clear();
            this.reload = !0;
            ...
            function d(b) {
                a.loaded = !0;
                e.j && (a.status = "loaded", a.wa = !0, a.Le = b, e.set("display",
                    0), "function" === typeof c && c())
            }

            var e = this;
            a.status = "loading";
            this.j.Un && this.j.Un.call(this, a, d, function () {
                a.loaded = !0;
            ...
            for (var f = 0; f < a.length; f += 1) {
                var h = a[f].qa, k = Math.floor(h.x / b), h = Math.floor(h.y / b);
                if (d) {
                    if (k = c + "/" + k + "/" + h, (h = this.ta.get(k)) && "loaded" == h.status) continue
                } else h = new g.Dq(c, k, h), k = h + "", h = new g.nb(h);
            ...
            if (this.j.DG) {
                var e, f, h, k, l, m, n, p = function () {
                    ...
                    if (0 == p) return b.call(c, a), {xK: void 0};
                    d.ST = a;
                    for (e = a.length - 1; 0 <= e; e -= 1) for (f = a[e], h = [], k = [], f.NS = h, f.Zu = k, l = f.length - 1; 0 <= l; l -= 1) m = f[l], n = m.qa, c.j.e.th.nz(n.x, n.y, n.z, function () {
                        var c = l;
                        return function (e) {
                            ...
                            if (0 == p) {
                                for (e = a.length - 1; 0 <= e; e -= 1) {
                                    var l = a[e];
                                    a[e] = l.NS;
                                    if (l.Zu) for (var m = l.Zu.length - 1; 0 <= m; m -= 1) {
                                        var n = l.Zu[m];
                                        n.status = "loaded";
                                        n.loaded = !0;
                                        n.wa =
                ...
                if ("object" === typeof p) return p.xK
            } else b.call(this, a)
        }, Gv: function (a, b, c) {
            ...
            var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
            if (a.length) if (this.LJ) this.eJ = !0; else {
                for (var c =
                    a.length - 1; 0 <= c; c -= 1) {
                    var d = a[c];
                    if (d.length) for (var e = Math.pow(2, 20 - d[0].qa.z), c = d.length - 1; 0 <= c; c--) {
                        var f = d[c], h = f.qa;
                        h.S = e;
                        f.xa = {};
                        f.Qm = 0;
                        if (10 > h.z) {
                            var k = this.nI(f);
                            k && (f.Rb = k, f.status = "loaded", f.wa = !0, k.Ui += 1, f.Qm = (h.x - k.qa.x) / Math.pow(2, h.z), d.splice(c, 1), this.set("display", 0))
                        }
                        this.ta.set(f.key, f);
                        !b && f.ve ? f.ve = !1 : f.status = "loading"
                    }
                }
                var l = this;
                this.RH(a, function (a) {
                    for (var c = a.length - 1; 0 <= c; c -= 1) {
                        ...
                        if (d.length) if (l.oi) {
                            ...
                            l.vv(d, l.kj ? 1 : 0);
                            for (var f = 0,
                                     k = 0; f < d.length;) l.MR(d.slice(50 * k, 50 * k + 50), e, b), f += 50, k += 1
                        } else for (e = function () {
                            var a = d.length;
                            return function () {
                                if (0 === --a) {
                                    var b = {key: "rb", index: 0, id: l.e.D.id};
                                    l.j.V.Zj || (g.ne.$e.end(b), g.ne.$e.end(g.extend(b, {index: 1})))
                                }
                            }
                        }(), l.vv(d), l.Pp += d.length, f = d.length - 1; 0 <= f; f -= 1) l.kh(d[f], l.Ul, e)
                    }
                })
            }
        }, fy: function (a, b) {
        ...
        Cx: function (a, b) {
            var c = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0) || this.bb, d = a.Pd.x,
                e = a.Pd.y, f = a.Xb.x, h = a.Xb.y;
            new g.H(0, 0);
            var k = this.dK(20, c);
            ...
            return b < a.Jc || b > a.Hc || c < a.dc || c > a.vc ? !1 : !0
        }, vv: function (a, b) {
            if (a.length) {
                var c = this.hb.dd(this.xd << 20 - a[0].qa.z), d = Math.floor(c.x), e = Math.floor(c.y);
                a.sort(function (a, c) {
                    var k = a.qa, l = c.qa, m = k.x - d, k = k.y - e, n = l.x - d, l = l.y - e;
            ...
            this.zoom = c.zoom;
            this.ye = c.ye;
            this.bb = !1 === this.oi && !this.j.fR && this.j.ia ? this.ye + 1 : this.ye;
            this.We && this.bb > this.We && (this.bb = this.We);
            this.vo && this.bb < this.vo && (this.bb = this.vo);
            this.S = c.S;
            this.rg = c.rg;
            c = a.R.Ha;
            this.Wj = this.Cx(c, b.I);
            this.Vv = c.l9 ? this.Cx(c.l9, b.I) : null;
            var c = this.Wj, d = this.Ha.Z7, e = null, e = d < this.zoom && this.Vv ? this.Vv : c, f = [], h = [], k,
                l = [], m = [], n = [], p = new g.Dq(0, 0, 0), q, r = this.zoom, m = this.ol || "", s = {}, u = {}, v,
                x, t, w, y, D;
            this.Yd =
                1E6 * Math.random() << 0;
            for (q = m.length - 1; 0 <= q; q -= 1) if (k = m[q], !(k.yw < b.opacity)) if (p.z = k.qa.z, p.x = k.qa.x, p.y = k.qa.y, p.z === this.bb) s[p + ""] |= 16; else if (p.z < this.bb) {
                if (s[p + ""] |= 64, this.Ki) for (w = this.bb - p.z, v = Math.max(c.Jc, p.x << w), r = Math.min(c.Hc, (p.x + 1 << w) - 1), x = Math.max(c.dc, p.y << w), t = Math.min(c.vc, (p.y + 1 << w) - 1), p.z = this.bb, w = v; w <= r; w += 1) for (p.x = w, y = x; y <= t; y += 1) p.y = y, D = p + "", s[D] |= 32, u[D] = u[D] ? Math.max(k.qa.z, u[D]) : k.qa.z
            } else if (this.Ji) for (v = 1; p.z >= this.bb;) {
                s[p + ""] |= v;
                v = p.x >> 1;
                x = p.y >> 1;
                r = v << 1;
            ...
            q = !0;
            this.ta.m1();
            for (w = e.Jc; w <= e.Hc; w += 1) for (p.x = w, y = e.dc; y <= e.vc; y += 1) p.y = y, k = this.fy(p), this.rt(k), v = !1, k.wa ? (k.Yd = this.Yd, this.Iu(c, w, y) && (m.push(k), this.pk && (k.ad !== this.ad || 1 > k.yw) && (v = !0))) : (q = !1, this.Iu(c, w, y) && (v = !0), k.status && !k.ve || this.ye !== d || this.Vv && !this.Iu(this.Vv, w, y) || l.push(k)), v && n.push(k);
            q ? (this.sC || (this.sC = !0), this.j.La || (k = {
                key: this.j.Ig ? "rl" : "rb", index: 1,
                id: this.e.D.id
            }, this.j.V.Zj || (g.ne.$e.end(k), g.ne.$e.push({
                key: "ftc",
                qf: m.length,
                id: this.e.D.id
            })))) : this.j.La = !1;
            this.hg = q;
            m.length && this.sC && (f.push(m), m.hg = q);
            h.push(l);
            d = !1;
            if (this.Ji) {
                n = n.slice(0);
                ...
                for (r = this.bb + 1; n.length && r <= k; r += 1) {
                    ...
                    n = [];
                    p.z = r;
                    for (q = l.length - 1; 0 <= q; q -= 1) if (w = l[q], v = s[w.key], v & 7) for (v = w.qa.x << 1, x = w.qa.y << 1, w = 1; 0 <= w; w -= 1) for (p.x = v + w, y = 1; 0 <= y; y -= 1) p.y = x + y, D = p + "", t = this.ta.vJ(D), s[D] & 5 && t && t.wa ? (t.YA =
                        !0, t.Yd = this.Yd, m.push(t), this.rt(t)) : n.push(new g.nb(p.mb()));
                    m.length && (d = !0, f.push(m))
                }
                n = e
            }
            if (!d && this.Ki) for (w = !f.length || this.kj ? b.kb[0] : Math.max(b.kb[0], this.bb - 2), Math.max(w, this.bb - this.vfa), r = this.bb - 1; n.length && r >= w; r -= 1) {
                m = [];
                y = {};
                l = n;
                n = [];
                for (q = l.length - 1; 0 <= q; q -= 1) k = l[q], p.z = r, p.x = k.qa.x >> 1, p.y = k.qa.y >> 1, k = this.fy(p), y[k.key] || (y[k.key] = 1, v = !1, k.wa && (!this.xha || s[k.key] & 64) ? (p.x = Math.min(c.Hc, Math.max(c.Jc, p.x << this.bb - r)), p.y = Math.min(c.vc, Math.max(c.dc, p.y << this.bb - r)), p.z = this.bb,
                    D = p + "", "number" === typeof u[D] && k.qa.z > u[D] ? v = !0 : k.YA = !0, k.Yd = this.Yd, m.push(k), this.rt(k)) : v = !0, v && n.push(k));
                m.length && f.push(m)
            }
            this.ST = h;
            this.Uu = this.Pp = 0;
            ...
            for (var c = [], d = this.e.D.getCoordsBoundByZoom(a), d = this.Cx(d, b, a), e = d.Jc; e < d.Hc; e++) for (var f = d.dc; f < d.vc; f++) {
                var h = [a, e, f].join("/");
                this.ta.Wc(h) || c.push(new g.nb(new g.Dq(a, e, f), !0))
            }
            return c
        }, KL: function () {
            var a = this.e.D;
            return a.s6 &&
                a.get("preloadMode") && 200 <= this.ta.bp && this.j.V.Mu() && "stable" != this.Df && this.lx && this.lx() && this.zoom !== this.bb
        }, gv: function (a, b) {
            var c = b.I, d = b.kb;
            if (this.KL() && this.bb >= d[0] + 1) {
                var d = [], e = null, e = "zoomOut" === this.Df ? Math.floor(this.zoom) : Math.ceil(this.zoom),
                    e = this.EQ(e, c);
                e.length && d.push(e);
                d.length && this.dn(d, !0)
            }
        }
    });
    g.N.Wd.Ei = g.N.Ei.extend({
        r: function (a, b) {
            arguments.callee.ka.apply(this, arguments);
            this.wn = 120;
            this.oi = !1;
            ...
            this.ru = document.createDocumentFragment()
        }, lv: function (a) {
            var b = Math.pow(2, a.R.zoom - this.mf), c = a.R.hb.$a(this.Xr).dd(this.Zl);
        ...
        IO: function (a, b) {
            ...
            this.sU = b.sU;
            var c = this.Wj;
            this.pk = this.wn && b.hH;
            var d = this.Tg, e = 256 * c.xD, c = 256 * c.DJ;
            this.Ze = this.zoom << 0 !== this.zoom;
            var f = this.hb.$a(this.Ka);
            f.x < -g.a.Da / 2 ? f.x += g.a.Da : f.x > g.a.Da / 2 && (f.x -= g.a.Da);
            this.XO = f.dd(this.rg);
            return [d, e, c, b]
        }, Yy: function (a, b) {
            var c = this.IO(a, b);
            this.ss.apply(this, c);
            this.De(a);
            this.hg && !this.j.La && (c = this.j, c.V.Zj || g.ne.$e.end({key: "rb", index: 2, id: this.e.D.id}), c.La =
                !0, c.Cd ? c.ma("renderComplete") : (c.Cd = !0, c.ma("complete")))
        }, fc: function (a, b) {
            this.Ss = a.Ss;
            this.Lg = a.Lg;
            this.Do(a, b);
            this.Xr && g.l.Al && (a.Ze || a.Lg) ? this.lv(a, b) : this.Yy(a, b);
            this.Xr = this.hb;
            this.je && this.set("display", 0)
        }, kv: function () {
            for (var a = this.Kb.childNodes, b = a.length - 1; 0 <= b; b -= 1) a[b] && a[b].ad !== this.ad && this.Kb.removeChild(a[b])
        }, wD: function (a, b) {
            return a.dc === b.dc && a.Jc === b.Jc && a.vc === b.vc && a.Hc === b.Hc
        }, ss: function (a) {
            var b = this.ad;
            this.ad += 1;
            var c = !1, d, e, f;
            ...
            for (d = a.length -
                ...
                e = f[0].qa.z;
                var m, n, p = this.dK(this.ye, e), q = !1;
                this.$m && f.hg && f[0].qa.z == this.bb && (k = [], l = [], q = !0);
                for (var r = f.length - 1; 0 <= r; r -= 1) {
                    ...
                    n.mf = this.mf;
                    m = n.qa;
                    var c = !0, u = (new g.H((m.x << 20 - e) * this.xd, (m.y << 20 - e) * this.xd)).$a(this.Ka),
                        u = u.dd(this.rg);
                    u.x = g.a.lc(u.x, 1);
                    u.y = g.a.lc(u.y, 1);
                    var v = 1;
                    if (!n.VW || this.ZV && n.ad !== b) n.VW = this.currentTime;
                    this.pk && !n.YA ? (s = Math.max(0, Math.abs(m.z - this.zoom) - 1), v = Math.min(1, (this.currentTime - n.VW) / (1 / Math.pow(1.32, s) * this.wn)), 1 !== v && (this.je = !0)) : n.YA = !1;
                    n.ad = this.ad;
                    n.yw = v;
                    n.wa ? (s = n.Le, !s && n.Rb && n.Rb.Le && (s = n.Rb.Le), 0 !== v && s && (this.M2(s, u.x, u.y, p, p, v, m.z), s.parentNode !== this.Kb && (g.l.li && "overlayer" === this.j.get("type") && (s.style.display = "none"), this.ru.appendChild(s)), s.ad = this.ad, n.ye = this.ye, h.push(n))) : n.Yd = null
                }
                e = !0
            }
            this.$m &&
            k && (r = l.sort().join(";"), k.AR = r, r !== this.Pf.AR && (this.Pf = k));
            1 < a.length && (this.je = !0);
            this.ol = h;
            this.kv();
            this.Kb.appendChild(this.ru);
            return c || !e
        }, cT: function () {
        }, De: function () {
            this.transform = {translate: this.XO, scale: Math.pow(2, this.zoom - this.ye), rotate: 0}
        }
    });
    window.CanvasRenderingContext2D && (window.CanvasRenderingContext2D.prototype.vP = function (a, b, c, d, e) {
        ...
        c = h / k;
        e.pg = 0;
        for (var l = [], f = this.yH, m = 0, n = 0, p = !1, q = h = 0; q < e.length; q += 1) e.pg += e[q], l[q] = {
            oC: e[q] * d,
            pC: e[q] * c,
            ty: h += e[q]
        }, f -= e[q], 0 > f && !p && (m = q, n = -f, p = !0);
        for (p = 0; n + p <= k;) n < e[m] ? (f = n * d, h = n * c) : (f = l[m].oC, h = l[m].pC), a += f, b += h, this.PD ? this.moveTo(a, b) : this.lineTo(a, b), p += n, this.PD = !this.PD, n = e[(m + 1) %
        e.length], m = (m + 1) % e.length;
        k -= p;
        a += k * d;
        b += k * c;
        this.PD ? this.moveTo(a, b) : this.lineTo(a, b);
        this.yH = (this.yH + p + k) % e.pg
    }, window.CanvasRenderingContext2D.prototype.Lma = function (a, b, c, d) {
    ...
    g.N.xe.kl = g.N.Ei.extend({
        r: function (a, b) {
            ...
            if (this.Ih && this.Ih) for (var a in this.Ih) if (this.Ih.hasOwnProperty(a)) {
                var b = this.Ih[a];
                b.Yd !== this.Yd && b.ba && this.K.ql.appendChild(b.ba)
            }
        }, fc: function (a, b) {
            ...
            c = c.Wm(e);
            for (d in c) c.hasOwnProperty(d) && (c[d].Yd = this.Yd, c[d].I4 = this);
            this.kv(c);
            this.Ls.call(this.Xa, a, b);
            this.Xa.ED(c);
            this.Ih = c;
            this.De(a)
        }, De: function () {
            var a = Math.pow(2, this.zoom - this.ye);
            this.transform = {translate: this.Ka.$a(this.ib).dd(this.S), scale: a, rotate: 0}
        }
    });
    g.N.xe.$c = g.aa.extend({
        r: function (a) {
            this.Vk = a
        }, ED: function (a, b) {
            var c = document.createDocumentFragment(), d = b && b.rR ? null : {}, e = !0, f;
            for (f in a) if (a.hasOwnProperty(f)) {
                var h = a[f], k, l = h.get("params");
                if (h.ba) k = h.ba; else {
                    k = g.h.create("div");
                    k.className = "amap-marker";
                    var m = l.Bg, n = l.x7, p = l.MI;
                    m && k.appendChild(m);
                    n && k.appendChild(n);
                    p && !1 !== m.wL && k.appendChild(p);
                    h.ba = k;
                    h.Bg = m;
                    if (n = l.title) m.title = n;
                    this.j.Ql = !0;
                    -1 === g.a.indexOf(this.j.Ng, h) && this.j.Ng.push(h);
                    h.Vd = !0
                }
                var p = l.offset, q = p.x, r = p.y, s = l.textAlign,
                    u = l.verticalAlign, n = l.anchor, m = !1, v, x;
                n && (n = n.split("-"), 2 === n.length ? (s = n[1], u = n[0]) : 1 === n.length && "center" === n[0] && (s = "center", u = "middle"));
                var t, n = t = 0;
                if ("AMap.Text" == h.np || "AMap.Marker" == h.np) {
                    if (x = v = 0, k.parentNode !== this.Vk && d && (m = !0, d[f] = h, e = !1), !m) {
                        h.Vd || !h.Gj ? (t = g.h.ao(h.Bg), h.Gj = t) : t = h.Gj;
                        n = t[0];
                        t = t[1];
                        switch (s) {
                            case "center":
                ...
                if (!m) if (h.Vd) {
                    ...
                    D.push("top:" + r + "px");
                    D.push("left:" + q + "px");
                    D.push("z-index:" + (l.u4 ? this.j.sq + 10 : l.zIndex));
                    if (!g.l.te) {
                        r = v;
                        q = x;
                        if ("AMap.Marker" == h.np) {
                ...
                } else if (h.y$ || this.zoom << 0 !== this.zoom || h.zoom !== this.zoom || k.parentNode !== this.Vk || h.Ka !== this.Ka) w = this.$t(h.da.va), h.Ka = this.Ka, y = l.uE,
                    r = Math.round(w[1] + r + y.y), q = Math.round(w[0] + q + y.x), k.style.top = r + "px", k.style.left = q + "px";
                h.zoom = this.zoom;
                k.parentNode !== this.Vk && (g.l.li && g.a.iepngFix(k), c.appendChild(k));
                h.Vd = m;
                k.bB = this.Vk
            }
            this.Vk.appendChild(c);
            e || this.ED(d, {rR: !0})
        }, $t: function (a) {
            var b = a[0] - this.Ka.x;
    ...
    var Kc = g.A, Sc = g.l, ec = g.aa.gu, Tc = g.Mta, fa = document, Uc = !0, Vc = [];
    Sc.Af && Vc.push("touch");
    Sc.Z || Vc.push("mouse");
    Sc.hK && (Vc.push("vectorlayer", "overlay"), Sc.nq ? Vc.push("wgl") : Vc.push("cgl"));
    if (Tc) {
    ...
    if (Sc.$r) {
        ...
        try {
            for (var xc = 0, bd = Vc.length; xc < bd; xc++) {
                ...
                if (cd && cd.version === Kc.tj) $c.push(cd.script), cd.css && ad.push(cd.css); else {
                    $c = void 0;
                    Zc = !1;
                    break
                }
    ...
    if (Uc) for (xc = 0; xc < Vc.length; xc += 1) g.pb.dC(Vc[xc]).status = 1; else Kc.WC = !1, hd();
    ...
    function hd() {
        var a = Kc.yb + "/maps/modules?v=" + Kc.er + "&key=" + Kc.key + "&vrs=" + Kc.tj + "&m=" + Vc.join(",");
    ...
    ;
})(["391e9af14a808e5b064732b402559efe", [115.423411, 39.442758, 117.514625, 41.060816, 116.405285, 39.904989], "http://webapi.amap.com", 1, "1.4.13", null, "110000", "", true, false, true, true, "1562073668-1", false])